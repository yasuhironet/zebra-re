...
#define IGMP_SOURCE_TEST_FORWARDING(flags)                                    \
  ((flags) & IGMP_SOURCE_MASK_FORWARDING)
...
#define IGMP_SOURCE_DO_FORWARDING(flags)                                      \
  ((flags) |= IGMP_SOURCE_MASK_FORWARDING)
...
#define IGMP_SOURCE_DONT_FORWARDING(flags)                                    \
  ((flags) &= ~IGMP_SOURCE_MASK_FORWARDING)
...
void igmp_send_query (int igmp_version, struct gm_group *group,
