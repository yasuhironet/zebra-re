...
void
pim_ssm_prefix_list_update (struct pim_instance *pim,
...
int
pim_is_grp_ssm (struct pim_instance *pim, pim_addr group_addr)
{
  struct pim_ssm *ssm;
  struct prefix group;
  struct prefix_list *plist;
...
int
pim_ssm_range_set (struct pim_instance *pim, vrf_id_t vrf_id,
