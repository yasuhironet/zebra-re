...
#define PIM_IF_FLAG_TEST_COULD_ASSERT(flags)                                  \
  ((flags) & PIM_IF_FLAG_MASK_COULD_ASSERT)
...
#define PIM_IF_FLAG_TEST_ASSERT_TRACKING_DESIRED(flags)                       \
  ((flags) & PIM_IF_FLAG_MASK_ASSERT_TRACKING_DESIRED)
...
#define PIM_IF_FLAG_TEST_PROTO_PIM(flags)                                     \
...
#define PIM_IF_FLAG_TEST_PROTO_IGMP(flags)                                    \
