...
#define PIM_DONT_DEBUG_MROUTE_DETAIL                                          \
  (router->debugs &= ~PIM_MASK_MROUTE_DETAIL)
...
#define PIM_DONT_DEBUG_MSDP_INTERNAL                                          \
  (router->debugs &= ~PIM_MASK_MSDP_INTERNAL)
 ...
 */
/* RFC 2710: 7.8. Last Listener Query Interval - Default: 10 deciseconds for
 * MLD
 */
