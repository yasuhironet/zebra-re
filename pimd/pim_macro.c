...
*/
static int
downstream_jpstate_isjoined (const struct pim_ifchannel *ch)
{
...
*/
static int
local_receiver_include (const struct pim_ifchannel *ch)
{
...
*/
int
pim_macro_chisin_joins (const struct pim_ifchannel *ch)
{
...
*/
int
pim_macro_ch_lost_assert (const struct pim_ifchannel *ch)
{
...
*/
int
pim_macro_chisin_pim_include (const struct pim_ifchannel *ch)
{
...
int
pim_macro_chisin_joins_or_include (const struct pim_ifchannel *ch)
{
...
*/
int
pim_macro_ch_could_assert_eval (const struct pim_ifchannel *ch)
{
  struct interface *ifp;
...
pim_macro_spt_assert_metric (const struct pim_rpf *rpf, pim_addr ifaddr)
{
  ...
  if (pim_ifp)
    {
      if (PIM_IF_FLAG_TEST_COULD_ASSERT (ch->flags))
        {
          return pim_macro_spt_assert_metric (&ch->upstream->rpf,
                                              pim_ifp->primary_address);
        }
    }
...
*/
static int
pim_macro_chisin_inherited_olist (const struct pim_ifchannel *ch)
{
...
*/
int
pim_macro_chisin_oiflist (const struct pim_ifchannel *ch)
{
...
*/
int
pim_macro_assert_tracking_desired_eval (const struct pim_ifchannel *ch)
{
  struct pim_interface *pim_ifp;
  struct interface *ifp;
