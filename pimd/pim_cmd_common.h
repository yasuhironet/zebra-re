...
int pim_process_ip_pim_drprio_cmd (struct vty *vty,
...
void pim_show_rpf (struct pim_instance *pim, struct vty *vty,
                   json_object *json);
...
void pim_show_join_desired (struct pim_instance *pim, struct vty *vty,
                            bool uj);
void pim_show_upstream_rpf (struct pim_instance *pim, struct vty *vty,
                            bool uj);
...
void json_object_pim_upstream_add (json_object *json, struct pim_upstream *up);
int pim_show_join_cmd_helper (const char *vrf, struct vty *vty,
                              pim_addr s_or_g, pim_addr g, const char *json);
...
int pim_show_rp_helper (const char *vrf, struct vty *vty,
                        const char *group_str, const struct prefix *group,
                        bool json);
...
int pim_show_upstream_helper (const char *vrf, struct vty *vty,
                              pim_addr s_or_g, pim_addr g, bool json);
...
int pim_show_state_helper (const char *vrf, struct vty *vty,
                           const char *s_or_g_str, const char *g_str,
                           bool json);
...
int pim_show_mroute_summary_helper (const char *vrf, struct vty *vty,
                                    bool json);
