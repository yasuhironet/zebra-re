...
sharp_nh_tracker_get (struct prefix *p)
{
...
void
sharp_nh_tracker_dump (struct vty *vty)
{
  struct listnode *node;
  struct sharp_nh_tracker *nht;
...
static int
sharp_nhg_compare_func (const struct sharp_nhg *a, const struct sharp_nhg *b)
{
...
static void
sharp_nhgroup_add_cb (const char *name)
{
...
static void
sharp_nhgroup_modify_cb (const struct nexthop_group_cmd *nhgc)
{
  struct sharp_nhg lookup;
  struct sharp_nhg *snhg;
...
static void
sharp_nhgroup_add_nexthop_cb (const struct nexthop_group_cmd *nhgc,
...
static void
sharp_nhgroup_del_nexthop_cb (const struct nexthop_group_cmd *nhgc,
                              const struct nexthop *nhop)
{
  struct sharp_nhg lookup;
  struct sharp_nhg *snhg;
...
static void
sharp_nhgroup_delete_cb (const char *name)
{
  struct sharp_nhg lookup;
  struct sharp_nhg *snhg;
...
uint32_t
sharp_nhgroup_get_id (const char *name)
{
  struct sharp_nhg lookup;
  struct sharp_nhg *snhg;
...
void
sharp_nhgroup_id_set_installed (uint32_t id, bool installed)
{
  struct sharp_nhg *snhg;
...
bool
sharp_nhgroup_id_is_installed (uint32_t id)
{
  struct sharp_nhg *snhg;
...
sharp_nhgroup_init (void)
{
  ...
  nexthop_group_init (sharp_nhgroup_add_cb, sharp_nhgroup_modify_cb,
                      ...
                      sharp_nhgroup_del_nexthop_cb, sharp_nhgroup_delete_cb);
}
