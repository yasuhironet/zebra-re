...
static int
ipv4_address_store_clb (const char *type_name, const char *value_str,
...
static int
ipv6_address_store_clb (const char *type_name, const char *value_str,
                        lyd_val *value, char **err_msg)
{
...
static int
ip_address_store_clb (const char *type_name, const char *value_str,
                      lyd_val *value, char **err_msg)
{
...
static int
ipv4_prefix_store_clb (const char *type_name, const char *value_str,
                       lyd_val *value, char **err_msg)
{
...
static int
ipv6_prefix_store_clb (const char *type_name, const char *value_str,
                       lyd_val *value, char **err_msg)
{
...
static int
ip_prefix_store_clb (const char *type_name, const char *value_str,
                     lyd_val *value, char **err_msg)
{
...
struct lytype_plugin_list frr_user_types[] = {
  { "ietf-inet-types", "2013-07-15", "ipv4-address", ipv4_address_store_clb,
    free },
  { "ietf-inet-types", "2013-07-15", "ipv4-address-no-zone",
    ipv4_address_store_clb, free },
  { "ietf-inet-types", "2013-07-15", "ipv6-address", ipv6_address_store_clb,
    free },
  ...
  { "ietf-inet-types", "2013-07-15", "ipv6-prefix", ipv6_prefix_store_clb,
    free },
  { "ietf-inet-types", "2013-07-15", "ip-prefix", ip_prefix_store_clb, free },
