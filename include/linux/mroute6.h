 ...
 * We'll overlay the structure onto an MLD header (not an IPv6 heder like
 * igmpmsg{} used for IPv4 implementation). This is because this structure will
 * be passed via an IPv6 raw socket, on which an application will only receiver
 * the payload i.e the data after the IPv6 header and all the extension
 * headers. (See section 3 of RFC 3542)
 */
