...
#define PCEP_MAX_SIZE 6000
  ...
  /* Given a double linked list of PCEP messages, return the first node that
   * has the same message type */
  struct pcep_message *pcep_msg_get (double_linked_list *msg_list,
                                     uint8_t type);
