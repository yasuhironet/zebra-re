...
void
queue_destroy (queue_handle *handle)
{
  if (handle == NULL)
    {
      pcep_log (LOG_DEBUG,
...
void
queue_destroy_with_data (queue_handle *handle)
{
  if (handle == NULL)
    {
      pcep_log (
...
queue_node *
queue_enqueue (queue_handle *handle, void *data)
{
  if (handle == NULL)
    {
      pcep_log (LOG_DEBUG,
...
void *
queue_dequeue (queue_handle *handle)
{
  if (handle == NULL)
    {
      pcep_log (LOG_DEBUG,
