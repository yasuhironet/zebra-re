 ...
 * to determine where in the list to add it. The newly created
 * ordered_list_node will be returned.
 */
...
/* The same as the previous function, but with a specific
 * orderedComparefunction
 */
