...
#define MAX_ITERATIONS 10
   ...
   * Network byte order. This function will also encode all the objects and
   * their TLVs in the message. The result will be stored in the
   * encoded_message field in the pcep_message. Implemented in
   * pcep-messages-encoding.c */
