...
void
dll_destroy (double_linked_list *handle)
{
  if (handle == NULL)
    {
      pcep_log (LOG_WARNING, "%s: dll_destroy cannot destroy NULL handle",
                __func__);
      return;
    }
...
void
dll_destroy_with_data_memtype (double_linked_list *handle,
...
void
dll_destroy_with_data (double_linked_list *handle)
{
...
dll_prepend (double_linked_list *handle, void *data)
{
  if (handle == NULL)
    {
      pcep_log (LOG_WARNING, "%s: dll_prepend_data NULL handle", __func__);
      return NULL;
    }
...
double_linked_list_node *
dll_append (double_linked_list *handle, void *data)
{
  if (handle == NULL)
    {
      pcep_log (LOG_WARNING, "%s: dll_append_data NULL handle", __func__);
      return NULL;
    }
...
void *
dll_delete_first_node (double_linked_list *handle)
{
  if (handle == NULL)
    {
...
void *
dll_delete_last_node (double_linked_list *handle)
{
  if (handle == NULL)
    {
      pcep_log (LOG_WARNING, "%s: dll_delete_last_node NULL handle", __func__);
      return NULL;
    }
...
void *
dll_delete_node (double_linked_list *handle, double_linked_list_node *node)
{
  if (handle == NULL)
    {
      pcep_log (LOG_WARNING, "%s: dll_delete_node NULL handle", __func__);
      return NULL;
    }
