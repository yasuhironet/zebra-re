...
main (int argc, char **argv)
{
  ...
  CU_add_test (test_socket_comm_suite, "test_pcep_socket_comm_initialize_ipv6",
  ...
  CU_add_test (test_socket_comm_suite,
               ...
               test_pcep_socket_comm_session_not_initialized);
  CU_add_test (test_socket_comm_suite, "test_pcep_socket_comm_session_destroy",
  ...
  CU_add_test (test_socket_comm_loop_suite,
               ...
               test_socket_comm_loop_null_handle);
  CU_add_test (test_socket_comm_loop_suite, "test_socket_comm_loop_not_active",
  ...
  CU_add_test (test_socket_comm_loop_suite, "test_handle_reads_read_message",
      ...
      do
        {
          printf ("\t [%s] [%s] [%s:%d]\n", failure_record->pSuite->pName,
                  failure_record->pTest->pName, failure_record->strFileName,
