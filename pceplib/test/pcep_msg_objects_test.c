...
int
pcep_objects_test_suite_setup (void)
{
...
int
pcep_objects_test_suite_teardown (void)
{
  printf ("\n");
  pceplib_memory_dump ();
  return 0;
...
static void
verify_pcep_obj_header2 (uint8_t obj_class, uint8_t obj_type,
...
/* Internal util verification function */
static void
verify_pcep_obj_header (uint8_t obj_class, uint8_t obj_type,
...
test_pcep_obj_create_open_with_tlvs ()
{
  ...
  struct pcep_object_tlv_stateful_pce_capability *tlv =
      pcep_tlv_create_stateful_pce_capability (true, true, true, true, true,
                                               true);
...
test_pcep_obj_create_lsp ()
{
  ...
  lsp = pcep_obj_create_lsp (plsp_id, status, c_flag, a_flag, r_flag, s_flag,
                             d_flag, NULL);
  ...
  CU_ASSERT_EQUAL (
      (ntohl (*((uint32_t *) (lsp->header.encoded_object + 4))) >> 12) &
          0x000fffff,
      plsp_id);
...
static void
test_pcep_obj_create_object_common (ro_func func_to_test, uint8_t object_class,
                                    uint8_t object_type)
{
...
{
  test_pcep_obj_create_object_common (pcep_obj_create_ero, PCEP_OBJ_CLASS_ERO,
                                      PCEP_OBJ_TYPE_ERO);
}
...
{
  test_pcep_obj_create_object_common (pcep_obj_create_rro, PCEP_OBJ_CLASS_RRO,
                                      PCEP_OBJ_TYPE_RRO);
}
...
{
  test_pcep_obj_create_object_common (pcep_obj_create_iro, PCEP_OBJ_CLASS_IRO,
                                      PCEP_OBJ_TYPE_IRO);
}

/* Internal util function to wrap an RO Subobj in a RO and encode it */
static struct pcep_object_ro *
encode_ro_subobj (struct pcep_object_ro_subobj *sr)
{
...
static void
verify_pcep_obj_ro_header (struct pcep_object_ro *ro,
                           ...
                           uint16_t length)
{
   ...
   * we can provide more info in the error message. */
  uint8_t found_type =
      (ro->header.encoded_object[4] & 0x7f); /* remove the Loose hop bit */
...
verify_pcep_obj_ro_sr_header (struct pcep_object_ro *ro,
                              struct pcep_object_ro_subobj *ro_subobj,
                              uint8_t nai_type, bool loose_hop,
                              uint16_t length)
{
...
test_pcep_obj_create_ro_subobj_ipv4 ()
{
  ...
  verify_pcep_obj_ro_header (ro, &ipv4->ro_subobj, RO_SUBOBJ_TYPE_IPV4, false,
                             sizeof (uint32_t) * 3);
  ...
  verify_pcep_obj_ro_header (ro, &ipv4->ro_subobj, RO_SUBOBJ_TYPE_IPV4, true,
                             sizeof (uint32_t) * 3);
  CU_ASSERT_EQUAL (*((uint32_t *) (ro->header.encoded_object + 6)),
                   ro_ipv4.s_addr);
  CU_ASSERT_EQUAL (ro->header.encoded_object[10], prefix_len);
...
test_pcep_obj_create_ro_subobj_ipv6 ()
{
  ...
  verify_pcep_obj_ro_header (ro, &ipv6->ro_subobj, RO_SUBOBJ_TYPE_IPV6, false,
                             sizeof (uint32_t) * 6);
  ...
  verify_pcep_obj_ro_header (ro, &ipv6->ro_subobj, RO_SUBOBJ_TYPE_IPV6, true,
                             sizeof (uint32_t) * 6);
...
test_pcep_obj_create_ro_subobj_sr_nonai ()
{
  ...
  verify_pcep_obj_ro_sr_header (ro, &sr->ro_subobj, PCEP_SR_SUBOBJ_NAI_ABSENT,
                                false, sizeof (uint32_t) * 3);
...
test_pcep_obj_create_ro_subobj_sr_ipv4_node ()
{
  ...
  sr = pcep_obj_create_ro_subobj_sr_ipv4_node (true, true, false, false, sid,
                                               &ipv4_node_id);
  CU_ASSERT_PTR_NOT_NULL (sr);
  assert (sr != NULL);
  struct pcep_object_ro *ro = encode_ro_subobj (&sr->ro_subobj);
  ...
  reset_objects_buffer ();
  inet_pton (AF_INET, "192.168.1.2", &ipv4_node_id);
  sr = pcep_obj_create_ro_subobj_sr_ipv4_node (false, false, true, true, sid,
                                               &ipv4_node_id);
  CU_ASSERT_PTR_NOT_NULL (sr);
  assert (sr != NULL);
  ro = encode_ro_subobj (&sr->ro_subobj);
...
test_pcep_obj_create_ro_subobj_sr_ipv6_node ()
{
  ...
  reset_objects_buffer ();
  inet_pton (AF_INET6, "2001:db8::8a2e:370:7334", &ipv6_node_id);
  sr = pcep_obj_create_ro_subobj_sr_ipv6_node (false, false, true, true, sid,
                                               &ipv6_node_id);
  CU_ASSERT_PTR_NOT_NULL (sr);
  ro = encode_ro_subobj (&sr->ro_subobj);
  verify_pcep_obj_ro_sr_header (ro, &sr->ro_subobj,
...
test_pcep_obj_create_ro_subobj_sr_ipv4_adj ()
{
  ...
  inet_pton (AF_INET, "172.168.1.2", &remote_ipv4);
  reset_objects_buffer ();
  sr = pcep_obj_create_ro_subobj_sr_ipv4_adj (false, false, true, true, sid,
                                              &local_ipv4, &remote_ipv4);
  CU_ASSERT_PTR_NOT_NULL (sr);
  ro = encode_ro_subobj (&sr->ro_subobj);
  verify_pcep_obj_ro_sr_header (ro, &sr->ro_subobj,
...
test_pcep_obj_create_ro_subobj_sr_ipv6_adj ()
{
  ...
  inet_pton (AF_INET6, "2001:db8::8a2e:370:8221", &local_ipv6);
  inet_pton (AF_INET6, "2001:db8::8a2e:370:7334", &remote_ipv6);
  sr = pcep_obj_create_ro_subobj_sr_ipv6_adj (false, false, true, false, sid,
                                              &local_ipv6, &remote_ipv6);
  CU_ASSERT_PTR_NOT_NULL (sr);
  ro = encode_ro_subobj (&sr->ro_subobj);
  verify_pcep_obj_ro_sr_header (ro, &sr->ro_subobj,
...
test_pcep_obj_create_ro_subobj_sr_linklocal_ipv6_adj ()
{
  ...
  /* Test the sid is absent */
  sr = pcep_obj_create_ro_subobj_sr_linklocal_ipv6_adj (
      true, true, true, true, sid, &local_ipv6, local_if_id, &remote_ipv6,
      remote_if_id);
  CU_ASSERT_PTR_NOT_NULL (sr);
  struct pcep_object_ro *ro = encode_ro_subobj (&sr->ro_subobj);
  verify_pcep_obj_ro_sr_header (ro, &sr->ro_subobj,
                                PCEP_SR_SUBOBJ_NAI_LINK_LOCAL_IPV6_ADJACENCY,
                                true, sizeof (uint32_t) * 12);
  CU_ASSERT_TRUE (ro->header.encoded_object[7] & OBJECT_SUBOBJ_SR_FLAG_S);
  CU_ASSERT_TRUE (ro->header.encoded_object[7] & ~OBJECT_SUBOBJ_SR_FLAG_F);
  CU_ASSERT_TRUE (ro->header.encoded_object[7] & ~OBJECT_SUBOBJ_SR_FLAG_C);
  CU_ASSERT_TRUE (ro->header.encoded_object[7] & ~OBJECT_SUBOBJ_SR_FLAG_M);
  ...
  reset_objects_buffer ();
  sr = pcep_obj_create_ro_subobj_sr_linklocal_ipv6_adj (
      false, false, true, true, sid, &local_ipv6, local_if_id, &remote_ipv6,
      remote_if_id);
  CU_ASSERT_PTR_NOT_NULL (sr);
  ro = encode_ro_subobj (&sr->ro_subobj);
  verify_pcep_obj_ro_sr_header (ro, &sr->ro_subobj,
                                PCEP_SR_SUBOBJ_NAI_LINK_LOCAL_IPV6_ADJACENCY,
                                false, sizeof (uint32_t) * 13);
  CU_ASSERT_TRUE (ro->header.encoded_object[7] & OBJECT_SUBOBJ_SR_FLAG_C);
  CU_ASSERT_TRUE (ro->header.encoded_object[7] & OBJECT_SUBOBJ_SR_FLAG_M);
  CU_ASSERT_TRUE (ro->header.encoded_object[7] & ~OBJECT_SUBOBJ_SR_FLAG_S);
  CU_ASSERT_TRUE (ro->header.encoded_object[7] & ~OBJECT_SUBOBJ_SR_FLAG_F);
