...
void *
test_pceplib_malloc (void *mem_type, size_t size)
{
...
void *
test_pceplib_calloc (void *mem_type, size_t size)
{
...
void *
test_pceplib_realloc (void *mem_type, void *ptr, size_t size)
{
...
void *
test_pceplib_strdup (void *mem_type, const char *str)
{
...
void
test_pceplib_free (void *mem_type, void *ptr)
{
...
void
verify_memory_type (struct pceplib_memory_type *mt, uint32_t num_alloc,
                    uint32_t alloc_bytes, uint32_t num_free,
                    uint32_t free_bytes)
{
...
void
verify_ext_memory_type (void *mt, int num_malloc_calls, int num_calloc_calls,
                        int num_realloc_calls, int num_strdup_calls,
                        int num_free_calls)
{
...
test_memory_internal_impl ()
{
  ...
  pceplib_infra_ptr->num_allocates = pceplib_infra_ptr->total_bytes_allocated =
      pceplib_infra_ptr->num_frees = pceplib_infra_ptr->total_bytes_freed = 0;
