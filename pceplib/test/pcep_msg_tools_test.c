...
const char *pcep_open_initiate_odl_hexbyte_strs[] = {
  "20", "01", "00", "1c", "01", "10", "00", "18", "20", "1e", "78", "55", "00",
  "10", "00", "04", "00", "00", "00", "3f", "00", "1a", "00", "04", "00", "00",
  "00", "00", "20", "0c", "00", "48", "21", "12", "00", "14", "00", "00", "00",
  "00", "00", "00", "00", "01", "00", "1c", "00", "04", "00", "00", "00", "01",
  "20", "10", "00", "14", "00", "00", "00", "09", "00", "11", "00", "08", "36",
  "65", "31", "31", "38", "39", "32", "31", "04", "10", "00", "0c", "c0", "a8",
  "14", "05", "01", "01", "01", "01", "07", "10", "00", "10", "05", "0c", "10",
  "01", "03", "e8", "a0", "00", "01", "01", "01", "01"
};
...
const char *pcep_update_cisco_pce_hexbyte_strs[] = {
  "20", "0b", "00", "64", "21", "10", "00", "14", "00", "00", "00", "00", "00",
  "00", "00", "01", "00", "1c", "00", "04", "00", "00", "00", "01", "20", "10",
  "00", "18", "80", "00", "f0", "89", "00", "07", "00", "0c", "00", "00", "00",
  "09", "00", "03", "00", "04", "00", "00", "00", "01", "07", "10", "00", "28",
  "24", "0c", "10", "01", "04", "65", "50", "00", "0a", "0a", "0a", "05", "24",
  "0c", "10", "01", "04", "65", "20", "00", "0a", "0a", "0a", "02", "24", "0c",
  "10", "01", "04", "65", "10", "00", "0a", "0a", "0a", "01", "06", "10", "00",
  "0c", "00", "00", "00", "02", "41", "f0", "00", "00"
};

uint16_t pcep_report_cisco_pcc_hexbyte_strs_length = 148;
const char *pcep_report_cisco_pcc_hexbyte_strs[] = {
  "20", "0a", "00", "94", "21", "10", "00", "14", "00", "00", "00", "00", "00",
  "00", "00", "00", "00", "1c", "00", "04", "00", "00", "00", "01", "20", "10",
  "00", "3c", "80", "00", "f0", "09", "00", "12", "00", "10", "0a", "0a", "0a",
  "06", "00", "02", "00", "0f", "0a", "0a", "0a", "06", "0a", "0a", "0a", "01",
  "00", "11", "00", "0d", "63", "66", "67", "5f", "52", "36", "2d", "74", "6f",
  "2d", "52", "31", "00", "00", "00", "00", "ff", "e1", "00", "06", "00", "00",
  "05", "dd", "70", "00", "00", "00", "07", "10", "00", "04", "09", "10", "00",
  "14", "00", "00", "00", "00", "00", "00", "00", "00", "00", "00", "00", "00",
  "07", "07", "01", "00", "05", "12", "00", "08", "00", "00", "00", "00", "05",
  "52", "00", "08", "00", "00", "00", "00", "06", "10", "00", "0c", "00", "00",
  "00", "02", "00", "00", "00", "00", "06", "10", "00", "0c", "00", "00", "01",
  "04", "41", "80", "00", "00"
};
...
const char *pcep_initiate_cisco_pcc_hexbyte_strs[] = {
  "20", "0c", "00", "68", "21", "10", "00", "14", "00", "00", "00", "00", "00",
  "00", "00", "01", "00", "1c", "00", "04", "00", "00", "00", "01", "20", "10",
  "00", "30", "00", "00", "00", "89", "00", "11", "00", "13", "50", "4f", "4c",
  "31", "5f", "50", "43", "49", "4e", "49", "54", "41", "54", "45", "5f", "54",
  "45", "53", "54", "00", "00", "07", "00", "0c", "00", "00", "00", "09", "00",
  "03", "00", "04", "00", "00", "00", "01", "04", "10", "00", "0c", "0a", "0a",
  "0a", "0a", "0a", "0a", "0a", "04", "24", "10", "00", "08", "00", "00", "01",
  "4d", "25", "10", "00", "08", "00", "00", "00", "64", "07", "10", "00", "04"
};
...
int
pcep_tools_test_suite_setup (void)
{
...
int
pcep_tools_test_suite_teardown (void)
{
  printf ("\n");
  pceplib_memory_dump ();
  return 0;
...
void
pcep_tools_test_setup (void)
{
}

void
pcep_tools_test_teardown (void)
{
}
...
int
convert_hexstrs_to_binary (char *filename, const char *hexbyte_strs[],
                           uint16_t hexbyte_strs_length)
{
  mode_t oldumask;
...
static bool
pcep_obj_has_tlv (struct pcep_object_header *obj_hdr)
{
...
test_pcep_msg_read_pcep_initiate ()
{
  ...
  CU_ASSERT_EQUAL (((struct pcep_ro_subobj_ipv4 *) subobj_hdr)->ip_addr.s_addr,
                   ero_subobj_ip.s_addr);
  CU_ASSERT_EQUAL (((struct pcep_ro_subobj_ipv4 *) subobj_hdr)->prefix_length,
                   24);
...
test_pcep_msg_read_pcep_initiate2 ()
{
  ...
  int fd = convert_hexstrs_to_binary (filename, pcep_initiate2_hexbyte_strs,
...
test_pcep_msg_read_pcep_open_initiate ()
{
  ...
  int fd =
      convert_hexstrs_to_binary (filename, pcep_open_initiate_odl_hexbyte_strs,
...
test_pcep_msg_read_pcep_open_cisco_pce ()
{
  ...
  int fd =
      convert_hexstrs_to_binary (filename, pcep_open_cisco_pce_hexbyte_strs,
...
test_pcep_msg_read_pcep_update_cisco_pce ()
{
  ...
  int fd =
      convert_hexstrs_to_binary (filename, pcep_update_cisco_pce_hexbyte_strs,
  ...
  CU_ASSERT_EQUAL (*((uint32_t *) sr_subobj_ipv4_node->nai_list->head->data),
                   htonl (0x0a0a0a05));
...
test_pcep_msg_read_pcep_report_cisco_pcc ()
{
  ...
  int fd =
      convert_hexstrs_to_binary (filename, pcep_report_cisco_pcc_hexbyte_strs,
  ...
  CU_ASSERT_EQUAL (
      strncmp (sym_path_name->symbolic_path_name, "cfg_R6-to-R1", 13), 0);
...
test_validate_message_header ()
{
  ...
  CU_ASSERT_TRUE (
      pcep_decode_validate_msg_header (pcep_message_invalid_version) < 0);

  /* Verify invalid message header flags */
  CU_ASSERT_TRUE (
      pcep_decode_validate_msg_header (pcep_message_invalid_flags) < 0);

  /* Verify invalid message header lengths */
  CU_ASSERT_TRUE (
      pcep_decode_validate_msg_header (pcep_message_invalid_length) < 0);
  pcep_message_invalid_length[3] = 0x05;
  CU_ASSERT_TRUE (
      pcep_decode_validate_msg_header (pcep_message_invalid_length) < 0);

  /* Verify invalid message header types */
  CU_ASSERT_TRUE (pcep_decode_validate_msg_header (pcep_message_invalid_type) <
                  0);
...
struct pcep_message *
create_message (uint8_t msg_type, uint8_t obj1_class, uint8_t obj2_class,
                uint8_t obj3_class, uint8_t obj4_class)
{
  struct pcep_message *msg =
      pceplib_malloc (PCEPLIB_MESSAGES, sizeof (struct pcep_message));
  msg->obj_list = dll_initialize ();
  msg->msg_header =
      pceplib_malloc (PCEPLIB_MESSAGES, sizeof (struct pcep_message_header));
...
test_validate_message_objects ()
{
  ...
  /* Valid PcRep message */
  msg =
      create_message (PCEP_TYPE_PCREP, PCEP_OBJ_CLASS_RP, any_obj_class, 0, 0);
  CU_ASSERT_TRUE (validate_message_objects (msg));
  pcep_msg_free_message (msg);

  /* Valid Notify message */
  msg = create_message (PCEP_TYPE_PCNOTF, PCEP_OBJ_CLASS_NOTF, any_obj_class,
                        0, 0);
  CU_ASSERT_TRUE (validate_message_objects (msg));
  pcep_msg_free_message (msg);

  /* Valid Error message */
  msg = create_message (PCEP_TYPE_ERROR, PCEP_OBJ_CLASS_ERROR, any_obj_class,
                        0, 0);
  CU_ASSERT_TRUE (validate_message_objects (msg));
  pcep_msg_free_message (msg);
...
test_validate_message_objects_invalid ()
{
  ...
  msg = create_message (PCEP_TYPE_OPEN, PCEP_OBJ_CLASS_OPEN, any_obj_class, 0,
                        0);
  CU_ASSERT_FALSE (validate_message_objects (msg));
  pcep_msg_free_message (msg);
  ...
  msg =
      create_message (PCEP_TYPE_PCREQ, PCEP_OBJ_CLASS_RP, any_obj_class, 0, 0);
  CU_ASSERT_FALSE (validate_message_objects (msg));
  pcep_msg_free_message (msg);
  ...
  msg = create_message (PCEP_TYPE_REPORT, PCEP_OBJ_CLASS_SRP, any_obj_class, 0,
                        0);
  CU_ASSERT_FALSE (validate_message_objects (msg));
  pcep_msg_free_message (msg);
  ...
  msg = create_message (PCEP_TYPE_UPDATE, PCEP_OBJ_CLASS_SRP, any_obj_class, 0,
                        0);
  CU_ASSERT_FALSE (validate_message_objects (msg));
  pcep_msg_free_message (msg);
  ...
  msg = create_message (PCEP_TYPE_INITIATE, PCEP_OBJ_CLASS_SRP, any_obj_class,
                        0, 0);
  CU_ASSERT_FALSE (validate_message_objects (msg));
  pcep_msg_free_message (msg);
}
