...
static int
test_loop_message_ready_to_read_handler (void *session_data, int socket_fd)
{
...
void
test_loop_conn_except_notifier (void *session_data, int socket_fd)
{
  (void) session_data;
  (void) socket_fd;
 ...
 */
void
pcep_socket_comm_loop_test_setup ()
{
...
void
pcep_socket_comm_loop_test_teardown ()
{
