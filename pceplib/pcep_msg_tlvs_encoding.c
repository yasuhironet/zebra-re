...
pcep_encode_tlv_stateful_pce_capability (struct pcep_object_tlv_header *tlv,
                                         ...
                                         uint8_t *tlv_body_buf);
uint16_t
pcep_encode_tlv_symbolic_path_name (struct pcep_object_tlv_header *tlv,
                                    struct pcep_versioning *versioning,
                                    uint8_t *tlv_body_buf);
uint16_t
...
struct pcep_object_tlv_header *pcep_decode_tlv_stateful_pce_capability (
...
uint16_t
pcep_encode_tlv (struct pcep_object_tlv_header *tlv_hdr,
...
void
write_tlv_header (struct pcep_object_tlv_header *tlv_hdr, uint16_t tlv_length,
                  struct pcep_versioning *versioning, uint8_t *buf)
{
  (void) versioning;
...
uint16_t
pcep_encode_tlv_no_path_vector (struct pcep_object_tlv_header *tlv,
                                struct pcep_versioning *versioning,
                                uint8_t *tlv_body_buf)
{
  (void) versioning;
                                         ...
                                         uint8_t *tlv_body_buf)
{
  ...
  tlv_body_buf[3] =
      ((spc_tlv->flag_f_triggered_initial_sync == true
            ...
            : 0x00) |
       (spc_tlv->flag_d_delta_lsp_sync == true ? TLV_STATEFUL_PCE_CAP_FLAG_D
                                               : 0x00) |
       (spc_tlv->flag_t_triggered_resync == true ? TLV_STATEFUL_PCE_CAP_FLAG_T
                                                 : 0x00) |
...
uint16_t
pcep_encode_tlv_lsp_error_code (struct pcep_object_tlv_header *tlv,
                                struct pcep_versioning *versioning,
                                uint8_t *tlv_body_buf)
{
  (void) versioning;
...
uint16_t
pcep_encode_tlv_rsvp_error_spec (struct pcep_object_tlv_header *tlv,
                                 struct pcep_versioning *versioning,
                                 uint8_t *tlv_body_buf)
{
...
uint16_t
pcep_encode_tlv_lsp_db_version (struct pcep_object_tlv_header *tlv,
                                struct pcep_versioning *versioning,
                                uint8_t *tlv_body_buf)
{
  (void) versioning;
...
uint16_t
pcep_encode_tlv_speaker_entity_id (struct pcep_object_tlv_header *tlv,
                                   struct pcep_versioning *versioning,
                                   uint8_t *tlv_body_buf)
{
  (void) versioning;
...
uint16_t
pcep_encode_tlv_sr_pce_capability (struct pcep_object_tlv_header *tlv,
                                   struct pcep_versioning *versioning,
                                   uint8_t *tlv_body_buf)
{
  (void) versioning;
...
uint16_t
pcep_encode_tlv_path_setup_type (struct pcep_object_tlv_header *tlv,
                                 struct pcep_versioning *versioning,
                                 uint8_t *tlv_body_buf)
{
  (void) versioning;
  ...
  for (; node != NULL; node = node->next_node)
    {
      ...
      uint16_t sub_tlv_length =
          pcep_encode_tlv (sub_tlv, versioning, tlv_body_buf + index);
...
uint16_t
pcep_encode_tlv_pol_id (struct pcep_object_tlv_header *tlv,
                        struct pcep_versioning *versioning,
                        uint8_t *tlv_body_buf)
{
  (void) versioning;
...
uint16_t
pcep_encode_tlv_pol_name (struct pcep_object_tlv_header *tlv,
                          struct pcep_versioning *versioning,
                          uint8_t *tlv_body_buf)
{
  (void) versioning;
...
uint16_t
pcep_encode_tlv_cpath_id (struct pcep_object_tlv_header *tlv,
                          struct pcep_versioning *versioning,
                          uint8_t *tlv_body_buf)
{
  (void) versioning;
...
uint16_t
pcep_encode_tlv_cpath_preference (struct pcep_object_tlv_header *tlv,
                                  struct pcep_versioning *versioning,
                                  uint8_t *tlv_body_buf)
{
  (void) versioning;
...
uint16_t
pcep_encode_tlv_vendor_info (struct pcep_object_tlv_header *tlv,
                             struct pcep_versioning *versioning,
                             uint8_t *tlv_body_buf)
{
  (void) versioning;
...
uint16_t
pcep_encode_tlv_arbitrary (struct pcep_object_tlv_header *tlv,
                           struct pcep_versioning *versioning,
                           uint8_t *tlv_body_buf)
{
  (void) versioning;
...
uint16_t
pcep_encode_tlv_of_list (struct pcep_object_tlv_header *tlv,
                         struct pcep_versioning *versioning,
                         uint8_t *tlv_body_buf)
{
  (void) versioning;
...
void
pcep_decode_tlv_hdr (const uint8_t *tlv_buf,
                     struct pcep_object_tlv_header *tlv_hdr)
{
...
pcep_decode_tlv (const uint8_t *tlv_buf)
{
  ...
  if (tlv_hdr.type >= MAX_TLV_ENCODER_INDEX)
    {
      pcep_log (LOG_INFO, "%s: Cannot decode unknown TLV type [%d]", __func__,
                tlv_hdr.type);
      return NULL;
    }
  ...
  if (tlv_hdr.type == PCEP_OBJ_TYPE_CISCO_BSID)
    {
      pcep_log (LOG_INFO, "%s: Cisco BSID TLV decoder found for TLV type [%d]",
                __func__, tlv_hdr.type);
...
{
  struct pcep_object_tlv_stateful_pce_capability *tlv =
      (struct pcep_object_tlv_stateful_pce_capability *) common_tlv_create (
          tlv_hdr, sizeof (struct pcep_object_tlv_stateful_pce_capability));
                                    ...
                                    const uint8_t *tlv_body_buf)
{
  struct pcep_object_tlv_symbolic_path_name *tlv =
      (struct pcep_object_tlv_symbolic_path_name *) common_tlv_create (
          tlv_hdr, sizeof (struct pcep_object_tlv_symbolic_path_name));
  ...
  if (length > MAX_SYMBOLIC_PATH_NAME)
    {
      ...
      pcep_log (
          ...
          __func__, tlv_hdr->encoded_tlv_length, MAX_SYMBOLIC_PATH_NAME);
    }
                                      ...
                                      const uint8_t *tlv_body_buf)
{
  struct pcep_object_tlv_ipv4_lsp_identifier *tlv =
      (struct pcep_object_tlv_ipv4_lsp_identifier *) common_tlv_create (
          tlv_hdr, sizeof (struct pcep_object_tlv_ipv4_lsp_identifier));
                                      ...
                                      const uint8_t *tlv_body_buf)
{
  struct pcep_object_tlv_ipv6_lsp_identifier *tlv =
      (struct pcep_object_tlv_ipv6_lsp_identifier *) common_tlv_create (
          tlv_hdr, sizeof (struct pcep_object_tlv_ipv6_lsp_identifier));
                                 ...
                                 const uint8_t *tlv_body_buf)
{
  ...
  struct pcep_object_tlv_rsvp_error_spec *tlv =
      (struct pcep_object_tlv_rsvp_error_spec *) common_tlv_create (
          tlv_hdr, sizeof (struct pcep_object_tlv_rsvp_error_spec));
  ...
  if (ctype == RSVP_ERROR_SPEC_IPV4_CTYPE)
    {
      ...
      tlv->error_value =
          ntohs (*((uint16_t *) (tlv_body_buf + LENGTH_2WORDS + 2)));
    }
  else /* RSVP_ERROR_SPEC_IPV6_CTYPE */
    {
      ...
      tlv->error_value =
          ntohs (*((uint16_t *) (tlv_body_buf + LENGTH_5WORDS + 2)));
    }
                                   ...
                                   const uint8_t *tlv_body_buf)
{
  struct pcep_object_tlv_speaker_entity_identifier *tlv =
      (struct pcep_object_tlv_speaker_entity_identifier *) common_tlv_create (
          tlv_hdr, sizeof (struct pcep_object_tlv_speaker_entity_identifier));
                                   ...
                                   const uint8_t *tlv_body_buf)
{
  struct pcep_object_tlv_sr_pce_capability *tlv =
      (struct pcep_object_tlv_sr_pce_capability *) common_tlv_create (
          tlv_hdr, sizeof (struct pcep_object_tlv_sr_pce_capability));
                                 ...
                                 const uint8_t *tlv_body_buf)
{
  struct pcep_object_tlv_path_setup_type *tlv =
      (struct pcep_object_tlv_path_setup_type *) common_tlv_create (
          tlv_hdr, sizeof (struct pcep_object_tlv_path_setup_type));
...
{
  struct pcep_object_tlv_path_setup_type_capability *tlv =
      (struct pcep_object_tlv_path_setup_type_capability *) common_tlv_create (
          tlv_hdr, sizeof (struct pcep_object_tlv_path_setup_type_capability));
  ...
  uint16_t buf_index =
      normalize_pcep_tlv_length (TLV_HEADER_LENGTH + LENGTH_1WORD + num_psts);
  ...
  if (length > MAX_ARBITRARY_SIZE)
    {
      ...
      pcep_log (
          ...
          __func__, tlv_hdr->encoded_tlv_length, MAX_ARBITRARY_SIZE);
    }
