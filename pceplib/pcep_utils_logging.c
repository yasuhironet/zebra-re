...
void
register_logger (pcep_logger_func logger)
{
  logger_func = logger;
}
...
void
pcep_log (int priority, const char *format, ...)
{
  va_list va;
  va_start (va, format);
...
void
pcep_log_hexbytes (int priority, const char *message, const uint8_t *bytes,
                   uint8_t bytes_len)
{
...
int
pcep_stdout_logger (int priority, const char *format, va_list args)
{
