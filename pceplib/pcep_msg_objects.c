...
/* Internal common function used to create a pcep_object and populate the
 * header
 */
static struct pcep_object_header *
pcep_obj_create_common_with_tlvs (uint8_t obj_length,
...
pcep_obj_create_rp (uint8_t priority, bool flag_r, bool flag_b, bool flag_s,
                    bool flag_of, uint32_t reqid, double_linked_list *tlv_list)
{
  ...
  struct pcep_object_rp *obj =
      (struct pcep_object_rp *) pcep_obj_create_common_with_tlvs (
          sizeof (struct pcep_object_rp), PCEP_OBJ_CLASS_RP, PCEP_OBJ_TYPE_RP,
          tlv_list);
                        ...
                        enum pcep_nopath_tlv_err_codes error_code)
{
  ...
  struct pcep_object_nopath *obj =
      (struct pcep_object_nopath *) pcep_obj_create_common_with_tlvs (
          sizeof (struct pcep_object_nopath), PCEP_OBJ_CLASS_NOPATH,
          PCEP_OBJ_TYPE_NOPATH, tlv_list);
                               ...
                               const struct in_addr *dst_ipv4)
{
  ...
  struct pcep_object_endpoints_ipv4 *obj =
      (struct pcep_object_endpoints_ipv4 *) pcep_obj_create_common (
          sizeof (struct pcep_object_endpoints_ipv4), PCEP_OBJ_CLASS_ENDPOINTS,
                               ...
                               const struct in6_addr *dst_ipv6)
{
  ...
  struct pcep_object_endpoints_ipv6 *obj =
      (struct pcep_object_endpoints_ipv6 *) pcep_obj_create_common (
          sizeof (struct pcep_object_endpoints_ipv6), PCEP_OBJ_CLASS_ENDPOINTS,
...
pcep_obj_create_bandwidth (float bandwidth)
{
  struct pcep_object_bandwidth *obj =
      (struct pcep_object_bandwidth *) pcep_obj_create_common (
          sizeof (struct pcep_object_bandwidth), PCEP_OBJ_CLASS_BANDWIDTH,
...
pcep_obj_create_metric (enum pcep_metric_types type, bool flag_b, bool flag_c,
                        float value)
{
  struct pcep_object_metric *obj =
      (struct pcep_object_metric *) pcep_obj_create_common (
          sizeof (struct pcep_object_metric), PCEP_OBJ_CLASS_METRIC,
                             ...
                             uint32_t enterprise_spec_info)
{
  struct pcep_object_vendor_info *obj =
      (struct pcep_object_vendor_info *) pcep_obj_create_common (
          sizeof (struct pcep_object_vendor_info), PCEP_OBJ_CLASS_VENDOR_INFO,
...
pcep_obj_create_inter_layer (bool flag_i, bool flag_m, bool flag_t)
{
  struct pcep_object_inter_layer *obj =
      (struct pcep_object_inter_layer *) pcep_obj_create_common (
          sizeof (struct pcep_object_inter_layer), PCEP_OBJ_CLASS_INTER_LAYER,
  ...
  struct pcep_object_server_indication *obj =
      (struct pcep_object_server_indication *)
          pcep_obj_create_common_with_tlvs (
              ...
              PCEP_OBJ_CLASS_SERVER_IND, PCEP_OBJ_TYPE_SERVER_IND, tlv_list);
...
pcep_obj_create_ro_subobj_ipv6 (bool loose_hop,
                                const struct in6_addr *rro_ipv6,
                                uint8_t prefix_length, bool flag_local_prot)
{
  if (rro_ipv6 == NULL)
    {
...
pcep_obj_create_ro_subobj_sr_nonai (bool loose_hop, uint32_t sid, bool c_flag,
                                    bool m_flag)
{
                                        ...
                                        struct in_addr *ipv4_node_id)
{
  ...
  struct pcep_ro_subobj_sr *obj = pcep_obj_create_ro_subobj_sr_common (
      PCEP_SR_SUBOBJ_NAI_IPV4_NODE, loose_hop, false, sid_absent, c_flag,
      m_flag);
                                        ...
                                        struct in6_addr *ipv6_node_id)
{
  ...
  struct pcep_ro_subobj_sr *obj = pcep_obj_create_ro_subobj_sr_common (
      PCEP_SR_SUBOBJ_NAI_IPV6_NODE, loose_hop, false, sid_absent, c_flag,
      m_flag);
...
struct pcep_ro_subobj_sr *
pcep_obj_create_ro_subobj_sr_ipv4_adj (bool loose_hop, bool sid_absent,
                                       bool c_flag, bool m_flag, uint32_t sid,
                                       ...
                                       struct in_addr *remote_ipv4)
{
  ...
  struct pcep_ro_subobj_sr *obj = pcep_obj_create_ro_subobj_sr_common (
      PCEP_SR_SUBOBJ_NAI_IPV4_ADJACENCY, loose_hop, false, sid_absent, c_flag,
      m_flag);
...
struct pcep_ro_subobj_sr *
pcep_obj_create_ro_subobj_sr_ipv6_adj (bool loose_hop, bool sid_absent,
                                       bool c_flag, bool m_flag, uint32_t sid,
                                       ...
                                       struct in6_addr *remote_ipv6)
{
  ...
  struct pcep_ro_subobj_sr *obj = pcep_obj_create_ro_subobj_sr_common (
      PCEP_SR_SUBOBJ_NAI_IPV6_ADJACENCY, loose_hop, false, sid_absent, c_flag,
      m_flag);
