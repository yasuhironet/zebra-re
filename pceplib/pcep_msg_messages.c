                         ...
                         double_linked_list *object_list)
{
  ...
  struct pcep_message *message =
      pcep_msg_create_common_with_obj_list (PCEP_TYPE_PCREQ, object_list);
...
struct pcep_message *
pcep_msg_create_reply (struct pcep_object_rp *rp,
                       double_linked_list *object_list)
{
  struct pcep_message *message =
      pcep_msg_create_common_with_obj_list (PCEP_TYPE_PCREP, object_list);
...
{
  struct pcep_message *message =
      pcep_msg_create_common_with_obj_list (PCEP_TYPE_ERROR, object_list);
...
pcep_msg_create_update (double_linked_list *update_request_object_list)
{
  ...
  return (pcep_msg_create_common_with_obj_list (PCEP_TYPE_UPDATE,
                        ...
                        double_linked_list *object_list)
{
  if (notify == NULL)
    {
      pcep_log (LOG_INFO, "%s: pcep_msg_create_notify NULL notify object",
                __func__);
      return NULL;
    }

  struct pcep_message *message =
      pcep_msg_create_common_with_obj_list (PCEP_TYPE_PCNOTF, object_list);
