 ...
 */
int
pointer_compare_function (void *list_entry, void *new_entry)
{
 ...
 */
void
ordered_list_destroy (ordered_list_handle *handle)
{
  if (handle == NULL)
    {
      return;
...
ordered_list_node *
ordered_list_add_node (ordered_list_handle *handle, void *data)
{
  if (handle == NULL)
    {
...
ordered_list_node *
ordered_list_find2 (ordered_list_handle *handle, void *data,
...
ordered_list_node *
ordered_list_find (ordered_list_handle *handle, void *data)
{
  if (handle == NULL)
    {
      pcep_log (LOG_WARNING,
...
void *
ordered_list_remove_first_node (ordered_list_handle *handle)
{
  if (handle == NULL)
    {
      pcep_log (
...
void *
ordered_list_remove_first_node_equals2 (ordered_list_handle *handle,
                                        void *data,
                                        ordered_compare_function compare_func)
{
  if (handle == NULL)
...
void *
ordered_list_remove_first_node_equals (ordered_list_handle *handle, void *data)
{
  if (handle == NULL)
    {
      pcep_log (
...
void *
ordered_list_remove_node (ordered_list_handle *handle,
...
void *
ordered_list_remove_node2 (ordered_list_handle *handle,
