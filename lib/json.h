...
#define JSON_OBJECT_NEW_ARRAY(json_func, fields, n)                           \
  ({                                                                          \
    ...
    for (int _i = 0; _i < (n); _i++)                                          \
      json_object_array_add (_json_array, (json_func) ((fields)[_i]));        \
    (_json_array);                                                            \
  })
  ...
  PRINTFRR (3, 0)
  extern void json_object_string_addv (struct json_object *obj,
                                       const char *key, const char *fmt,
                                       va_list args);
  PRINTFRR (3, 4)
  static inline void
  json_object_string_addf (struct json_object *obj, const char *key,
                           const char *fmt, ...)
  {
    va_list args;
  ...
  PRINTFRR (2, 3)
  static inline void
  json_array_string_addf (struct json_object *obj, const char *fmt, ...)
  {
    va_list args;
  ...
  PRINTFRR (3, 4)
  static inline void
  json_object_object_addf (struct json_object *parent,
