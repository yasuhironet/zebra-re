...
extern "C"
{
  ...
  extern struct yang_data *yang_data_new_dec64 (const char *xpath,
                                                double value);
  ...
  extern struct yang_data *yang_data_new_int8 (const char *xpath,
                                               int8_t value);
  ...
  extern struct yang_data *yang_data_new_int16 (const char *xpath,
                                                int16_t value);
  ...
  extern struct yang_data *yang_data_new_int32 (const char *xpath,
                                                int32_t value);
  ...
  extern struct yang_data *yang_data_new_int64 (const char *xpath,
                                                int64_t value);
  ...
  extern struct yang_data *yang_data_new_uint8 (const char *xpath,
                                                uint8_t value);
  ...
  extern void yang_dnode_get_prefix (struct prefix *prefix,
                                     ...
                                     const char *xpath_fmt, ...)
      PRINTFRR (3, 4);
  extern void yang_get_default_prefix (union prefixptr var,
                                       const char *xpath_fmt, ...)
      PRINTFRR (2, 3);
  ...
  extern void yang_get_default_ipv4 (struct in_addr *var,
                                     const char *xpath_fmt, ...)
      PRINTFRR (2, 3);
  ...
  extern void yang_dnode_get_ipv4p (union prefixptr prefix,
                                    ...
                                    const char *xpath_fmt, ...)
      PRINTFRR (3, 4);
  extern void yang_get_default_ipv4p (union prefixptr var,
                                      const char *xpath_fmt, ...)
      PRINTFRR (2, 3);
  ...
  extern void yang_dnode_get_ipv6 (struct in6_addr *addr,
                                   const struct lyd_node *dnode,
                                   const char *xpath_fmt, ...) PRINTFRR (3, 4);
  extern void yang_get_default_ipv6 (struct in6_addr *var,
                                     const char *xpath_fmt, ...)
      PRINTFRR (2, 3);
  ...
  extern void yang_dnode_get_ipv6p (union prefixptr prefix,
                                    ...
                                    const char *xpath_fmt, ...)
      PRINTFRR (3, 4);
  extern void yang_get_default_ipv6p (union prefixptr var,
                                      const char *xpath_fmt, ...)
      PRINTFRR (2, 3);
  ...
  extern void yang_dnode_get_ip (struct ipaddr *addr,
                                 const struct lyd_node *dnode,
                                 const char *xpath_fmt, ...) PRINTFRR (3, 4);
  ...
  void yang_afi_safi_identity2value (const char *key, afi_t *afi,
                                     safi_t *safi);
