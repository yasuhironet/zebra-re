...
void
flex_algos_free (struct flex_algos *flex_algos)
{
...
struct flex_algo *
flex_algo_alloc (struct flex_algos *flex_algos, uint8_t algorithm, void *arg)
{
  struct flex_algo *fa;
...
static void
_flex_algo_delete (struct flex_algos *flex_algos, struct flex_algo *fa)
{
...
void
flex_algo_delete (struct flex_algos *flex_algos, uint8_t algorithm)
{
  struct listnode *node, *nnode;
  struct flex_algo *fa;
 ...
 */
struct flex_algo *
flex_algo_lookup (struct flex_algos *flex_algos, uint8_t algorithm)
{
 ...
 */
bool
flex_algo_definition_cmp (struct flex_algo *fa1, struct flex_algo *fa2)
{
 ...
 */
bool
flex_algo_id_valid (uint16_t algorithm)
{
...
char *
flex_algo_metric_type_print (char *type_str, size_t sz,
...
bool
flex_algo_get_state (struct flex_algos *flex_algos, uint8_t algorithm)
{
...
void
flex_algo_set_state (struct flex_algos *flex_algos, uint8_t algorithm,
                     bool state)
{
  struct flex_algo *fa = flex_algo_lookup (flex_algos, algorithm);
