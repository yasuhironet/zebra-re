...
ldp_sync_info_create (void)
{
  ...
  ldp_sync_info = XCALLOC (MTYPE_LDP_SYNC_INFO, sizeof (struct ldp_sync_info));
...
bool
ldp_sync_if_is_enabled (struct ldp_sync_info *ldp_sync_info)
{
...
bool
ldp_sync_if_down (struct ldp_sync_info *ldp_sync_info)
{
