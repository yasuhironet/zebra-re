...
static int
agentx_log_callback (int major, int minor, void *serverarg, void *clientarg)
{
...
void
smux_init (struct event_loop *tm)
{
  agentx_tm = tm;
...
void
smux_trap (struct variable *vp, size_t vp_len, const oid *ename,
...
int
smux_trap_multi_index (struct variable *vp, size_t vp_len, const oid *ename,
                       ...
                       uint8_t sptrap)
{
  ...
  snmp_varlist_add_variable (
      &notification_vars, objid_snmptrap, objid_snmptrap_len, ASN_OBJECT_ID,
      (uint8_t *) notification_oid, notification_oid_len * sizeof (oid));
      ...
      if (trapobj[i].namelen > 0)
        {
          ...
          oid_copy (oid + namelen + onamelen, iname[iindex].indexname,
