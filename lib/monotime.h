...
#define ONE_YEAR_SECOND (ONE_DAY_SECOND * 365)
  ...
  monotime_since (const struct timeval *ref, struct timeval *out)
  {
    struct timeval tv;
    monotime (&tv);
    timersub (&tv, ref, &tv);
  ...
  static inline int64_t
  monotime_until (const struct timeval *ref, struct timeval *out)
  {
    struct timeval tv;
    monotime (&tv);
    timersub (ref, &tv, &tv);
  ...
  static inline time_t
  monotime_to_realtime (const struct timeval *mono, struct timeval *realout)
  {
...
#define MONOTIME_STRLEN 32
  ...
  static inline char *
  time_to_string (time_t ts, char *buf)
  {
    struct timeval tv;
    time_t tbuf;
  ...
  frrtime_to_interval (time_t t, char *buf, size_t buflen)
  {
    struct tm tm;
