...
void
base64_init_encodestate (struct base64_encodestate *state_in)
{
...
int
base64_encode_blockend (char *code_out, struct base64_encodestate *state_in)
{
  char *codechar = code_out;
...
signed char
base64_decode_value (signed char value_in)
{
...
void
base64_init_decodestate (struct base64_decodestate *state_in)
{
  state_in->step = step_a;
...
int
base64_decode_block (const char *code_in, int length_in, char *plaintext_out,
