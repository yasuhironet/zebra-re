...
struct json_object *
json_object_new_stringv (const char *fmt, va_list args)
{
...
void
json_array_string_add (json_object *json, const char *str)
{
  json_object_array_add (json, json_object_new_string (str));
}

void
json_array_string_addv (json_object *json, const char *fmt, va_list args)
{
...
void
json_object_string_addv (struct json_object *obj, const char *key,
...
void
json_object_object_addv (struct json_object *parent, struct json_object *child,
...
void
json_object_double_add (struct json_object *obj, const char *key, double i)
{
...
void
json_object_boolean_add (struct json_object *obj, const char *key, bool val)
{
