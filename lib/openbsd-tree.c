...
static inline struct rb_entry *
rbe_remove (const struct rb_type *t, struct rbt_tree *rbt,
            struct rb_entry *rbe)
{
...
void *
_rb_find (const struct rb_type *t, const struct rbt_tree *rbt, const void *key)
{
...
void *
_rb_nfind (const struct rb_type *t, const struct rbt_tree *rbt,
           const void *key)
{
  struct rb_entry *tmp = RBH_ROOT (rbt);
  void *node;
...
void *
_rb_root (const struct rb_type *t, const struct rbt_tree *rbt)
{
...
void *
_rb_min (const struct rb_type *t, const struct rbt_tree *rbt)
{
  struct rb_entry *rbe = RBH_ROOT (rbt);
  struct rb_entry *parent = NULL;
...
void *
_rb_max (const struct rb_type *t, const struct rbt_tree *rbt)
{
  struct rb_entry *rbe = RBH_ROOT (rbt);
  struct rb_entry *parent = NULL;
