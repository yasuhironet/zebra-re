...
void
oid2in6_addr (oid oid[], struct in6_addr *addr)
{
  unsigned int i;
  uint8_t *pnt;
...
void
oid_copy_in_addr (oid oid[], const struct in_addr *addr)
{
  int i;
  const uint8_t *pnt;
...
void
oid_copy_in6_addr (oid oid[], const struct in6_addr *addr)
{
  int i;
  const uint8_t *pnt;
...
void
oid2string (oid oid[], int len, char *string)
{
  int i;
  uint8_t *pnt;
...
void
oid_copy_str (oid oid[], const char *string, int len)
{
  int i;
  const uint8_t *pnt;
