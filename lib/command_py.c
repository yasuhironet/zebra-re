...
#define member(name, type)                                                    \
  {                                                                           \
    (char *) #name, type, offsetof (struct wrap_graph_node, name), READONLY,  \
        (char *) #name " (" #type ")"                                         \
  }
 ...
 */
static PyObject *
graph_node_next (PyObject *self, PyObject *args)
{
 ...
 */
static PyObject *
graph_node_join (PyObject *self, PyObject *args)
{
  struct wrap_graph_node *wrap = (struct wrap_graph_node *) self;
...
static PyObject *
graph_to_pyobj (struct wrap_graph *wgraph, struct graph_node *gn)
{
...
#define member(name, type)                                                    \
  {                                                                           \
    (char *) #name, type, offsetof (struct wrap_graph, name), READONLY,       \
        (char *) #name " (" #type ")"                                         \
  }
...
static PyObject *
graph_first (PyObject *self, PyObject *args)
{
...
static PyObject *
graph_parse (PyTypeObject *type, PyObject *args, PyObject *kwds)
{
  ...
  gwrap->nodewrappers =
      calloc (vector_active (graph->nodes), sizeof (gwrap->nodewrappers[0]));
