...
int
routing_control_plane_protocols_control_plane_protocol_create (
...
int
routing_control_plane_protocols_control_plane_protocol_destroy (
...
static void
vrf_to_control_plane_protocol (const struct lyd_node *dnode, char *xpath)
{
  const char *vrf;
...
static void
control_plane_protocol_to_vrf (const struct lyd_node *dnode, char *xpath)
{
  const char *vrf;
...
void
routing_control_plane_protocols_register_vrf_dependency (void)
{
