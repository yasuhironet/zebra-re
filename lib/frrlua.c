...
int
frrlua_table_get_integer (lua_State *L, const char *key)
{
  int result;
...
void
lua_pushprefix (lua_State *L, const struct prefix *prefix)
{
...
void
lua_decode_prefix (lua_State *L, int idx, struct prefix *prefix)
{
...
void *
lua_toprefix (lua_State *L, int idx)
{
...
void
lua_pushinterface (lua_State *L, const struct interface *ifp)
{
  lua_newtable (L);
...
void
lua_decode_interface (lua_State *L, int idx, struct interface *ifp)
{
...
void *
lua_tointerface (lua_State *L, int idx)
{
...
void
lua_pushinaddr (lua_State *L, const struct in_addr *addr)
{
...
void
lua_decode_inaddr (lua_State *L, int idx, struct in_addr *inaddr)
{
...
void *
lua_toinaddr (lua_State *L, int idx)
{
  struct in_addr *inaddr = XCALLOC (MTYPE_SCRIPT_RES, sizeof (struct in_addr));
...
void
lua_pushin6addr (lua_State *L, const struct in6_addr *addr)
{
...
void
lua_decode_in6addr (lua_State *L, int idx, struct in6_addr *in6addr)
{
...
void *
lua_toin6addr (lua_State *L, int idx)
{
...
void
lua_pushipaddr (lua_State *L, const struct ipaddr *addr)
{
...
void
lua_pushethaddr (lua_State *L, const struct ethaddr *addr)
{
  lua_newtable (L);
...
void
lua_pushsockunion (lua_State *L, const union sockunion *su)
{
...
void
lua_decode_sockunion (lua_State *L, int idx, union sockunion *su)
{
  lua_getfield (L, idx, "string");
...
void *
lua_tosockunion (lua_State *L, int idx)
{
...
void
lua_pushintegerp (lua_State *L, const long long *num)
{
  lua_pushinteger (L, *num);
}

void
lua_decode_integerp (lua_State *L, int idx, long long *num)
{
  int isnum;
...
void *
lua_tointegerp (lua_State *L, int idx)
{
...
void
lua_pushnexthop (lua_State *L, const struct nexthop *nexthop)
{
  lua_newtable (L);
...
void
lua_pushnexthop_group (lua_State *L, const struct nexthop_group *ng)
{
  lua_newtable (L);
...
void
lua_decode_stringp (lua_State *L, int idx, char *str)
{
...
void *
lua_tostringp (lua_State *L, int idx)
{
 ...
 */
void
lua_decode_noop (lua_State *L, int idx, const void *ptr)
{
}
 ...
 */
void
lua_decode_integer_noop (lua_State *L, int idx, int i)
{
}
...
void
frrlua_export_logging (lua_State *L)
{
  lua_newtable (L);
