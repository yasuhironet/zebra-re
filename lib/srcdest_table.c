...
static struct route_node *
srcdest_srcnode_get (struct route_node *rn, const struct prefix_ipv6 *src_p)
{
  struct srcdest_rnode *srn;
...
static struct route_node *
srcdest_srcnode_lookup (struct route_node *rn, const struct prefix_ipv6 *src_p)
{
  struct srcdest_rnode *srn;
...
struct route_node *
srcdest_rnode_get (struct route_table *table, union prefixconstptr dst_pu,
...
struct route_node *
srcdest_rnode_lookup (struct route_table *table, union prefixconstptr dst_pu,
                      const struct prefix_ipv6 *src_p)
{
  const struct prefix_ipv6 *dst_p = dst_pu.p6;
  struct route_node *rn;
...
void
srcdest_rnode_prefixes (const struct route_node *rn, const struct prefix **p,
...
const char *
srcdest2str (const struct prefix *dst_p, const struct prefix_ipv6 *src_p,
             char *str, int size)
{
...
const char *
srcdest_rnode2str (const struct route_node *rn, char *str, int size)
{
...
static ssize_t
printfrr_rn (struct fbuf *buf, struct printfrr_eargs *ea, const void *ptr)
{
...
struct route_table *
srcdest_srcnode_table (struct route_node *rn)
{
  if (rnode_is_dstnode (rn))
    {
      struct srcdest_rnode *srn = srcdest_rnode_from_rnode (rn);
