...
#define MAX_COST 0xFFFFFFFF
  ...
  macro_inline int
  q_cmp (const struct c_path *p1, const struct c_path *p2)
  {
  ...
  macro_inline int
  p_cmp (const struct c_path *p1, const struct c_path *p2)
  {
  ...
  macro_inline int
  v_cmp (const struct v_node *p1, const struct v_node *p2)
  {
   ...
   *
   * @param algo	CSPF structure, may be null if a new CSPF must be
   * created
   ...
   */
  extern struct cspf *cspf_init (struct cspf *algo,
                                 const struct ls_vertex *src,
  ...
  /**
   * Clean CSPF structure. Reset all internal list and priority queue for
   * latter initialization of the CSPF structure and new path computation.
   *
   ...
   */
  extern struct c_path *compute_p2p_path (struct cspf *algo,
                                          struct ls_ted *ted);
