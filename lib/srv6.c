...
int
snprintf_seg6_segs (char *str, size_t size, const struct seg6_segs *segs)
{
  str[0] = '\0';
...
void
srv6_locator_chunk_list_free (void *data)
{
...
srv6_locator_chunk_alloc (void)
{
  ...
  chunk =
      XCALLOC (MTYPE_SRV6_LOCATOR_CHUNK, sizeof (struct srv6_locator_chunk));
  return chunk;
}

void
srv6_locator_free (struct srv6_locator *locator)
{
  if (locator)
    {
      QOBJ_UNREG (locator);
...
void
srv6_locator_chunk_free (struct srv6_locator_chunk **chunk)
{
  XFREE (MTYPE_SRV6_LOCATOR_CHUNK, *chunk);
}

json_object *
srv6_locator_chunk_json (const struct srv6_locator_chunk *chunk)
{
...
json_object *
srv6_locator_json (const struct srv6_locator *loc)
{
...
json_object *
srv6_locator_detailed_json (const struct srv6_locator *loc)
{
  struct listnode *node;
  struct srv6_locator_chunk *chunk;
  json_object *jo_root = NULL;
