...
static void
base32 (uint8_t **inpos, int *bitpos, char *out, size_t n_chars)
{
...
static void
xref_add_one (const struct xref *xref)
{
  SHA256_CTX sha;
...
void
xref_gcc_workaround (const struct xref *xref)
{
  xref_add_one (xref);
}

void
xref_block_add (struct xref_block *block)
{
