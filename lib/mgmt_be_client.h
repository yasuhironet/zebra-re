...
#define MGMTD_BE_MAX_CLIENTS_PER_XPATH_REG 32
  ...
  mgmt_be_client_id2name (enum mgmt_be_client_id id)
  {
...
#define MGMTD_DBG_BE_CLIENT_CHECK()                                           \
   ...
   *
   * This call should be added to your component when enabling other vty code
   * to enable mgmtd client debugs. When adding, one needs to also add a their
