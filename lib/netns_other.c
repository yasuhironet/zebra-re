 ...
 */
void
ns_init_management (ns_id_t ns_id)
{
}
...
void
ns_walk_func (int (*func) (struct ns *))
{
}
...
int
ns_switch_to_netns (const char *netns_name)
{
  return 0;
}
 ...
 */
int
ns_enable (struct ns *ns, int (*func) (ns_id_t, void *))
{
  return 0;
}

ns_id_t
ns_map_nsid_with_external (ns_id_t ns_id, bool maporunmap)
{
  return NS_UNKNOWN;
}
