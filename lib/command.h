...
#define EVPN_TYPE_ALL_LIST_HELP_STR                                           \
  EVPN_TYPE_1_HELP_STR EVPN_TYPE_1_HELP_STR EVPN_TYPE_2_HELP_STR              \
      EVPN_TYPE_2_HELP_STR EVPN_TYPE_3_HELP_STR EVPN_TYPE_3_HELP_STR          \
          EVPN_TYPE_4_HELP_STR EVPN_TYPE_4_HELP_STR EVPN_TYPE_5_HELP_STR      \
...
#define install_element(node_type_, cmd_element_)                             \
  do                                                                          \
    {                                                                         \
      static const struct xref_install_element _xref                          \
          __attribute__ ((used)) = {                                          \
            .xref = XREF_INIT (XREFT_INSTALL_ELEMENT, NULL, __func__),        \
   ...
   *
   * matched
   *    If non-null and a match was found, the address of the matched command
   * is stored here. No action otherwise.
   *
   * vtysh
  ...
  extern int cmd_find_cmds (struct vty *vty, struct cmd_token **argv,
                            int argc);
  ...
  extern void command_setup_early_logging (const char *dest,
                                           const char *level);
