...
/* Free list. */
static void
list_free_internal (struct list *l)
{
...
listnode_new (struct list *list, void *val)
{
...
/* Free listnode. */
static void
listnode_free (struct list *list, struct listnode *node)
{
  if (! (list->flags & LINKLIST_FLAG_NODE_MEM_BY_APP))
...
void
listnode_delete (struct list *list, const void *val)
{
...
struct listnode *
listnode_lookup (struct list *list, const void *data)
{
  struct listnode *node;
...
struct listnode *
listnode_lookup_nocheck (struct list *list, void *data)
{
  if (! list)
    return NULL;
...
void
list_sort (struct list *list, int (*cmp) (const void **, const void **))
{
...
struct listnode *
listnode_add_force (struct list **list, void *val)
{
  if (*list == NULL)
    *list = list_new ();
...
void **
list_to_array (struct list *list, void **arr, size_t arrlen)
{
  struct listnode *ln;
  void *vp;
  size_t idx = 0;
