...
#define STREAM_BOUND_WARN(S, WHAT)                                            \
  do                                                                          \
    {                                                                         \
      flog_warn (EC_LIB_STREAM, "%s: Attempt to %s out of bounds", __func__,  \
                 (WHAT));                                                     \
      STREAM_WARN_OFFSETS (S);                                                \
      assert (0);                                                             \
    }                                                                         \
...
struct stream *
stream_copy (struct stream *dest, const struct stream *src)
{
...
struct stream *
stream_dup (const struct stream *s)
{
  struct stream *snew;
...
struct stream *
stream_dupcat (const struct stream *s1, const struct stream *s2, size_t offset)
{
  struct stream *new;
...
size_t
stream_resize_inplace (struct stream **sptr, size_t newsize)
{
...
size_t
stream_get_getp (const struct stream *s)
{
  STREAM_VERIFY_SANE (s);
  return s->getp;
}
...
size_t
stream_get_endp (const struct stream *s)
{
  STREAM_VERIFY_SANE (s);
  return s->endp;
}
...
size_t
stream_get_size (const struct stream *s)
{
  STREAM_VERIFY_SANE (s);
  return s->size;
}
...
bool
stream_forward_getp2 (struct stream *s, size_t size)
{
  STREAM_VERIFY_SANE (s);
...
void
stream_rewind_getp (struct stream *s, size_t size)
{
  STREAM_VERIFY_SANE (s);
...
bool
stream_rewind_getp2 (struct stream *s, size_t size)
{
  STREAM_VERIFY_SANE (s);
...
bool
stream_forward_endp2 (struct stream *s, size_t size)
{
  STREAM_VERIFY_SANE (s);
...
bool
stream_get2 (void *dst, struct stream *s, size_t size)
{
  STREAM_VERIFY_SANE (s);
...
bool
stream_getc2 (struct stream *s, uint8_t *byte)
{
  STREAM_VERIFY_SANE (s);
...
bool
stream_getw2 (struct stream *s, uint16_t *word)
{
  STREAM_VERIFY_SANE (s);
...
bool
stream_getl2 (struct stream *s, uint32_t *l)
{
  STREAM_VERIFY_SANE (s);
...
bool
stream_getq2 (struct stream *s, uint64_t *q)
{
  STREAM_VERIFY_SANE (s);
...
bool
stream_get_ipaddr (struct stream *s, struct ipaddr *ip)
{
  uint16_t ipa_len = 0;
...
int
stream_putc (struct stream *s, uint8_t c)
{
  STREAM_VERIFY_SANE (s);
...
int
stream_put3 (struct stream *s, uint32_t l)
{
  STREAM_VERIFY_SANE (s);
...
int
stream_putc_at (struct stream *s, size_t putp, uint8_t c)
{
  STREAM_VERIFY_SANE (s);
...
int
stream_putw_at (struct stream *s, size_t putp, uint16_t w)
{
  STREAM_VERIFY_SANE (s);
...
int
stream_put3_at (struct stream *s, size_t putp, uint32_t l)
{
  STREAM_VERIFY_SANE (s);
...
int
stream_putl_at (struct stream *s, size_t putp, uint32_t l)
{
  STREAM_VERIFY_SANE (s);
...
/* Put long word to the stream. */
int
stream_put_ipv4 (struct stream *s, uint32_t l)
{
  STREAM_VERIFY_SANE (s);
...
bool
stream_put_ipaddr (struct stream *s, struct ipaddr *ip)
{
...
int
stream_put_in_addr_at (struct stream *s, size_t putp,
...
int
stream_put_in6_addr_at (struct stream *s, size_t putp,
...
int
stream_put_prefix_addpath (struct stream *s, const struct prefix *p,
...
/* Put NLRI with label */
int
stream_put_labeled_prefix (struct stream *s, const struct prefix *p,
...
void
stream_hexdump (const struct stream *s)
{
...
void
stream_fifo_init (struct stream_fifo *fifo)
{
...
void
stream_fifo_push_safe (struct stream_fifo *fifo, struct stream *s)
{
...
struct stream *
stream_fifo_pop_safe (struct stream_fifo *fifo)
{
  struct stream *ret;
...
struct stream *
stream_fifo_head_safe (struct stream_fifo *fifo)
{
  struct stream *ret;
...
void
stream_fifo_clean_safe (struct stream_fifo *fifo)
{
  frr_with_mutex (&fifo->mtx)
    {
...
size_t
stream_fifo_count_safe (struct stream_fifo *fifo)
{
  return atomic_load_explicit (&fifo->count, memory_order_acquire);
}

void
stream_fifo_deinit (struct stream_fifo *fifo)
{
  stream_fifo_clean (fifo);
...
void
stream_pulldown (struct stream *s)
{
