...
int ldp_vty_nbr_session_holdtime (struct vty *, const char *, struct in_addr,
                                  long);
...
int ldp_vty_label_advertise (struct vty *, const char *, const char *,
                             const char *);
int ldp_vty_label_allocate (struct vty *, const char *, const char *,
                            const char *);
int ldp_vty_label_expnull (struct vty *, const char *, const char *);
int ldp_vty_label_accept (struct vty *, const char *, const char *,
                          const char *);
...
int ldp_vty_neighbor_password (struct vty *, const char *, struct in_addr,
                               const char *);
int ldp_vty_neighbor_ttl_security (struct vty *, const char *, struct in_addr,
                                   const char *);
