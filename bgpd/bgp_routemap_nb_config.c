...
static int
bgp_route_match_add (struct route_map_index *index, const char *command,
...
static int
bgp_route_match_delete (struct route_map_index *index, const char *command,
                        const char *arg, route_map_event_t type, char *errmsg,
                        size_t errmsg_len)
{
  enum rmap_compile_rets ret;
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      ret = bgp_route_match_add (rhc->rhc_rmi, "local-preference", local_pref,
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      ret = bgp_route_match_add (rhc->rhc_rmi, "source-protocol", proto,
                                 RMAP_EVENT_MATCH_ADDED, args->errmsg,
                                 args->errmsg_len);
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      ret = bgp_route_match_add (rhc->rhc_rmi, "rpki-extcommunity", rpki,
                                 RMAP_EVENT_MATCH_ADDED, args->errmsg,
                                 args->errmsg_len);
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      ret = bgp_route_match_add (rhc->rhc_rmi, "probability", probability,
                                 RMAP_EVENT_MATCH_ADDED, args->errmsg,
                                 args->errmsg_len);
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      condition =
          yang_dnode_get_string (args->dnode, "../../frr-route-map:condition");
      ...
      if (IS_MATCH_AS_LIST (condition))
        {
          ...
          ret = bgp_route_match_add (rhc->rhc_rmi, "as-path", list_name,
      ...
      else if (IS_MATCH_MAC_LIST (condition))
        {
          ...
          ret = bgp_route_match_add (rhc->rhc_rmi, "mac address", list_name,
      ...
      else if (IS_MATCH_ROUTE_SRC (condition))
        {
          ...
          ret = bgp_route_match_add (rhc->rhc_rmi, "ip route-source",
      ...
      else if (IS_MATCH_ROUTE_SRC_PL (condition))
        {
          ...
          ret = bgp_route_match_add (
              rhc->rhc_rmi, "ip route-source prefix-list", list_name,
    ...
    struct nb_cb_create_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      ret = bgp_route_match_add (rhc->rhc_rmi, "evpn default-route", NULL,
                                 RMAP_EVENT_MATCH_ADDED, args->errmsg,
                                 args->errmsg_len);
    ...
    struct nb_cb_apply_finish_args *args)
{
  ...
  if (yang_dnode_exists (args->dnode, "./comm-list-name-exact-match"))
    exact_match =
        yang_dnode_get_bool (args->dnode, "./comm-list-name-exact-match");
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      rv = generic_set_add (rhc->rhc_rmi, "distance", type, args->errmsg,
                            args->errmsg_len);
      if (rv != CMD_SUCCESS)
        {
          rhc->rhc_shook = NULL;
 ...
 */
int
lib_route_map_entry_set_action_rmap_set_action_extcommunity_nt_modify (
    struct nb_cb_modify_args *args)
{
  struct routemap_hook_context *rhc;
  const char *str;
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      rv = generic_set_add (rhc->rhc_rmi, "extcommunity nt", str, args->errmsg,
                            args->errmsg_len);
      if (rv != CMD_SUCCESS)
        {
          rhc->rhc_shook = NULL;
...
int
lib_route_map_entry_set_action_rmap_set_action_extcommunity_nt_destroy (
    struct nb_cb_destroy_args *args)
{
  switch (args->event)
    {
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      rv = generic_set_add (rhc->rhc_rmi, rhc->rhc_rule, type, args->errmsg,
                            args->errmsg_len);
      ...
      if (action && IS_SET_IPV6_NH_GLOBAL (action))
        {
          ...
          if (IN6_IS_ADDR_UNSPECIFIED (&i6a) || IN6_IS_ADDR_LOOPBACK (&i6a) ||
              IN6_IS_ADDR_MULTICAST (&i6a) || IN6_IS_ADDR_LINKLOCAL (&i6a))
            return NB_ERR_VALIDATION;
        }
    /* FALLTHROUGH */
    case NB_EV_PREPARE:
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      action =
          yang_dnode_get_string (args->dnode, "../../frr-route-map:action");
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      rv = generic_set_add (rhc->rhc_rmi, "label-index", type, args->errmsg,
                            args->errmsg_len);
      if (rv != CMD_SUCCESS)
        {
          rhc->rhc_shook = NULL;
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      rv = generic_set_add (rhc->rhc_rmi, "originator-id", type, args->errmsg,
                            args->errmsg_len);
      if (rv != CMD_SUCCESS)
        {
          rhc->rhc_shook = NULL;
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      rv = generic_set_add (rhc->rhc_rmi, rhc->rhc_rule, aigp, args->errmsg,
                            args->errmsg_len);
      if (rv != CMD_SUCCESS)
        {
          rhc->rhc_shook = NULL;
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      rv = generic_set_add (rhc->rhc_rmi, "community", type, args->errmsg,
                            args->errmsg_len);
      if (rv != CMD_SUCCESS)
        {
          rhc->rhc_shook = NULL;
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      if (none)
        {
          rv = generic_set_add (rhc->rhc_rmi, "large-community", "none",
                                args->errmsg, args->errmsg_len);
          if (rv != CMD_SUCCESS)
            {
              rhc->rhc_shook = NULL;
    ...
    struct nb_cb_apply_finish_args *args)
{
  ...
  argstr =
      XMALLOC (MTYPE_ROUTE_MAP_COMPILED, strlen (asn) + strlen (addr) + 2);
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      rv = generic_set_add (rhc->rhc_rmi, rhc->rhc_rule, value, args->errmsg,
                            args->errmsg_len);
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      if (none)
        {
          rv = generic_set_add (rhc->rhc_rmi, "extcommunity", "none",
                                args->errmsg, args->errmsg_len);
          if (rv != CMD_SUCCESS)
            {
              rhc->rhc_shook = NULL;
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      rv = generic_set_add (rhc->rhc_rmi, "l3vpn next-hop encapsulation", type,
                            args->errmsg, args->errmsg_len);
      if (rv != CMD_SUCCESS)
        {
          rhc->rhc_shook = NULL;
