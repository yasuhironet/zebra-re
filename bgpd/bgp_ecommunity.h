 ...
 */
static inline void
encode_route_target_as (as_t as, uint32_t val, struct ecommunity_val *eval,
                        bool trans)
{
 ...
 */
static inline void
encode_route_target_ip (struct in_addr *ip, uint16_t val,
 ...
 */
static inline void
encode_route_target_as4 (as_t as, uint16_t val, struct ecommunity_val *eval,
                         bool trans)
{
...
static uint32_t
uint32_to_ieee_float_uint32 (uint32_t u)
{
  union
  {
    float r;
 ...
 */
static inline void
encode_lb_extcomm (as_t as, uint32_t bw, bool non_trans,
...
static inline void
encode_origin_validation_state (enum rpki_states state,
...
static inline void
encode_node_target (struct in_addr *node_id, struct ecommunity_val *eval,
                    bool trans)
{
  /*
   *  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
...
extern bool ecommunity_add_val (struct ecommunity *ecom,
                                struct ecommunity_val *eval, bool unique,
                                bool overwrite);
...
extern void bgp_compute_aggregate_ecommunity (struct bgp_aggregate *aggregate,
...
static inline void
ecommunity_strip_rts (struct ecommunity *ecom)
{
