...
extern int bgp_damp_enable (struct bgp *bgp, afi_t afi, safi_t safi,
...
extern int bgp_damp_withdraw (struct bgp_path_info *path,
                              struct bgp_dest *dest, afi_t afi, safi_t safi,
                              int attr_change);
