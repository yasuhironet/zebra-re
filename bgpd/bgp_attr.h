...
extern bgp_size_t bgp_packet_attribute (
    ...
    safi_t safi, struct peer *from, struct prefix_rd *prd, mpls_label_t *label,
    uint32_t num_labels, bool addpath_capable, uint32_t addpath_tx_id,
...
extern void bgp_path_attribute_discard_vty (struct vty *vty, struct peer *peer,
                                            ...
                                            bool set);
extern void bgp_path_attribute_withdraw_vty (struct vty *vty,
                                             struct peer *peer,
                                             const char *withdraw_attrs,
                                             bool set);
extern enum bgp_attr_parse_ret bgp_attr_ignore (struct peer *peer,
                                                uint8_t type);
...
static inline bool
bgp_rmap_nhop_changed (uint32_t out_rmap_flags, uint32_t in_rmap_flags)
{
  return (
      (CHECK_FLAG (out_rmap_flags, BATTR_RMAP_NEXTHOP_PEER_ADDRESS) ||
...
static inline enum pta_type
bgp_attr_get_pmsi_tnl_type (struct attr *attr)
{
  return attr->pmsi_tnl_type;
}

static inline void
bgp_attr_set_pmsi_tnl_type (struct attr *attr, enum pta_type pmsi_tnl_type)
{
...
static inline void
bgp_attr_set_ecommunity (struct attr *attr, struct ecommunity *ecomm)
{
...
static inline void
bgp_attr_set_lcommunity (struct attr *attr, struct lcommunity *lcomm)
{
...
static inline struct community *
bgp_attr_get_community (const struct attr *attr)
{
  return attr->community;
}

static inline void
bgp_attr_set_community (struct attr *attr, struct community *comm)
{
  attr->community = comm;
...
static inline void
bgp_attr_set_ipv6_ecommunity (struct attr *attr, struct ecommunity *ipv6_ecomm)
{
...
static inline struct transit *
bgp_attr_get_transit (const struct attr *attr)
{
  return attr->transit;
}

static inline void
bgp_attr_set_transit (struct attr *attr, struct transit *transit)
{
  attr->transit = transit;
}

static inline uint64_t
bgp_attr_get_aigp_metric (const struct attr *attr)
{
  return attr->aigp_metric;
}

static inline void
bgp_attr_set_aigp_metric (struct attr *attr, uint64_t aigp)
{
...
static inline struct cluster_list *
bgp_attr_get_cluster (const struct attr *attr)
{
  return attr->cluster1;
}

static inline void
bgp_attr_set_cluster (struct attr *attr, struct cluster_list *cl)
{
  attr->cluster1 = cl;
}
...
static inline void
bgp_attr_set_evpn_overlay (struct attr *attr, struct bgp_route_evpn *eo)
{
