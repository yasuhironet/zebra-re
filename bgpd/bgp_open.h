...
#define CAPABILITY_CODE_DYNAMIC_OLD                                           \
  66 /* Dynamic Capability, deprecated since 2003 */
...
#define CAPABILITY_CODE_ORF_OLD                                               \
  130 /* Cooperative Route Filtering Capability(cisco) */
...
#define CAPABILITY_CODE_ENHE_LEN                                              \
  6 /* NRLI AFI = 2, SAFI = 2, Nexthop AFI = 2 */
