...
static unsigned int
bgp_ca_community_hash_key (const void *p)
{
...
static bool
bgp_ca_community_hash_cmp (const void *p1, const void *p2)
{
...
static unsigned int
bgp_ca_alias_hash_key (const void *p)
{
  const struct community_alias *ca = p;
...
static bool
bgp_ca_alias_hash_cmp (const void *p1, const void *p2)
{
  const struct community_alias *ca1 = p1;
  const struct community_alias *ca2 = p2;
...
static void *
bgp_community_alias_alloc (void *p)
{
  const struct community_alias *ca = p;
...
void
bgp_community_alias_init (void)
{
  bgp_ca_community_hash =
      hash_create (bgp_ca_community_hash_key, bgp_ca_community_hash_cmp,
...
void
bgp_community_alias_finish (void)
{
...
static void
bgp_community_alias_show_iterator (struct hash_bucket *hb, struct vty *vty)
{
...
int
bgp_community_alias_write (struct vty *vty)
{
...
void
bgp_ca_community_insert (struct community_alias *ca)
{
  (void) hash_get (bgp_ca_community_hash, ca, bgp_community_alias_alloc);
}

void
bgp_ca_alias_insert (struct community_alias *ca)
{
  (void) hash_get (bgp_ca_alias_hash, ca, bgp_community_alias_alloc);
}

void
bgp_ca_community_delete (struct community_alias *ca)
{
...
void
bgp_ca_alias_delete (struct community_alias *ca)
{
...
struct community_alias *
bgp_ca_alias_lookup (struct community_alias *ca)
{
  return hash_lookup (bgp_ca_alias_hash, ca);
}

const char *
bgp_community2alias (char *community)
{
...
const char *
bgp_alias2community (char *alias)
{
  struct community_alias ca;
  struct community_alias *find;
 ...
 */
char *
bgp_alias2community_str (const char *str)
{
  char **aliases;
  char *comstr;
  int num, i;
...
static int
bgp_community_alias_vector_walker (struct hash_bucket *bucket, void *data)
{
  vector *comps = data;
...
static void
bgp_community_alias_cmd_completion (vector comps, struct cmd_token *token)
{
...
void
bgp_community_alias_command_completion_setup (void)
{
