...
static void
test_run_spf (struct vty *vty, const struct isis_topology *topology,
...
static void
test_run_lfa (struct vty *vty, const struct isis_topology *topology,
              const struct isis_test_node *root, struct isis_area *area,
...
static void
test_run_rlfa (struct vty *vty, const struct isis_topology *topology,
               const struct isis_test_node *root, struct isis_area *area,
               struct lspdb_head *lspdb, int level, int tree,
               struct lfa_protected_resource *protected_resource)
{
  ...
  frr_each_safe (rlfa_tree, &spftree_self->lfa.remote.rlfas, rlfa)
    {
      ...
      response.pq_label =
          test_topology_node_ldp_label (topology, rlfa->pq_address);
...
static void
test_run_ti_lfa (struct vty *vty, const struct isis_topology *topology,
                 const struct isis_test_node *root, struct isis_area *area,
                 struct lspdb_head *lspdb, int level, int tree,
                 struct lfa_protected_resource *protected_resource)
{
...
static int
test_run (struct vty *vty, const struct isis_topology *topology,
