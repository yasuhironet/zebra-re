...
static int
list_cmp (const struct item *a, const struct item *b)
{
  if (a->val > b->val)
    return 1;
  if (a->val < b->val)
...
static void
ts_hash_head (struct list_head *h, const char *text, const char *expect)
{
...
ts_hash ("add-dup+find_{lt,gteq}",
  ...
  ts_hashx (
      "del",
      "cb2e5d80f08a803ef7b56c15e981b681adcea214bebc2f55e12e0bfb242b07ca");
  ...
  ts_hashx (
      "frr_each_safe+del",
      "e0beb71dd963a75af05b722b8e71b61b304587d860c8accdc4349067542b86bb");
  ...
  ts_hash ("del-prng",
           "86d568a95eb429dab3162976c5a5f3f75aabc835932cd682aa280b6923549564");
  ...
  ts_hash ("pop#1",
           "42b8950c880535b2d2e0c980f9845f7841ecf675c0fb9801aec4170d2036349d");
  ...
  assert (list_count (&head) == k);
  assert (list_first (&head) != NULL);
  ts_hash ("fill / add_head",
           "3084d8f8a28b8c756ccc0a92d60d86f6d776273734ddc3f9e1d89526f5ca2795");
  ...
  ts_hash ("del-prng",
           "dc916fa7ea4418792c7c8232d74df2887f9975ead4222f4b977be6bc0b52285e");
  ...
  assert (list_count (&head) == k);
  assert (list_first (&head) != NULL);
  ts_hash ("fill / add_{head,tail}",
           "93fa180a575c96e4b6c3775c2de7843ee3254dd6ed5af699bbe155f994114b06");
  ...
  assert (list_count (&head) == k);
  assert (list_first (&head) != NULL);
  ts_hash ("prng add/del",
           "4909f31d06bb006efca4dfeebddb8de071733ddf502f89b6d532155208bbc6df");
              ...
              do
                {
                  j = prng_rand (prng) % NITEM;
                  prev = &itm[j];
                  if (prev->scratchpad == 0 || prev == item)
                    prev = NULL;
                  l++;
                }
              while (! prev && l < 10);
  ...
  assert (list_count (&head) == k);
  assert (list_first (&head) != NULL);
  ts_hash ("prng add/after/del",
           "84c5fc83294eabebb9808ccbba32a303c4fca084db87ed1277d2bae1f8c5bee4");
#endif
