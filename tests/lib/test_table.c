 ...
 */
static void
verify_next_by_iterating (struct route_table *table, struct prefix *target_pfx,
...
test_get_next (void)
{
   ...
   */
  add_nodes (table, "1.0.0.0/16", "1.0.0.0/24", "1.0.1.0/24", "1.0.128.0/17",
             NULL);
