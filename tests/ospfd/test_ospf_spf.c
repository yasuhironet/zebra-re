...
static struct ospf *
test_init (struct ospf_test_node *root)
{
  struct ospf *ospf;
...
static void
test_run_spf (struct vty *vty, struct ospf *ospf,
...
static int
test_run (struct vty *vty, struct ospf_topology *topology,
          struct ospf_test_node *root, enum protection_type protection_type,
          bool verbose)
{
  struct ospf *ospf;
