...
#define ZEVPN_READY_FOR_BGP (1 << 0) /* ready to be sent to BGP */
  ...
  zevpn_map_to_svi (struct zebra_evpn *zevpn)
  {
  ...
  int zebra_evpn_del_macip_for_intf (struct interface *ifp,
                                     struct zebra_evpn *zevpn);
  int zebra_evpn_advertise_subnet (struct zebra_evpn *zevpn,
                                   struct interface *ifp, int advertise);
  ...
  void zebra_evpn_read_mac_neigh (struct zebra_evpn *zevpn,
                                  struct interface *ifp);
