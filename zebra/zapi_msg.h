...
extern "C"
{
  ...
  extern int zsend_interface_add (struct zserv *zclient,
                                  struct interface *ifp);
  extern int zsend_interface_delete (struct zserv *zclient,
                                     struct interface *ifp);
  ...
  extern bool zserv_nexthop_num_warn (const char *caller,
