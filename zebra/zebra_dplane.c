...
intf_addr_update_internal (const struct interface *ifp,
                           const struct connected *ifc, enum dplane_op_e op);
static enum zebra_dplane_result
...
void
dplane_enable_sys_route_notifs (void)
{
 ...
 */
static void
dplane_ctx_free_internal (struct zebra_dplane_ctx *ctx)
{
  ...
  switch (ctx->zd_op)
    ...
    case DPLANE_OP_ROUTE_NOTIFY:
      ...
      while ((if_extra =
                  dplane_intf_extra_list_pop (&ctx->u.rinfo.intf_extra_list)))
    ...
    case DPLANE_OP_LSP_NOTIFY:
      {
        ...
        frr_each_safe (nhlfe_list, &(ctx->u.lsp.backup_nhlfe_list), nhlfe)
          {
            nhlfe_list_del (&ctx->u.lsp.backup_nhlfe_list, nhlfe);
            zebra_mpls_nhlfe_free (nhlfe);
          }
 ...
 */
static void
dplane_ctx_free (struct zebra_dplane_ctx **pctx)
{
  if (pctx == NULL)
    return;
 ...
 */
void
dplane_ctx_reset (struct zebra_dplane_ctx *ctx)
{
 ...
 */
void
dplane_ctx_fini (struct zebra_dplane_ctx **pctx)
{
...
void
dplane_ctx_q_init (struct dplane_ctx_list_head *q)
{
...
void
dplane_ctx_enqueue_tail (struct dplane_ctx_list_head *list,
...
void
dplane_ctx_list_append (struct dplane_ctx_list_head *to_list,
...
struct zebra_dplane_ctx *
dplane_ctx_get_head (struct dplane_ctx_list_head *q)
{
...
struct zebra_dplane_ctx *
dplane_ctx_dequeue (struct dplane_ctx_list_head *q)
{
...
dplane_ctx_get_status (const struct zebra_dplane_ctx *ctx)
{
...
void
dplane_ctx_set_status (struct zebra_dplane_ctx *ctx,
...
uint32_t
dplane_ctx_get_provider (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
 ...
 */
void
dplane_ctx_set_skip_kernel (struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
bool
dplane_ctx_is_skip_kernel (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_op (struct zebra_dplane_ctx *ctx, enum dplane_op_e op)
{
  DPLANE_CTX_VALID (ctx);
  ctx->zd_op = op;
}
...
enum dplane_op_e
dplane_ctx_get_op (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
const char *
dplane_op2str (enum dplane_op_e op)
{
...
const char *
dplane_res2str (enum zebra_dplane_result res)
{
  const char *ret = "<Unknown>";
...
void
dplane_ctx_set_dest (struct zebra_dplane_ctx *ctx, const struct prefix *dest)
{
  DPLANE_CTX_VALID (ctx);
...
const struct prefix *
dplane_ctx_get_dest (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_src (struct zebra_dplane_ctx *ctx, const struct prefix *src)
{
  DPLANE_CTX_VALID (ctx);
...
const struct prefix *
dplane_ctx_get_src (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
bool
dplane_ctx_is_update (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_seq (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_old_seq (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_vrf (struct zebra_dplane_ctx *ctx, vrf_id_t vrf)
{
  DPLANE_CTX_VALID (ctx);
...
vrf_id_t
dplane_ctx_get_vrf (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_ns_id (struct zebra_dplane_ctx *ctx, ns_id_t nsid)
{
  DPLANE_CTX_VALID (ctx);
...
ns_id_t
dplane_ctx_get_ns_id (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
bool
dplane_ctx_is_from_notif (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_notif_provider (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_notif_provider (struct zebra_dplane_ctx *ctx, uint32_t id)
{
  DPLANE_CTX_VALID (ctx);
...
const char *
dplane_ctx_get_ifname (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_ifname (struct zebra_dplane_ctx *ctx, const char *ifname)
{
  DPLANE_CTX_VALID (ctx);
...
ifindex_t
dplane_ctx_get_ifindex (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_ifindex (struct zebra_dplane_ctx *ctx, ifindex_t ifindex)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_type (struct zebra_dplane_ctx *ctx, int type)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_get_type (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_get_old_type (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_afi (struct zebra_dplane_ctx *ctx, afi_t afi)
{
  DPLANE_CTX_VALID (ctx);
...
afi_t
dplane_ctx_get_afi (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_safi (struct zebra_dplane_ctx *ctx, safi_t safi)
{
  DPLANE_CTX_VALID (ctx);
...
safi_t
dplane_ctx_get_safi (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_table (struct zebra_dplane_ctx *ctx, uint32_t table)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_table (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
route_tag_t
dplane_ctx_get_tag (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_tag (struct zebra_dplane_ctx *ctx, route_tag_t tag)
{
  DPLANE_CTX_VALID (ctx);
...
route_tag_t
dplane_ctx_get_old_tag (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint16_t
dplane_ctx_get_instance (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_instance (struct zebra_dplane_ctx *ctx, uint16_t instance)
{
  DPLANE_CTX_VALID (ctx);
...
uint16_t
dplane_ctx_get_old_instance (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_flags (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_flags (struct zebra_dplane_ctx *ctx, uint32_t flags)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_metric (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_old_metric (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_mtu (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_nh_mtu (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint8_t
dplane_ctx_get_distance (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_distance (struct zebra_dplane_ctx *ctx, uint8_t distance)
{
  DPLANE_CTX_VALID (ctx);
...
uint8_t
dplane_ctx_get_old_distance (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_tc_qdisc_get_kind (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_tc_class_get_handle (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_tc_class_get_kind (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint64_t
dplane_ctx_tc_class_get_rate (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint64_t
dplane_ctx_tc_class_get_ceil (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_tc_filter_get_kind (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_tc_filter_get_priority (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_tc_filter_get_handle (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint16_t
dplane_ctx_tc_filter_get_eth_proto (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_tc_filter_get_filter_bm (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint8_t
dplane_ctx_tc_filter_get_ip_proto (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint8_t
dplane_ctx_tc_filter_get_dsfield (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_tc_filter_get_classid (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
 ...
 */
void
dplane_ctx_set_nexthops (struct zebra_dplane_ctx *ctx, struct nexthop *nh)
{
  DPLANE_CTX_VALID (ctx);
 ...
 */
void
dplane_ctx_set_backup_nhg (struct zebra_dplane_ctx *ctx,
...
uint32_t
dplane_ctx_get_nhg_id (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
dplane_ctx_get_ng (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
dplane_ctx_get_ns (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_get_ns_sock (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_nhe_id (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_old_nhe_id (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
afi_t
dplane_ctx_get_nhe_afi (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
vrf_id_t
dplane_ctx_get_nhe_vrf_id (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_get_nhe_type (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint8_t
dplane_ctx_get_nhe_nh_grp_count (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
mpls_label_t
dplane_ctx_get_in_label (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_in_label (struct zebra_dplane_ctx *ctx, mpls_label_t label)
{
  DPLANE_CTX_VALID (ctx);
...
uint8_t
dplane_ctx_get_addr_family (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_addr_family (struct zebra_dplane_ctx *ctx, uint8_t family)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_lsp_flags (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_lsp_flags (struct zebra_dplane_ctx *ctx, uint32_t flags)
{
  DPLANE_CTX_VALID (ctx);
...
const struct nhlfe_list_head *
dplane_ctx_get_nhlfe_list (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
const struct nhlfe_list_head *
dplane_ctx_get_backup_nhlfe_list (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
struct zebra_nhlfe *
dplane_ctx_add_nhlfe (struct zebra_dplane_ctx *ctx, enum lsp_types_t lsp_type,
                      ...
                      mpls_label_t *out_labels)
{
  ...
  nhlfe = zebra_mpls_lsp_add_nhlfe (&(ctx->u.lsp), lsp_type, nh_type, gate,
...
struct zebra_nhlfe *
dplane_ctx_add_backup_nhlfe (struct zebra_dplane_ctx *ctx,
                             ...
                             uint8_t num_labels, mpls_label_t *out_labels)
{
  ...
  nhlfe = zebra_mpls_lsp_add_backup_nhlfe (
      &(ctx->u.lsp), lsp_type, nh_type, gate, ifindex, num_labels, out_labels);
...
uint32_t
dplane_ctx_get_lsp_num_ecmp (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
mpls_label_t
dplane_ctx_get_pw_local_label (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
mpls_label_t
dplane_ctx_get_pw_remote_label (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_get_pw_type (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_get_pw_af (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_pw_flags (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_get_pw_status (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_pw_status (struct zebra_dplane_ctx *ctx, int status)
{
  DPLANE_CTX_VALID (ctx);
...
const union g_addr *
dplane_ctx_get_pw_dest (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
const union pw_protocol_fields *
dplane_ctx_get_pw_proto (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_intf_metric (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_intf_metric (struct zebra_dplane_ctx *ctx, uint32_t metric)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_intf_pd_reason_val (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_intf_pd_reason_val (struct zebra_dplane_ctx *ctx, bool val)
{
  DPLANE_CTX_VALID (ctx);
...
bool
dplane_ctx_intf_is_protodown (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
bool
dplane_ctx_intf_is_connected (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
bool
dplane_ctx_intf_is_secondary (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
bool
dplane_ctx_intf_is_broadcast (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_intf_set_connected (struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_intf_set_secondary (struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_intf_set_broadcast (struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
const struct prefix *
dplane_ctx_get_intf_addr (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_intf_addr (struct zebra_dplane_ctx *ctx, const struct prefix *p)
{
  DPLANE_CTX_VALID (ctx);
...
bool
dplane_ctx_intf_has_dest (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
const struct prefix *
dplane_ctx_get_intf_dest (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_intf_dest (struct zebra_dplane_ctx *ctx, const struct prefix *p)
{
  DPLANE_CTX_VALID (ctx);
...
bool
dplane_ctx_intf_has_label (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
const char *
dplane_ctx_get_intf_label (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_intf_label (struct zebra_dplane_ctx *ctx, const char *label)
{
  size_t len;
...
vlanid_t
dplane_ctx_mac_get_vlan (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
bool
dplane_ctx_mac_is_sticky (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_mac_get_nhg_id (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_mac_get_update_flags (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
dplane_ctx_mac_get_addr (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
vni_t
dplane_ctx_mac_get_vni (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
dplane_ctx_mac_get_vtep_ip (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
ifindex_t
dplane_ctx_mac_get_br_ifindex (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
const struct ipaddr *
dplane_ctx_neigh_get_ipaddr (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
const struct ethaddr *
dplane_ctx_neigh_get_mac (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
vni_t
dplane_ctx_neigh_get_vni (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_neigh_get_flags (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint16_t
dplane_ctx_neigh_get_state (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_neigh_get_update_flags (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_rule_get_sock (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
const char *
dplane_ctx_rule_get_ifname (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_rule_get_unique (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
int
dplane_ctx_rule_get_seq (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_rule_get_priority (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_rule_get_old_priority (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_rule_get_table (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_rule_get_old_table (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_rule_get_filter_bm (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_rule_get_old_filter_bm (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_rule_get_fwmark (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_rule_get_old_fwmark (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint8_t
dplane_ctx_rule_get_ipproto (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint8_t
dplane_ctx_rule_get_old_ipproto (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint8_t
dplane_ctx_rule_get_dsfield (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint8_t
dplane_ctx_rule_get_old_dsfield (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
uint32_t
dplane_ctx_get_br_port_flags (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
                                ...
                                struct zebra_pbr_ipset_entry *entry)
{
  ...
  memcpy (entry, &ctx->u.ipset_entry.entry,
...
int
dplane_ctx_rule_get_out_ifindex (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
intptr_t
dplane_ctx_rule_get_dp_flow_ptr (const struct zebra_dplane_ctx *ctx)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_rule_set_dp_flow_ptr (struct zebra_dplane_ctx *ctx,
                                 intptr_t dp_flow_ptr)
{
  DPLANE_CTX_VALID (ctx);
...
{
  return dplane_intf_extra_list_const_first (&ctx->u.rinfo.intf_extra_list);
}
...
vrf_id_t
dplane_intf_extra_get_vrfid (const struct dplane_intf_extra *ptr)
{
  return ptr->vrf_id;
}

uint32_t
dplane_intf_extra_get_ifindex (const struct dplane_intf_extra *ptr)
{
  return ptr->ifindex;
}

uint32_t
dplane_intf_extra_get_flags (const struct dplane_intf_extra *ptr)
{
  return ptr->flags;
}

uint32_t
dplane_intf_extra_get_status (const struct dplane_intf_extra *ptr)
{
  return ptr->status;
}
...
void
dplane_ctx_set_netconf_mpls (struct zebra_dplane_ctx *ctx,
...
void
dplane_ctx_set_netconf_mcast (struct zebra_dplane_ctx *ctx,
                              enum dplane_netconf_status_e val)
{
  DPLANE_CTX_VALID (ctx);
...
void
dplane_ctx_set_netconf_linkdown (struct zebra_dplane_ctx *ctx,
                                 enum dplane_netconf_status_e val)
{
  DPLANE_CTX_VALID (ctx);
 ...
 */
uint32_t
dplane_get_in_queue_limit (void)
{
 ...
 */
void
dplane_set_in_queue_limit (uint32_t limit, bool set)
{
 ...
 */
static void
ctx_info_from_zns (struct zebra_dplane_info *ns_info, struct zebra_ns *zns)
{
 ...
 */
static int
dplane_ctx_ns_init (struct zebra_dplane_ctx *ctx, struct zebra_ns *zns,
                    bool is_update)
{
...
int
dplane_ctx_route_init_basic (struct zebra_dplane_ctx *ctx, enum dplane_op_e op,
                             struct route_entry *re, const struct prefix *p,
 ...
 */
int
dplane_ctx_route_init (struct zebra_dplane_ctx *ctx, enum dplane_op_e op,
                       struct route_node *rn, struct route_entry *re)
{
   ...
   */
  if (! re || ! rn)
    return dplane_ctx_route_init_basic (ctx, op, NULL, NULL, NULL, AFI_UNSPEC,
                                        SAFI_UNSPEC);
  ...
  copy_nexthops (&(ctx->u.rinfo.zd_ng.nexthop), re->nhe->nhg.nexthop, NULL);
      ...
      if (dplane_collect_extra_intf_info)
        {
          ...
          if (ifp)
            {
              if_extra =
                  XCALLOC (MTYPE_DP_INTF, sizeof (struct dplane_intf_extra));
              if_extra->vrf_id = nexthop->vrf_id;
              if_extra->ifindex = nexthop->ifindex;
              if_extra->flags = ifp->flags;
              if_extra->status = ifp->status;

              dplane_intf_extra_list_add_tail (&ctx->u.rinfo.intf_extra_list,
                                               if_extra);
            }
        }
  ...
  if (op == DPLANE_OP_SYS_ROUTE_ADD || op == DPLANE_OP_SYS_ROUTE_DELETE)
    {
      return AOK;
    }
...
static int
dplane_ctx_tc_qdisc_init (struct zebra_dplane_ctx *ctx, enum dplane_op_e op,
...
static int
dplane_ctx_tc_class_init (struct zebra_dplane_ctx *ctx, enum dplane_op_e op,
...
static int
dplane_ctx_tc_filter_init (struct zebra_dplane_ctx *ctx, enum dplane_op_e op,
 ...
 */
int
dplane_ctx_nexthop_init (struct zebra_dplane_ctx *ctx, enum dplane_op_e op,
                         struct nhg_hash_entry *nhe)
{
  ...
  if (! zebra_nhg_depends_is_empty (nhe) &&
    ...
    ctx->u.rinfo.nhe.nh_grp_count =
        zebra_nhg_nhe2grp (ctx->u.rinfo.nhe.nh_grp, nhe, MULTIPATH_NUM);
 ...
 */
int
dplane_ctx_intf_init (struct zebra_dplane_ctx *ctx, enum dplane_op_e op,
                      const struct interface *ifp)
{
  struct zebra_ns *zns;
  struct zebra_if *zif;
 ...
 */
int
dplane_ctx_lsp_init (struct zebra_dplane_ctx *ctx, enum dplane_op_e op,
                     struct zebra_lsp *lsp)
{
  int ret = AOK;
  ...
  if (IS_ZEBRA_DEBUG_DPLANE_DETAIL)
    zlog_debug ("init dplane ctx %s: in-label %u ecmp# %d", dplane_op2str (op),
  ...
  frr_each (nhlfe_list, &lsp->nhlfe_list, nhlfe)
    {
      ...
      new_nhlfe =
          zebra_mpls_lsp_add_nh (&(ctx->u.lsp), nhlfe->type, nhlfe->nexthop);
      ...
      if (CHECK_FLAG (new_nhlfe->nexthop->flags, NEXTHOP_FLAG_HAS_BACKUP))
        {
          new_nhlfe->nexthop->backup_num = nhlfe->nexthop->backup_num;
          memcpy (new_nhlfe->nexthop->backup_idx, nhlfe->nexthop->backup_idx,
  ...
  frr_each (nhlfe_list, &lsp->backup_nhlfe_list, nhlfe)
    {
      ...
      new_nhlfe = zebra_mpls_lsp_add_backup_nh (&(ctx->u.lsp), nhlfe->type,
                                                nhlfe->nexthop);
      if (new_nhlfe == NULL || new_nhlfe->nexthop == NULL)
        {
          ret = ENOMEM;
 ...
 */
static int
dplane_ctx_pw_init (struct zebra_dplane_ctx *ctx, enum dplane_op_e op,
                    struct zebra_pw *pw)
{
  int ret = EINVAL;
  struct prefix p;
  ...
  if (re)
    {
      ...
      copy_nexthops (&(ctx->u.pw.primary_nhg.nexthop), re->nhe->nhg.nexthop,
                     NULL);
 ...
 */
static void
dplane_ctx_rule_init_single (struct dplane_ctx_rule *dplane_rule,
  ...
  if (n && (n->flags & ZEBRA_NEIGH_ENT_ACTIVE))
    {
      struct interface *ifp =
          if_lookup_by_index_per_ns (zebra_ns_lookup (NS_DEFAULT), n->ifindex);
      if (ifp)
        {
 ...
 */
static int
dplane_ctx_rule_init (struct zebra_dplane_ctx *ctx, enum dplane_op_e op,
                      ...
                      struct zebra_pbr_rule *old_rule)
{
  if (IS_ZEBRA_DEBUG_DPLANE_DETAIL)
    zlog_debug (
        ...
        dplane_op2str (op), new_rule->ifname, new_rule->rule.priority,
        new_rule->rule.filter.fwmark, &new_rule->rule.filter.src_ip,
        &new_rule->rule.filter.dst_ip, new_rule->rule.action.table);
...
static void
zebra_dplane_interface_name_list_deletion (void *data)
{
 ...
 */
static int
dplane_ctx_iptable_init (struct zebra_dplane_ctx *ctx, enum dplane_op_e op,
                         struct zebra_pbr_iptable *iptable)
{
  char *ifname;
 ...
 */
static int
dplane_ctx_ipset_init (struct zebra_dplane_ctx *ctx, enum dplane_op_e op,
                       struct zebra_pbr_ipset *ipset)
{
  if (IS_ZEBRA_DEBUG_DPLANE_DETAIL)
    {
 ...
 */
static int
dplane_update_enqueue (struct zebra_dplane_ctx *ctx)
{
  int ret = EINVAL;
  uint32_t high, curr;
  ...
  curr = atomic_fetch_add_explicit (&(zdplane_info.dg_routes_queued), 1,
                                    memory_order_seq_cst);
  ...
  while (high < curr)
    {
      if (atomic_compare_exchange_weak_explicit (
              &zdplane_info.dg_routes_queued_max, &high, curr,
      ...
      if ((op == DPLANE_OP_ROUTE_UPDATE) && old_re && (old_re != re))
        {
          ...
          old_re->dplane_sequence = zebra_router_get_next_sequence ();
      ...
      if ((dplane_ctx_get_type (ctx) == dplane_ctx_get_old_type (ctx)) &&
          ...
          (dplane_ctx_get_nhe_id (ctx) >= ZEBRA_NHG_PROTO_LOWER))
        {
          ...
          if (IS_ZEBRA_DEBUG_DPLANE)
            zlog_debug ("%s: Ignoring Route exactly the same", __func__);
...
enum zebra_dplane_result
dplane_tc_qdisc_install (struct zebra_tc_qdisc *qdisc)
{
...
enum zebra_dplane_result
dplane_tc_class_add (struct zebra_tc_class *class)
{
  return tc_class_update_internal (DPLANE_OP_TC_CLASS_ADD, class);
}

enum zebra_dplane_result
dplane_tc_class_delete (struct zebra_tc_class *class)
{
  return tc_class_update_internal (DPLANE_OP_TC_CLASS_DELETE, class);
}

enum zebra_dplane_result
dplane_tc_class_update (struct zebra_tc_class *class)
{
  return tc_class_update_internal (DPLANE_OP_TC_CLASS_UPDATE, class);
}

enum zebra_dplane_result
dplane_tc_filter_add (struct zebra_tc_filter *filter)
{
 ...
 */
enum zebra_dplane_result
dplane_route_add (struct route_node *rn, struct route_entry *re)
{
  ...
  ret = dplane_route_update_internal (rn, re, NULL, DPLANE_OP_ROUTE_INSTALL);
 ...
 */
enum zebra_dplane_result
dplane_route_update (struct route_node *rn, struct route_entry *re,
                     struct route_entry *old_re)
{
  ...
  ret = dplane_route_update_internal (rn, re, old_re, DPLANE_OP_ROUTE_UPDATE);
 ...
 */
enum zebra_dplane_result
dplane_route_delete (struct route_node *rn, struct route_entry *re)
{
  enum zebra_dplane_result ret = ZEBRA_DPLANE_REQUEST_FAILURE;
  ...
  ret = dplane_route_update_internal (rn, re, NULL, DPLANE_OP_ROUTE_DELETE);
 ...
 */
enum zebra_dplane_result
dplane_sys_route_add (struct route_node *rn, struct route_entry *re)
{
  enum zebra_dplane_result ret = ZEBRA_DPLANE_REQUEST_FAILURE;
  ...
  ret = dplane_route_update_internal (rn, re, NULL, DPLANE_OP_SYS_ROUTE_ADD);
 ...
 */
enum zebra_dplane_result
dplane_sys_route_del (struct route_node *rn, struct route_entry *re)
{
  enum zebra_dplane_result ret = ZEBRA_DPLANE_REQUEST_FAILURE;
  ...
  ret =
      dplane_route_update_internal (rn, re, NULL, DPLANE_OP_SYS_ROUTE_DELETE);
 ...
 */
enum zebra_dplane_result
dplane_route_notif_update (struct route_node *rn, struct route_entry *re,
                           enum dplane_op_e op, struct zebra_dplane_ctx *ctx)
{
  enum zebra_dplane_result result = ZEBRA_DPLANE_REQUEST_FAILURE;
  int ret = EINVAL;
   ...
   * state.
   */
  if (op == DPLANE_OP_ROUTE_UPDATE || op == DPLANE_OP_ROUTE_INSTALL)
    {
      ...
      nhg = rib_get_fib_nhg (re);
      if (nhg && nhg->nexthop)
        copy_nexthops (&(new_ctx->u.rinfo.zd_ng.nexthop), nhg->nexthop, NULL);

      /* Check for installed backup nexthops also */
      nhg = rib_get_fib_backup_nhg (re);
      if (nhg && nhg->nexthop)
        {
          copy_nexthops (&(new_ctx->u.rinfo.zd_ng.nexthop), nhg->nexthop,
                         NULL);
        }
  ...
  dplane_ctx_set_notif_provider (new_ctx, dplane_ctx_get_notif_provider (ctx));
 ...
 */
enum zebra_dplane_result
dplane_nexthop_add (struct nhg_hash_entry *nhe)
{
  enum zebra_dplane_result ret = ZEBRA_DPLANE_REQUEST_FAILURE;
 ...
 */
enum zebra_dplane_result
dplane_nexthop_update (struct nhg_hash_entry *nhe)
{
  enum zebra_dplane_result ret = ZEBRA_DPLANE_REQUEST_FAILURE;
 ...
 */
enum zebra_dplane_result
dplane_nexthop_delete (struct nhg_hash_entry *nhe)
{
  enum zebra_dplane_result ret = ZEBRA_DPLANE_REQUEST_FAILURE;
 ...
 */
enum zebra_dplane_result
dplane_lsp_add (struct zebra_lsp *lsp)
{
 ...
 */
enum zebra_dplane_result
dplane_lsp_update (struct zebra_lsp *lsp)
{
  enum zebra_dplane_result ret =
 ...
 */
enum zebra_dplane_result
dplane_lsp_delete (struct zebra_lsp *lsp)
{
  enum zebra_dplane_result ret =
                         ...
                         struct zebra_dplane_ctx *notif_ctx)
{
  ...
  dplane_ctx_set_notif_provider (ctx,
 ...
 */
enum zebra_dplane_result
dplane_pw_install (struct zebra_pw *pw)
{
 ...
 */
enum zebra_dplane_result
dplane_pw_uninstall (struct zebra_pw *pw)
{
 ...
 */
static enum zebra_dplane_result
lsp_update_internal (struct zebra_lsp *lsp, enum dplane_op_e op)
{
  enum zebra_dplane_result result = ZEBRA_DPLANE_REQUEST_FAILURE;
  int ret = EINVAL;
  struct zebra_dplane_ctx *ctx = NULL;
 ...
 */
static enum zebra_dplane_result
pw_update_internal (struct zebra_pw *pw, enum dplane_op_e op)
{
  enum zebra_dplane_result result = ZEBRA_DPLANE_REQUEST_FAILURE;
  int ret;
  struct zebra_dplane_ctx *ctx = NULL;
  ...
  /* Update counter */
  atomic_fetch_add_explicit (&zdplane_info.dg_pws_in, 1, memory_order_relaxed);
  ...
  if (IS_ZEBRA_DEBUG_DPLANE_DETAIL || IS_ZEBRA_DEBUG_EVPN_MH_ES)
    {
      ...
      zlog_debug (
          ...
          dplane_op2str (op), ifp->name, flags, backup_nhg_id, vtep_str);
    }
...
dplane_intf_mpls_modify_state (const struct interface *ifp, bool set)
{
  ...
  if (set)
    ...
    dplane_ctx_set_netconf_mpls (ctx, DPLANE_NETCONF_STATUS_DISABLED);
  /* Increment counter */
  ...
  if (ret == AOK)
    ...
    {
      /* Error counter */
      atomic_fetch_add_explicit (&zdplane_info.dg_intf_changes_errors, 1,
                                 memory_order_relaxed);
      dplane_ctx_free (&ctx);
    }
 ...
 */
enum zebra_dplane_result
dplane_intf_addr_set (const struct interface *ifp, const struct connected *ifc)
{
 ...
 */
enum zebra_dplane_result
dplane_intf_addr_unset (const struct interface *ifp,
                           ...
                           const struct connected *ifc, enum dplane_op_e op)
{
  ...
  if (IS_ZEBRA_DEBUG_DPLANE_DETAIL)
    zlog_debug ("init intf ctx %s: idx %d, addr %u:%pFX", dplane_op2str (op),
                ifp->ifindex, ifp->vrf->vrf_id, ifc->address);
  ...
  if (CONNECTED_PEER (ifc))
    {
      ...
      ctx->u.intf.flags |= (DPLANE_INTF_CONNECTED | DPLANE_INTF_HAS_DEST);
    }
  ...
  if (ret == AOK)
    ...
    {
      /* Error counter */
      atomic_fetch_add_explicit (&zdplane_info.dg_intf_addr_errors, 1,
                                 memory_order_relaxed);
      dplane_ctx_free (&ctx);
    }
 ...
 */
enum zebra_dplane_result
dplane_intf_add (const struct interface *ifp)
{
  enum zebra_dplane_result ret = ZEBRA_DPLANE_REQUEST_FAILURE;
 ...
 */
enum zebra_dplane_result
dplane_intf_update (const struct interface *ifp)
{
  enum zebra_dplane_result ret = ZEBRA_DPLANE_REQUEST_FAILURE;
 ...
 */
enum zebra_dplane_result
dplane_intf_delete (const struct interface *ifp)
{
  enum zebra_dplane_result ret = ZEBRA_DPLANE_REQUEST_FAILURE;
                    ...
                    bool was_static)
{
  ...
  result = mac_update_common (DPLANE_OP_MAC_INSTALL, ifp, bridge_ifp, vid, mac,
                              vni, vtep_ip, sticky, nhg_id, update_flags);
  return result;
}
 ...
 */
enum zebra_dplane_result
dplane_rem_mac_del (const struct interface *ifp,
                    const struct interface *bridge_ifp, vlanid_t vid,
                    const struct ethaddr *mac, vni_t vni,
                    struct in_addr vtep_ip)
{
  ...
  /* Use common helper api */
  result = mac_update_common (DPLANE_OP_MAC_DELETE, ifp, bridge_ifp, vid, mac,
                              vni, vtep_ip, false, 0, update_flags);
  return result;
}
 ...
 */
enum zebra_dplane_result
dplane_neigh_ip_update (enum dplane_op_e op, const struct interface *ifp,
                        ...
                        uint32_t ndm_state, int protocol)
{
  ...
  if (IS_ZEBRA_DEBUG_DPLANE_DETAIL)
    zlog_debug ("%s: init link ctx %s: ifp %s, link_ip %pIA ip %pIA", __func__,
 ...
 */
enum zebra_dplane_result
dplane_local_mac_add (const struct interface *ifp,
                      const struct interface *bridge_ifp, vlanid_t vid,
                      const struct ethaddr *mac, bool sticky,
                      uint32_t set_static, uint32_t set_inactive)
{
  enum zebra_dplane_result result;
  uint32_t update_flags = 0;
  struct in_addr vtep_ip;
  ...
  /* Use common helper api */
  result = mac_update_common (DPLANE_OP_MAC_INSTALL, ifp, bridge_ifp, vid, mac,
                              0, vtep_ip, sticky, 0, update_flags);
  return result;
}
 ...
 */
void
dplane_mac_init (struct zebra_dplane_ctx *ctx, const struct interface *ifp,
                 const struct interface *br_ifp, vlanid_t vid,
                   ...
                   uint32_t update_flags)
{
  ...
  dplane_mac_init (ctx, ifp, br_ifp, vid, mac, vni, vtep_ip, sticky, nhg_id,
                   update_flags);
 ...
 */
enum zebra_dplane_result
dplane_rem_neigh_add (const struct interface *ifp, const struct ipaddr *ip,
                      const struct ethaddr *mac, uint32_t flags,
                      bool was_static)
{
  enum zebra_dplane_result result = ZEBRA_DPLANE_REQUEST_FAILURE;
  uint32_t update_flags = 0;
 ...
 */
enum zebra_dplane_result
dplane_local_neigh_add (const struct interface *ifp, const struct ipaddr *ip,
                        const struct ethaddr *mac, bool set_router,
                        bool set_static, bool set_inactive)
{
  enum zebra_dplane_result result = ZEBRA_DPLANE_REQUEST_FAILURE;
  uint32_t update_flags = 0;
  uint32_t ntf = 0;
  ...
  result =
      neigh_update_internal (DPLANE_OP_NEIGH_INSTALL, ifp, (const void *) mac,
                             AF_ETHERNET, ip, 0, ntf, state, update_flags, 0);
 ...
 */
enum zebra_dplane_result
dplane_rem_neigh_delete (const struct interface *ifp, const struct ipaddr *ip)
{
  enum zebra_dplane_result result;
  uint32_t update_flags = 0;
  ...
  result = neigh_update_internal (DPLANE_OP_NEIGH_DELETE, ifp, NULL,
                                  AF_ETHERNET, ip, 0, 0, 0, update_flags, 0);
 ...
 */
enum zebra_dplane_result
dplane_vtep_add (const struct interface *ifp, const struct in_addr *ip,
                 vni_t vni)
{
  enum zebra_dplane_result result;
  ...
  if (IS_ZEBRA_DEBUG_VXLAN)
    zlog_debug ("Install %pI4 into flood list for VNI %u intf %s(%u)", ip, vni,
                ifp->name, ifp->ifindex);

  SET_IPADDR_V4 (&addr);
  addr.ipaddr_v4 = *ip;

  result = neigh_update_internal (DPLANE_OP_VTEP_ADD, ifp, &mac, AF_ETHERNET,
                                  &addr, vni, 0, 0, 0, 0);
 ...
 */
enum zebra_dplane_result
dplane_vtep_delete (const struct interface *ifp, const struct in_addr *ip,
                    vni_t vni)
{
  enum zebra_dplane_result result;
  struct ethaddr mac = { { 0, 0, 0, 0, 0, 0 } };
  ...
  if (IS_ZEBRA_DEBUG_VXLAN)
    zlog_debug ("Uninstall %pI4 from flood list for VNI %u intf %s(%u)", ip,
  ...
  result =
      neigh_update_internal (DPLANE_OP_VTEP_DELETE, ifp, (const void *) &mac,
...
enum zebra_dplane_result
dplane_neigh_discover (const struct interface *ifp, const struct ipaddr *ip)
{
  enum zebra_dplane_result result;
...
enum zebra_dplane_result
dplane_neigh_table_update (const struct interface *ifp, const uint8_t family,
                           ...
                           const uint32_t mcast_probes)
{
  ...
  if (IS_ZEBRA_DEBUG_DPLANE_DETAIL)
    {
      zlog_debug ("set neigh ctx %s: ifp %s, family %s", dplane_op2str (op),
                  ifp->name, family2str (family));
    }
...
enum zebra_dplane_result
dplane_pbr_rule_add (struct zebra_pbr_rule *rule)
{
  return rule_update_internal (DPLANE_OP_RULE_ADD, rule, NULL);
}

enum zebra_dplane_result
dplane_pbr_rule_delete (struct zebra_pbr_rule *rule)
{
 ...
 */
static enum zebra_dplane_result
iptable_update_internal (enum dplane_op_e op,
                         struct zebra_pbr_iptable *iptable)
{
  enum zebra_dplane_result result = ZEBRA_DPLANE_REQUEST_FAILURE;
  struct zebra_dplane_ctx *ctx;
  ...
  if ((op == DPLANE_OP_IPTABLE_ADD &&
    ...
    {
      if (IS_ZEBRA_DEBUG_DPLANE_DETAIL)
        zlog_debug ("update dplane ctx %s: iptable %s already in progress",
  ...
  if (ret == AOK)
    {
      result = ZEBRA_DPLANE_REQUEST_QUEUED;
      if (op == DPLANE_OP_IPTABLE_ADD)
        SET_FLAG (iptable->internal_flags, IPTABLE_INSTALL_QUEUED);
      else
        SET_FLAG (iptable->internal_flags, IPTABLE_UNINSTALL_QUEUED);
    }
  else
    {
...
enum zebra_dplane_result
dplane_pbr_ipset_add (struct zebra_pbr_ipset *ipset)
{
  return ipset_update_internal (DPLANE_OP_IPSET_ADD, ipset);
}

enum zebra_dplane_result
dplane_pbr_ipset_delete (struct zebra_pbr_ipset *ipset)
{
                ...
                unsigned int mtu, const struct zebra_l2info_gre *gre_info)
{
  ...
  if (IS_ZEBRA_DEBUG_DPLANE_DETAIL)
    {
      zlog_debug ("init dplane ctx %s: if %s link %s%s", dplane_op2str (op),
                  ifp->name, ifp_link ? "set" : "unset",
                  ifp_link ? ifp_link->name : "");
    }
 ...
 */
int
dplane_show_helper (struct vty *vty, bool detailed)
{
  uint64_t queued, queue_max, limit, errs, incoming, yields, other_errs;

  /* Using atomics because counters are being changed in different
   * pthread contexts.
   */
  incoming =
      atomic_load_explicit (&zdplane_info.dg_routes_in, memory_order_relaxed);
  ...
  incoming =
      atomic_load_explicit (&zdplane_info.dg_lsps_in, memory_order_relaxed);
  errs =
      atomic_load_explicit (&zdplane_info.dg_lsp_errors, memory_order_relaxed);
  vty_out (vty, "LSP updates:              %" PRIu64 "\n", incoming);
  vty_out (vty, "LSP update errors:        %" PRIu64 "\n", errs);

  incoming =
      atomic_load_explicit (&zdplane_info.dg_pws_in, memory_order_relaxed);
  errs =
      atomic_load_explicit (&zdplane_info.dg_pw_errors, memory_order_relaxed);
  ...
  incoming =
      atomic_load_explicit (&zdplane_info.dg_neighs_in, memory_order_relaxed);
  ...
  incoming =
      atomic_load_explicit (&zdplane_info.dg_rules_in, memory_order_relaxed);
  ...
  incoming =
      atomic_load_explicit (&zdplane_info.dg_br_port_in, memory_order_relaxed);
  ...
  incoming =
      atomic_load_explicit (&zdplane_info.dg_iptable_in, memory_order_relaxed);
  ...
  incoming =
      atomic_load_explicit (&zdplane_info.dg_ipset_in, memory_order_relaxed);
  ...
  incoming =
      atomic_load_explicit (&zdplane_info.dg_gre_set_in, memory_order_relaxed);
 ...
 */
int
dplane_show_provs_helper (struct vty *vty, bool detailed)
{
  ...
  while (prov)
    {
      ...
      in = atomic_load_explicit (&prov->dp_in_counter, memory_order_relaxed);
      in_q = atomic_load_explicit (&prov->dp_in_queued, memory_order_relaxed);
      in_max = atomic_load_explicit (&prov->dp_in_max, memory_order_relaxed);
      out = atomic_load_explicit (&prov->dp_out_counter, memory_order_relaxed);
      out_q =
          atomic_load_explicit (&prov->dp_out_queued, memory_order_relaxed);
      out_max = atomic_load_explicit (&prov->dp_out_max, memory_order_relaxed);

      vty_out (vty,
               "%s (%u): in: %" PRIu64 ", q: %" PRIu64 ", q_max: %" PRIu64
               ", out: %" PRIu64 ", q: %" PRIu64 ", q_max: %" PRIu64 "\n",
               prov->dp_name, prov->dp_id, in, in_q, in_max, out, out_q,
               out_max);
 ...
 */
int
dplane_config_write_helper (struct vty *vty)
{
 ...
 */
int
dplane_provider_register (const char *name, enum dplane_provider_prio prio,
                          int flags,
                          int (*start_fp) (struct zebra_dplane_provider *),
                          int (*fp) (struct zebra_dplane_provider *),
                          int (*fini_fp) (struct zebra_dplane_provider *,
                                          bool early),
                          void *data, struct zebra_dplane_provider **prov_p)
{
  int ret = 0;
  ...
  if (prio <= DPLANE_PRIO_NONE || prio > DPLANE_PRIO_LAST)
    {
      ret = EINVAL;
      goto done;
    }
  ...
  if (name)
    ...
    snprintf (p->dp_name, DPLANE_PROVIDER_NAMELEN, "provider-%u", p->dp_id);
...
const char *
dplane_provider_get_name (const struct zebra_dplane_provider *prov)
{
  return prov->dp_name;
}

uint32_t
dplane_provider_get_id (const struct zebra_dplane_provider *prov)
{
  return prov->dp_id;
}

void *
dplane_provider_get_data (const struct zebra_dplane_provider *prov)
{
  return prov->dp_data;
}

int
dplane_provider_get_work_limit (const struct zebra_dplane_provider *prov)
{
 ...
 */
void
dplane_provider_lock (struct zebra_dplane_provider *prov)
{
...
void
dplane_provider_unlock (struct zebra_dplane_provider *prov)
{
  if (dplane_provider_is_threaded (prov))
 ...
 */
struct zebra_dplane_ctx *
dplane_provider_dequeue_in_ctx (struct zebra_dplane_provider *prov)
{
  struct zebra_dplane_ctx *ctx = NULL;
  ...
  if (ctx)
    {
      atomic_fetch_sub_explicit (&prov->dp_in_queued, 1, memory_order_relaxed);
    }
 ...
 */
int
dplane_provider_dequeue_in_list (struct zebra_dplane_provider *prov,
                                 struct dplane_ctx_list_head *listp)
{
  ...
  if (ret > 0)
    atomic_fetch_sub_explicit (&prov->dp_in_queued, ret, memory_order_relaxed);
...
uint32_t
dplane_provider_out_ctx_queue_len (struct zebra_dplane_provider *prov)
{
  return atomic_load_explicit (&(prov->dp_out_counter), memory_order_relaxed);
}
 ...
 */
void
dplane_provider_enqueue_out_ctx (struct zebra_dplane_provider *prov,
                                 struct zebra_dplane_ctx *ctx)
{
  uint64_t curr, high;
  ...
  atomic_fetch_add_explicit (&(prov->dp_out_queued), 1, memory_order_relaxed);
  ...
  if (curr > high)
    atomic_store_explicit (&prov->dp_out_max, curr, memory_order_relaxed);

  dplane_provider_unlock (prov);

  atomic_fetch_add_explicit (&(prov->dp_out_counter), 1, memory_order_relaxed);
}
...
dplane_provider_dequeue_out_ctx (struct zebra_dplane_provider *prov)
{
  ...
  atomic_fetch_sub_explicit (&(prov->dp_out_queued), 1, memory_order_relaxed);
 ...
 */
bool
dplane_provider_is_threaded (const struct zebra_dplane_provider *prov)
{
 ...
 */
static void
dplane_incoming_read (struct event *event)
{
 ...
 */
static void
dplane_incoming_request (struct event *event)
{
  struct dplane_zns_info *zi = EVENT_ARG (event);
 ...
 */
static void
dplane_kernel_info_request (struct dplane_zns_info *zi)
{
  /* If we happen to encounter an enabled zns before the dplane
   * pthread is running, we'll initiate this later on.
   */
  if (zdplane_info.dg_master)
    event_add_event (zdplane_info.dg_master, dplane_incoming_request, zi, 0,
                     &zi->t_request);
}
 ...
 */
void
zebra_dplane_ns_enable (struct zebra_ns *zns, bool enabled)
{
  ...
  if (enabled)
      ...
      if (zi == NULL)
        {
          ...
          if (IS_ZEBRA_DEBUG_DPLANE)
            zlog_debug ("%s: nsid %u, new zi %p", __func__, zns->ns_id, zi);
        }
    ...
    {
      if (IS_ZEBRA_DEBUG_DPLANE)
        zlog_debug ("%s: nsid %u, deleting zi %p", __func__, zns->ns_id, zi);
 ...
 */
int
dplane_provider_work_ready (void)
{
 ...
 */
void
dplane_provider_enqueue_to_zebra (struct zebra_dplane_ctx *ctx)
{
...
static void
kernel_dplane_log_detail (struct zebra_dplane_ctx *ctx)
{
  ...
  switch (dplane_ctx_get_op (ctx))
    ...
    case DPLANE_OP_ROUTE_DELETE:
      zlog_debug ("%u:%pFX Dplane route update ctx %p op %s",
                  dplane_ctx_get_vrf (ctx), dplane_ctx_get_dest (ctx), ctx,
    ...
    case DPLANE_OP_PW_UNINSTALL:
      zlog_debug ("Dplane pw %s: op %s af %d loc: %u rem: %u",
                  dplane_ctx_get_ifname (ctx), dplane_op2str (ctx->zd_op),
    ...
    case DPLANE_OP_GRE_SET:
      zlog_debug ("Dplane gre set op %s, ifp %s, link %u",
                  dplane_op2str (dplane_ctx_get_op (ctx)),
                  dplane_ctx_get_ifname (ctx), ctx->u.gre.link_ifindex);
      break;
    ...
    case DPLANE_OP_INTF_ADDR_DEL:
      zlog_debug ("Dplane incoming op %s, intf %s, addr %pFX",
                  dplane_op2str (dplane_ctx_get_op (ctx)),
                  dplane_ctx_get_ifname (ctx), dplane_ctx_get_intf_addr (ctx));
      break;
    ...
    case DPLANE_OP_TC_QDISC_INSTALL:
    case DPLANE_OP_TC_QDISC_UNINSTALL:
      zlog_debug ("Dplane tc qdisc ifidx %u", dplane_ctx_get_ifindex (ctx));
      break;
    case DPLANE_OP_TC_CLASS_ADD:
    case DPLANE_OP_TC_CLASS_DELETE:
    case DPLANE_OP_TC_CLASS_UPDATE:
...
static void
kernel_dplane_handle_result (struct zebra_dplane_ctx *ctx)
{
  ...
  switch (dplane_ctx_get_op (ctx))
    ...
    case DPLANE_OP_NONE:
      if (res != ZEBRA_DPLANE_REQUEST_SUCCESS)
        atomic_fetch_add_explicit (&zdplane_info.dg_other_errors, 1,
                                   memory_order_relaxed);
      break;
    }
}
...
static void
kernel_dplane_process_iptable (struct zebra_dplane_provider *prov,
                               struct zebra_dplane_ctx *ctx)
{
...
static void
kernel_dplane_process_ipset (struct zebra_dplane_provider *prov,
                             struct zebra_dplane_ctx *ctx)
{
...
void
dplane_rib_add_multipath (afi_t afi, safi_t safi, struct prefix *p,
                          ...
                          struct zebra_dplane_ctx *ctx)
{
  if (! ctx)
    ...
    {
      dplane_ctx_route_init_basic (ctx, dplane_ctx_get_op (ctx), re, p, src_p,
                                   afi, safi);
 ...
 */
static int
kernel_dplane_process_func (struct zebra_dplane_provider *prov)
{
  struct zebra_dplane_ctx *ctx;
  ...
  if (counter >= limit)
    {
      ...
      atomic_fetch_add_explicit (&zdplane_info.dg_update_yields, 1,
                                 memory_order_relaxed);
 ...
 */
static int
test_dplane_process_func (struct zebra_dplane_provider *prov)
{
  struct zebra_dplane_ctx *ctx;
  int counter, limit;
 ...
 */
static int
test_dplane_shutdown_func (struct zebra_dplane_provider *prov, bool early)
{
  if (IS_ZEBRA_DEBUG_DPLANE)
    zlog_debug ("dplane provider '%s': %sshutdown",
                dplane_provider_get_name (prov), early ? "early " : "");
 ...
 */
static void
dplane_provider_init (void)
{
  int ret;

  ret = dplane_provider_register (
      "Kernel", DPLANE_PRIO_KERNEL, DPLANE_PROV_FLAGS_DEFAULT, NULL,
      kernel_dplane_process_func, NULL, NULL, NULL);

  if (ret != AOK)
    zlog_err ("Unable to register kernel dplane provider: %d", ret);

#ifdef DPLANE_TEST_PROVIDER
  /* Optional test provider ... */
  ret = dplane_provider_register (
      "Test", DPLANE_PRIO_PRE_KERNEL, DPLANE_PROV_FLAGS_DEFAULT, NULL,
      test_dplane_process_func, test_dplane_shutdown_func, NULL /* data */,
      NULL);

  if (ret != AOK)
    zlog_err ("Unable to register test dplane provider: %d", ret);
#endif /* DPLANE_TEST_PROVIDER */
}
 ...
 */
int
dplane_clean_ctx_queue (bool (*context_cb) (struct zebra_dplane_ctx *ctx,
                                            void *arg),
                        void *val)
{
  struct zebra_dplane_ctx *ctx;
 ...
 */
void
dplane_enable_intf_extra_info (void)
{
 ...
 */
static void
dplane_check_shutdown_status (struct event *event)
{
  struct dplane_zns_info *zi;
 ...
 */
void
zebra_dplane_finish (void)
{
  if (IS_ZEBRA_DEBUG_DPLANE)
    zlog_debug ("Zebra dataplane fini called");

  event_add_event (zdplane_info.dg_master, dplane_check_shutdown_status, NULL,
                   0, &zdplane_info.dg_t_shutdown_check);
}
 ...
 */
static void
dplane_thread_loop (struct event *event)
{
  struct dplane_ctx_list_head work_list;
  ...
  while (prov)
    {
       ...
       */
      if (IS_ZEBRA_DEBUG_DPLANE_DETAIL)
        zlog_debug ("dplane enqueues %d new work to provider '%s'", counter,
                    dplane_provider_get_name (prov));
      ...
      high = atomic_load_explicit (&prov->dp_in_max, memory_order_relaxed);
      if (curr > high)
        atomic_store_explicit (&prov->dp_in_max, curr, memory_order_relaxed);
 ...
 */
static void
zebra_dplane_init_internal (void)
{
...
zebra_dplane_start (void)
{
  ...
  zdplane_info.dg_pthread =
      frr_pthread_new (&pattr, "Zebra dplane thread", "zebra_dplane");
 ...
 */
void
zebra_dplane_init (int (*results_fp) (struct dplane_ctx_list_head *))
{
