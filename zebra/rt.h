...
#define RSYSTEM_ROUTE(type)                                                   \
  ...
  extern void macfdb_read_for_bridge (struct zebra_ns *zns,
  ...
  extern void neigh_read_for_vlan (struct zebra_ns *zns,
                                   struct interface *ifp);
  ...
  /*
   * Called by the dplane pthread to read incoming OS messages and dispatch
   * them.
   */
