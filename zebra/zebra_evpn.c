 ...
 */
void
zebra_evpn_print (struct zebra_evpn *zevpn, void **ctxt)
{
 ...
 */
void
zebra_evpn_print_hash (struct hash_bucket *bucket, void *ctxt[])
{
  struct vty *vty;
 ...
 */
void
zebra_evpn_print_hash_detail (struct hash_bucket *bucket, void *data)
{
  struct vty *vty;
  struct zebra_evpn *zevpn;
...
static int
ip_prefix_send_to_client (vrf_id_t vrf_id, struct prefix *p, uint16_t cmd)
{
...
int
zebra_evpn_advertise_subnet (struct zebra_evpn *zevpn, struct interface *ifp,
                             int advertise)
{
  struct listnode *cnode = NULL, *cnnode = NULL;
  struct connected *c = NULL;
 ...
 */
int
zebra_evpn_gw_macip_add (struct interface *ifp, struct zebra_evpn *zevpn,
                         struct ethaddr *macaddr, struct ipaddr *ip)
{
  ...
  zebra_evpn_mac_gw_macip_add (ifp, zevpn, ip, &mac, macaddr, vni->access_vlan,
                               true);
...
void
zebra_evpn_gw_macip_del_for_evpn_hash (struct hash_bucket *bucket, void *ctxt)
{
...
void
zebra_evpn_gw_macip_add_for_evpn_hash (struct hash_bucket *bucket, void *ctxt)
{
  struct zebra_evpn *zevpn = NULL;
  struct zebra_if *zif = NULL;
  struct interface *vlan_if = NULL;
...
void
zebra_evpn_svi_macip_del_for_evpn_hash (struct hash_bucket *bucket, void *ctxt)
{
  struct zebra_evpn *zevpn = NULL;
  struct zebra_if *zif = NULL;
  struct interface *vlan_if = NULL;
  ...
  if (zevpn->advertise_svi_macip)
    {
      if (IS_ZEBRA_DEBUG_VXLAN)
        zlog_debug ("VNI: %u SVI-MACIP enabled, retain svi-macip", zevpn->vni);
      return;
    }
...
static int
zebra_evpn_map_vlan_ns (struct ns *ns, void *_in_param, void **_p_zevpn)
{
  int found = 0;
 ...
 */
struct zebra_evpn *
zebra_evpn_map_vlan (struct interface *ifp, struct interface *br_if,
                     vlanid_t vid)
{
  struct zebra_if *zif;
...
static int
zebra_evpn_from_svi_ns (struct ns *ns, void *_in_param, void **_p_zevpn)
{
  struct zebra_ns *zns = ns->info;
  struct route_node *rn;
  struct interface *br_if;
 ...
 */
struct zebra_evpn *
zebra_evpn_from_svi (struct interface *ifp, struct interface *br_if)
{
  struct zebra_evpn *zevpn = NULL;
  struct zebra_evpn **p_zevpn;
  struct zebra_if *zif;
  ...
  ns_walk_func (zebra_evpn_from_svi_ns, (void *) &in_param, (void **) p_zevpn);
  return zevpn;
}

static int
zvni_map_to_macvlan_ns (struct ns *ns, void *_in_param, void **_p_ifp)
{
  struct zebra_ns *zns = ns->info;
  struct zebra_from_svi_param *in_param =
      (struct zebra_from_svi_param *) _in_param;
 ...
 */
struct interface *
zebra_evpn_map_to_macvlan (struct interface *br_if, struct interface *svi_if)
{
  struct interface *tmp_if = NULL;
  struct zebra_if *zif;
 ...
 */
static void
zebra_evpn_uninstall_mac_hash (struct hash_bucket *bucket, void *ctxt)
{
 ...
 */
static void
zebra_evpn_install_mac_hash (struct hash_bucket *bucket, void *ctxt)
{
  struct zebra_mac *mac;
  struct mac_walk_ctx *wctx = ctxt;
 ...
 */
void
zebra_evpn_rem_mac_uninstall_all (struct zebra_evpn *zevpn)
{
 ...
 */
void
zebra_evpn_rem_mac_install_all (struct zebra_evpn *zevpn)
{
  struct mac_walk_ctx wctx;
 ...
 */
void
zebra_evpn_read_mac_neigh (struct zebra_evpn *zevpn, struct interface *ifp)
{
  struct zebra_ns *zns;
  struct zebra_vrf *zvrf;
  struct zebra_if *zif;
  ...
  if (IS_ZEBRA_DEBUG_VXLAN)
    zlog_debug (
        ...
        ifp->name, ifp->ifindex, zevpn->vni, zif->brslave_info.bridge_ifindex);
 ...
 */
unsigned int
zebra_evpn_hash_keymake (const void *p)
{
 ...
 */
bool
zebra_evpn_hash_cmp (const void *p1, const void *p2)
{
...
int
zebra_evpn_list_cmp (void *p1, void *p2)
{
  const struct zebra_evpn *zevpn1 = p1;
  const struct zebra_evpn *zevpn2 = p2;
...
zebra_evpn_send_add_to_client (struct zebra_evpn *zevpn)
{
  ...
  if (IS_ZEBRA_DEBUG_VXLAN)
    zlog_debug ("Send EVPN_ADD %u %pI4 tenant vrf %s(%u) SVI index %u to %s",
 ...
 */
static int
zebra_evpn_vtep_match (struct in_addr *vtep_ip, struct zebra_vtep *zvtep)
{
 ...
 */
struct zebra_vtep *
zebra_evpn_vtep_find (struct zebra_evpn *zevpn, struct in_addr *vtep_ip)
{
  struct zebra_vtep *zvtep;
 ...
 */
struct zebra_vtep *
zebra_evpn_vtep_add (struct zebra_evpn *zevpn, struct in_addr *vtep_ip,
                     int flood_control)
 ...
 */
int
zebra_evpn_vtep_del (struct zebra_evpn *zevpn, struct zebra_vtep *zvtep)
{
  if (zvtep->next)
 ...
 */
int
zebra_evpn_vtep_del_all (struct zebra_evpn *zevpn, int uninstall)
{
 ...
 */
int
zebra_evpn_vtep_install (struct zebra_evpn *zevpn, struct zebra_vtep *zvtep)
{
 ...
 */
int
zebra_evpn_vtep_uninstall (struct zebra_evpn *zevpn, struct in_addr *vtep_ip)
{
  if (! zevpn->vxlan_if)
    {
 ...
 */
void
zebra_evpn_handle_flooding_remote_vteps (struct hash_bucket *bucket,
                                         void *zvrf)
{
  struct zebra_evpn *zevpn;
  struct zebra_vtep *zvtep;
 ...
 */
void
zebra_evpn_cleanup_all (struct hash_bucket *bucket, void *arg)
{
  struct zebra_evpn *zevpn = NULL;
...
static void
zebra_evpn_process_sync_macip_add (struct zebra_evpn *zevpn,
                                   ...
                                   uint32_t seq, const esi_t *esi)
{
  ...
  if (sticky || remote_gw)
    {
      if (IS_ZEBRA_DEBUG_VXLAN || IS_ZEBRA_DEBUG_EVPN_MH_NEIGH ||
        ...
        zlog_debug ("Ignore sync-macip vni %u mac %pEA%s%s%s%s", zevpn->vni,
                    macaddr, ipa_len ? " IP " : "",
  ...
  if (! ipa_len)
    {
      /* MAC update */
      (void) zebra_evpn_proc_sync_mac_update (zevpn, macaddr, ipa_len, ipaddr,
                                              flags, seq, esi);
    }
  else
    {
      ...
      if (! mac)
        {
          mac = zebra_evpn_proc_sync_mac_update (zevpn, macaddr, ipa_len,
...
void
zebra_evpn_rem_macip_add (vni_t vni, const struct ethaddr *macaddr,
                          uint16_t ipa_len, const struct ipaddr *ipaddr,
                          uint8_t flags, uint32_t seq, struct in_addr vtep_ip,
                          const esi_t *esi)
{
  struct zebra_evpn *zevpn;
  struct zebra_vtep *zvtep;
  ...
  if (flags & ZEBRA_MACIP_TYPE_SYNC_PATH)
    {
      ...
      if (es && (es->flags & ZEBRA_EVPNES_READY_FOR_BGP))
        {
          zebra_evpn_process_sync_macip_add (zevpn, macaddr, ipa_len, ipaddr,
                                             flags, seq, esi);
        }
      else
        {
          if (IS_ZEBRA_DEBUG_EVPN_MH_ES)
            {
              ...
              zlog_debug ("Ignore sync-macip add; ES %s is not ready",
                          esi_str);
            }
        }
  ...
  if (! ipa_len)
    {
      /* MAC update */
      zebra_evpn_mac_remote_macip_add (zevpn, zvrf, macaddr, vtep_ip, flags,
                                       seq, esi);
    }
  else
    {
      ...
      if (! mac)
        {
          ...
          if (IS_ZEBRA_DEBUG_VXLAN)
            zlog_debug ("Neigh %pIA: MAC %pEA not found, Auto MAC created",
                        ipaddr, macaddr);
        }
...
void
zebra_evpn_rem_macip_del (vni_t vni, const struct ethaddr *macaddr,
                          uint16_t ipa_len, const struct ipaddr *ipaddr,
                          struct in_addr vtep_ip)
{
  ...
  if (n)
  ...
  else
    {
       ...
       */
      if (zvrf->dad_freeze && CHECK_FLAG (mac->flags, ZEBRA_MAC_DUPLICATE) &&
 ...
 * ************************/
void
zebra_evpn_cfg_cleanup (struct hash_bucket *bucket, void *ctxt)
{
  struct zebra_evpn *zevpn = NULL;
