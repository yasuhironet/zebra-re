...
static unsigned int
zebra_l2_bridge_vlan_hash_keymake (const void *p)
{
...
static bool
zebra_l2_bridge_vlan_hash_cmp (const void *p1, const void *p2)
{
...
static int
zebra_l2_bridge_if_vlan_walk_callback (struct hash_bucket *bucket, void *ctxt)
{
  int ret;
...
static void
zebra_l2_bridge_if_vlan_iterate_callback (struct hash_bucket *bucket,
                                          void *ctxt)
{
  struct zebra_l2_bridge_vlan *bvlan;
  struct zebra_l2_bridge_if_ctx *ctx;
...
static int
zebra_l2_bridge_if_vlan_clean (struct zebra_if *zif,
                               struct zebra_l2_bridge_vlan *bvlan, void *ctxt)
{
...
static void
zebra_l2_bridge_vlan_free (void *arg)
{
...
static void *
zebra_l2_bridge_vlan_alloc (void *p)
{
  struct zebra_l2_bridge_vlan *bvlan;
...
static void
zebra_l2_bridge_vlan_table_destroy (struct hash *vlan_table)
{
...
static void
zebra_l2_bridge_if_vlan_table_destroy (struct zebra_if *zif)
{
...
static int
zebra_l2_bridge_if_vlan_table_create (struct zebra_if *zif)
{
  struct zebra_l2_bridge_if *br;
...
static int
zebra_l2_bridge_if_vlan_del (struct interface *ifp, vlanid_t vid)
{
  struct zebra_if *zif;
  struct zebra_l2_bridge_if *br;
  struct zebra_l2_bridge_vlan bvl;
...
static int
zebra_l2_bridge_if_vlan_update (struct interface *ifp,
                                struct zebra_l2_bridge_vlan *bvl, int chgflags)
{
  struct zebra_if *zif;
  struct zebra_l2_bridge_vlan *bvlan;
...
static int
zebra_l2_bridge_if_vlan_add (struct interface *ifp,
                             struct zebra_l2_bridge_vlan *bvlan)
{
  struct zebra_if *zif;
  struct zebra_l2_bridge_if *br;
...
vni_t
zebra_l2_bridge_if_vni_find (const struct zebra_if *zif, vlanid_t vid)
{
  vni_t vni_id = 0;
  struct zebra_l2_bridge_vlan *bvlan;
...
void
zebra_l2_bridge_if_vlan_iterate (struct zebra_if *zif,
...
int
zebra_l2_bridge_if_cleanup (struct interface *ifp)
{
  struct zebra_if *zif;
...
int
zebra_l2_bridge_if_del (struct interface *ifp)
{
  if (IS_ZEBRA_DEBUG_VXLAN)
...
int
zebra_l2_bridge_if_add (struct interface *ifp)
{
  struct zebra_if *zif;
  struct zebra_l2_bridge_if *br;
