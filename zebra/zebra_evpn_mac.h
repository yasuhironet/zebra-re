...
#define SHOW_REMOTE_MAC_FROM_VTEP 0x8
   ...
   */
  static inline bool
  zebra_evpn_mac_is_static (struct zebra_mac *mac)
  {
  ...
  static inline bool
  zebra_evpn_mac_is_ready_for_bgp (uint32_t flags)
  {
  ...
  static inline void
  zebra_evpn_mac_clear_sync_info (struct zebra_mac *mac)
  {
  ...
  static inline bool
  zebra_evpn_mac_in_use (struct zebra_mac *mac)
  {
  ...
  int zebra_evpn_rem_mac_uninstall (struct zebra_evpn *zevi,
                                    struct zebra_mac *mac, bool force);
  int zebra_evpn_rem_mac_install (struct zebra_evpn *zevi,
                                  struct zebra_mac *mac, bool was_static);
  void zebra_evpn_deref_ip2mac (struct zebra_evpn *zevi,
  ...
  int zebra_evpn_macip_send_msg_to_client (uint32_t id,
                                           ...
                                           int state, struct zebra_evpn_es *es,
                                           uint16_t cmd);
  void zebra_evpn_print_mac (struct zebra_mac *mac, void *ctxt,
                             json_object *json);
  void zebra_evpn_print_mac_hash (struct hash_bucket *bucket, void *ctxt);
  void zebra_evpn_print_mac_hash_detail (struct hash_bucket *bucket,
                                         void *ctxt);
  ...
  int zebra_evpn_mac_send_add_to_client (vni_t vni,
                                         const struct ethaddr *macaddr,
                                         uint32_t mac_flags, uint32_t seq,
                                         struct zebra_evpn_es *es);
  int zebra_evpn_mac_send_del_to_client (vni_t vni,
                                         const struct ethaddr *macaddr,
                                         uint32_t flags, bool force);
  void zebra_evpn_send_mac_list_to_client (struct zebra_evpn *zevi);
  struct zebra_mac *zebra_evpn_proc_sync_mac_update (
      struct zebra_evpn *zevi, const struct ethaddr *macaddr, uint16_t ipa_len,
  ...
  int zebra_evpn_add_update_local_mac (
      struct zebra_vrf *zvrf, struct zebra_evpn *zevpn, struct interface *ifp,
      const struct ethaddr *macaddr, vlanid_t vid, bool sticky,
      bool local_inactive, bool dp_static, struct zebra_mac *mac);
  int zebra_evpn_del_local_mac (struct zebra_evpn *zevpn,
                                struct zebra_mac *mac, bool clear_static);
  ...
  void zebra_evpn_mac_svi_add (struct interface *ifp,
                               struct zebra_evpn *zevpn);
  void zebra_evpn_mac_svi_del (struct interface *ifp,
                               struct zebra_evpn *zevpn);
