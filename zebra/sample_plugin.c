 ...
 */
static int
sample_start (struct zebra_dplane_provider *prov)
{
 ...
 */
static int
sample_fini (struct zebra_dplane_provider *prov, bool early)
{
 ...
 */
static int
sample_process (struct zebra_dplane_provider *prov)
{
  int counter, limit;
 ...
 */
static int
init_sample_plugin (struct event_loop *tm)
{
  int ret;
  ...
  ret = dplane_provider_register (plugin_name, DPLANE_PRIO_PRE_KERNEL,
                                  ...
                                  sample_process, sample_fini, NULL, &prov_p);
