...
#define IS_ZL3VNI_SVD_BACKED(zl3vni)                                          \
  ...
  zl3vni_vxlan_if_name (struct zebra_l3vni *zl3vni)
  {
  ...
  static inline const char *
  zl3vni_svi_if_name (struct zebra_l3vni *zl3vni)
  {
  ...
  static inline const char *
  zl3vni_vrf_name (struct zebra_l3vni *zl3vni)
  {
  ...
  /* get the rmac string */
  static inline const char *
  zl3vni_rmac2str (struct zebra_l3vni *zl3vni, char *buf, int size)
  {
    char *ptr;
  ...
  static inline const char *
  zl3vni_sysmac2str (struct zebra_l3vni *zl3vni, char *buf, int size)
  {
    char *ptr;
   ...
   */
  static inline int
  is_l3vni_oper_up (struct zebra_l3vni *zl3vni)
  {
  ...
  static inline const char *
  zl3vni_state2str (struct zebra_l3vni *zl3vni)
  {
    if (! zl3vni)
      return NULL;
  ...
  zl3vni_vrf_id (struct zebra_l3vni *zl3vni)
  {
    return zl3vni->vrf_id;
  }

  static inline void
  zl3vni_get_svi_rmac (struct zebra_l3vni *zl3vni, struct ethaddr *rmac)
  {
    if (! zl3vni)
      return;
  ...
  extern vni_t vni_id_from_svi (struct interface *ifp,
                                struct interface *br_if);

  DECLARE_HOOK (zebra_rmac_update,
                (struct zebra_mac * rmac, struct zebra_l3vni *zl3vni,
