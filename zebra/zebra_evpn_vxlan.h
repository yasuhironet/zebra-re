...
static inline void
zevpn_vxlan_if_set (struct zebra_evpn *zevpn, struct interface *ifp, bool set)
{
  struct zebra_if *zif;
...
static inline void
zevpn_bridge_if_set (struct zebra_evpn *zevpn, struct interface *ifp, bool set)
{
  if (set)
    {
...
/* EVPN<=>Bridge interface association */
static inline void
zl3vni_bridge_if_set (struct zebra_l3vni *zl3vni, struct interface *ifp,
                      bool set)
{
  if (set)
    {
