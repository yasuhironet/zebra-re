 ...
 */
int
clear_evpn_dup_addr_rpc (struct nb_cb_rpc_args *args)
{
          ...
          if (yang_dup_mac)
            {
              ...
              ret = zebra_vxlan_clear_dup_detect_vni_mac (
                  zvrf, vni, &mac, args->errmsg, args->errmsg_len);
            }
          else if (yang_dup_ip)
            {
              yang_str2ip (yang_dup_ip->value, &host_ip);
              ret = zebra_vxlan_clear_dup_detect_vni_ip (
                  zvrf, vni, &host_ip, args->errmsg, args->errmsg_len);
            }
          else
 ...
 */
int
get_route_information_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
 ...
 */
int
get_v6_mroute_info_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
  return NB_ERR_NOT_FOUND;
}
 ...
 */
int
get_vrf_info_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
  return NB_ERR_NOT_FOUND;
}
 ...
 */
int
get_vrf_vni_info_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
  return NB_ERR_NOT_FOUND;
}
 ...
 */
int
get_evpn_info_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
  return NB_ERR_NOT_FOUND;
}
 ...
 */
int
get_vni_info_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
  return NB_ERR_NOT_FOUND;
}
 ...
 */
int
get_evpn_vni_rmac_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
  return NB_ERR_NOT_FOUND;
}
 ...
 */
int
get_evpn_vni_nexthops_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
  return NB_ERR_NOT_FOUND;
}
 ...
 */
int
get_evpn_macs_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
  return NB_ERR_NOT_FOUND;
}
 ...
 */
int
get_evpn_arp_cache_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
  return NB_ERR_NOT_FOUND;
}
 ...
 */
int
get_pbr_ipset_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
  return NB_ERR_NOT_FOUND;
}
 ...
 */
int
get_pbr_iptable_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
  return NB_ERR_NOT_FOUND;
}
 ...
 */
int
get_debugs_rpc (struct nb_cb_rpc_args *args)
{
  /* TODO: implement me. */
  return NB_ERR_NOT_FOUND;
}
