...
int
ripd_instance_state_routes_route_get_keys (struct nb_cb_get_keys_args *args);
...
void cli_show_rip_default_information_originate (struct vty *vty,
                                                 ...
                                                 bool show_defaults);
void cli_show_rip_default_metric (struct vty *vty,
                                  const struct lyd_node *dnode,
                                  bool show_defaults);
void cli_show_rip_distance (struct vty *vty, const struct lyd_node *dnode,
                            bool show_defaults);
void cli_show_rip_distance_source (struct vty *vty,
                                   const struct lyd_node *dnode,
                                   bool show_defaults);
void cli_show_rip_neighbor (struct vty *vty, const struct lyd_node *dnode,
                            bool show_defaults);
void cli_show_rip_network_prefix (struct vty *vty,
                                  const struct lyd_node *dnode,
                                  bool show_defaults);
...
void cli_show_rip_offset_list (struct vty *vty, const struct lyd_node *dnode,
                               bool show_defaults);
void cli_show_rip_passive_default (struct vty *vty,
                                   const struct lyd_node *dnode,
                                   bool show_defaults);
...
void cli_show_ip_rip_split_horizon (struct vty *vty,
                                    const struct lyd_node *dnode,
                                    bool show_defaults);
void cli_show_ip_rip_v2_broadcast (struct vty *vty,
                                   const struct lyd_node *dnode,
                                   bool show_defaults);
void cli_show_ip_rip_receive_version (struct vty *vty,
                                      const struct lyd_node *dnode,
                                      bool show_defaults);
void cli_show_ip_rip_send_version (struct vty *vty,
                                   const struct lyd_node *dnode,
                                   bool show_defaults);
...
void cli_show_ip_rip_bfd_enable (struct vty *vty, const struct lyd_node *dnode,
                                 bool show_defaults);
void cli_show_ip_rip_bfd_profile (struct vty *vty,
                                  const struct lyd_node *dnode,
                                  bool show_defaults);
