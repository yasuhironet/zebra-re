 ...
 */
const void *
ripd_instance_get_next (struct nb_cb_get_next_args *args)
{
...
int
ripd_instance_get_keys (struct nb_cb_get_keys_args *args)
{
...
const void *
ripd_instance_lookup_entry (struct nb_cb_lookup_entry_args *args)
{
...
ripd_instance_state_routes_route_get_keys (struct nb_cb_get_keys_args *args)
{
  ...
  args->keys->num = 1;
  (void) prefix2str (&rn->p, args->keys->key[0], sizeof (args->keys->key[0]));
 ...
 */
const void *
ripd_instance_state_routes_route_nexthops_nexthop_get_next (
    struct nb_cb_get_next_args *args)
{
...
static inline const struct rip_info *
    ...
    struct nb_cb_get_elem_args *args)
{
  ...
  return yang_data_new_string (
      args->xpath, ifindex2ifname (rinfo->nh.ifindex, rip->vrf->vrf_id));
}
    ...
    struct nb_cb_get_elem_args *args)
{
  ...
  return yang_data_new_uint32 (args->xpath, event_timer_remain_second (event));
}
