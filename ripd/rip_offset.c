...
rip_offset_list_new (struct rip *rip, const char *ifname)
{
...
void
offset_list_free (struct rip_offset_list *offset)
{
...
struct rip_offset_list *
rip_offset_list_lookup (struct rip *rip, const char *ifname)
{
  struct rip_offset_list *offset;
