 ...
 */
int
ripd_instance_create (struct nb_cb_create_args *args)
{
  struct rip *rip;
  struct vrf *vrf;
  const char *vrf_name;
...
int
ripd_instance_destroy (struct nb_cb_destroy_args *args)
{
  struct rip *rip;
 ...
 */
int
ripd_instance_allow_ecmp_modify (struct nb_cb_modify_args *args)
{
  struct rip *rip;
  ...
  rip->ecmp = MIN (yang_dnode_get_uint8 (args->dnode, NULL), zebra_ecmp_count);
  if (! rip->ecmp)
    {
  ...
  if (default_information)
    {
      ...
      rip_redistribute_add (rip, ZEBRA_ROUTE_RIP, RIP_ROUTE_DEFAULT, &p, &nh,
                            0, 0, 0);
    }
  else
    {
      rip_redistribute_delete (rip, ZEBRA_ROUTE_RIP, RIP_ROUTE_DEFAULT, &p, 0);
    }
 ...
 */
int
ripd_instance_default_metric_modify (struct nb_cb_modify_args *args)
{
  struct rip *rip;
 ...
 */
int
ripd_instance_distance_default_modify (struct nb_cb_modify_args *args)
{
  struct rip *rip;
 ...
 */
int
ripd_instance_distance_source_create (struct nb_cb_create_args *args)
{
  struct rip *rip;
...
int
ripd_instance_distance_source_destroy (struct nb_cb_destroy_args *args)
{
  struct route_node *rn;
 ...
 */
int
ripd_instance_distance_source_distance_modify (struct nb_cb_modify_args *args)
{
  struct route_node *rn;
  uint8_t distance;
  struct rip_distance *rdistance;
 ...
 */
int
ripd_instance_explicit_neighbor_create (struct nb_cb_create_args *args)
{
  struct rip *rip;
  struct prefix_ipv4 p;
...
int
ripd_instance_explicit_neighbor_destroy (struct nb_cb_destroy_args *args)
{
  struct rip *rip;
  struct prefix_ipv4 p;
 ...
 */
int
ripd_instance_network_create (struct nb_cb_create_args *args)
{
  struct rip *rip;
  struct prefix p;
...
int
ripd_instance_network_destroy (struct nb_cb_destroy_args *args)
{
  struct rip *rip;
  struct prefix p;
 ...
 */
int
ripd_instance_interface_create (struct nb_cb_create_args *args)
{
  struct rip *rip;
  const char *ifname;
...
int
ripd_instance_interface_destroy (struct nb_cb_destroy_args *args)
{
  struct rip *rip;
  const char *ifname;
 ...
 */
int
ripd_instance_offset_list_create (struct nb_cb_create_args *args)
{
  struct rip *rip;
  const char *ifname;
...
int
ripd_instance_offset_list_destroy (struct nb_cb_destroy_args *args)
{
  int direct;
  struct rip_offset_list *offset;
 ...
 */
int
ripd_instance_offset_list_access_list_modify (struct nb_cb_modify_args *args)
{
  int direct;
  struct rip_offset_list *offset;
 ...
 */
int
ripd_instance_offset_list_metric_modify (struct nb_cb_modify_args *args)
{
  int direct;
  uint8_t metric;
  struct rip_offset_list *offset;
 ...
 */
int
ripd_instance_passive_default_modify (struct nb_cb_modify_args *args)
{
  struct rip *rip;
 ...
 */
int
ripd_instance_passive_interface_create (struct nb_cb_create_args *args)
{
  struct rip *rip;
  const char *ifname;
...
int
ripd_instance_passive_interface_destroy (struct nb_cb_destroy_args *args)
{
  struct rip *rip;
  const char *ifname;
 ...
 */
int
ripd_instance_non_passive_interface_create (struct nb_cb_create_args *args)
{
  struct rip *rip;
  const char *ifname;
...
int
ripd_instance_non_passive_interface_destroy (struct nb_cb_destroy_args *args)
{
  struct rip *rip;
  const char *ifname;
 ...
 */
int
ripd_instance_redistribute_create (struct nb_cb_create_args *args)
{
  struct rip *rip;
  int type;
...
int
ripd_instance_redistribute_destroy (struct nb_cb_destroy_args *args)
{
  struct rip *rip;
  int type;
...
void
ripd_instance_redistribute_apply_finish (struct nb_cb_apply_finish_args *args)
{
  struct rip *rip;
  int type;
 ...
 */
int
ripd_instance_redistribute_route_map_modify (struct nb_cb_modify_args *args)
{
  struct rip *rip;
  int type;
...
int
ripd_instance_redistribute_route_map_destroy (struct nb_cb_destroy_args *args)
{
  struct rip *rip;
  int type;
 ...
 */
int
ripd_instance_redistribute_metric_modify (struct nb_cb_modify_args *args)
{
  struct rip *rip;
  int type;
  uint8_t metric;
...
int
ripd_instance_redistribute_metric_destroy (struct nb_cb_destroy_args *args)
{
  struct rip *rip;
  int type;
 ...
 */
int
ripd_instance_if_route_maps_if_route_map_create (
...
int
ripd_instance_if_route_maps_if_route_map_destroy (
    struct nb_cb_destroy_args *args)
{
  struct rip *rip;
...
static void
if_route_map_modify (const struct lyd_node *dnode, enum if_rmap_type type,
                     bool delete)
{
 ...
 */
int
ripd_instance_if_route_maps_if_route_map_in_route_map_modify (
    struct nb_cb_modify_args *args)
{
  if (args->event != NB_EV_APPLY)
    return NB_OK;
...
int
ripd_instance_if_route_maps_if_route_map_in_route_map_destroy (
    struct nb_cb_destroy_args *args)
{
  if (args->event != NB_EV_APPLY)
    return NB_OK;
 ...
 */
int
ripd_instance_if_route_maps_if_route_map_out_route_map_modify (
    struct nb_cb_modify_args *args)
{
  if (args->event != NB_EV_APPLY)
    return NB_OK;
...
int
ripd_instance_if_route_maps_if_route_map_out_route_map_destroy (
    struct nb_cb_destroy_args *args)
{
  if (args->event != NB_EV_APPLY)
    return NB_OK;
 ...
 */
int
ripd_instance_static_route_create (struct nb_cb_create_args *args)
{
  struct rip *rip;
  struct nexthop nh;
  struct prefix_ipv4 p;
...
int
ripd_instance_static_route_destroy (struct nb_cb_destroy_args *args)
{
  struct rip *rip;
  struct prefix_ipv4 p;
 ...
 */
void
ripd_instance_timers_apply_finish (struct nb_cb_apply_finish_args *args)
{
  struct rip *rip;
 ...
 */
int
ripd_instance_timers_flush_interval_modify (struct nb_cb_modify_args *args)
{
  struct rip *rip;
 ...
 */
int
ripd_instance_timers_holddown_interval_modify (struct nb_cb_modify_args *args)
{
  struct rip *rip;
 ...
 */
int
ripd_instance_timers_update_interval_modify (struct nb_cb_modify_args *args)
{
  struct rip *rip;
 ...
 */
int
ripd_instance_version_receive_modify (struct nb_cb_modify_args *args)
{
  struct rip *rip;
 ...
 */
int
ripd_instance_version_send_modify (struct nb_cb_modify_args *args)
{
  struct rip *rip;
 ...
 */
int
ripd_instance_default_bfd_profile_modify (struct nb_cb_modify_args *args)
{
  struct rip *rip;
  ...
  rip->default_bfd_profile = XSTRDUP (
      MTYPE_RIP_BFD_PROFILE, yang_dnode_get_string (args->dnode, NULL));
...
int
ripd_instance_default_bfd_profile_destroy (struct nb_cb_destroy_args *args)
{
  struct rip *rip;
 ...
 */
int
lib_interface_rip_split_horizon_modify (struct nb_cb_modify_args *args)
{
 ...
 */
int
lib_interface_rip_v2_broadcast_modify (struct nb_cb_modify_args *args)
{
  struct interface *ifp;
  struct rip_interface *ri;
 ...
 */
int
lib_interface_rip_version_receive_modify (struct nb_cb_modify_args *args)
{
  struct interface *ifp;
  struct rip_interface *ri;
 ...
 */
int
lib_interface_rip_version_send_modify (struct nb_cb_modify_args *args)
{
  struct interface *ifp;
  struct rip_interface *ri;
 ...
 */
int
lib_interface_rip_bfd_create (struct nb_cb_create_args *args)
{
  struct interface *ifp;
  struct rip_interface *ri;
...
int
lib_interface_rip_bfd_destroy (struct nb_cb_destroy_args *args)
{
  struct interface *ifp;
  struct rip_interface *ri;
 ...
 */
int
lib_interface_rip_bfd_enable_modify (struct nb_cb_modify_args *args)
{
  struct interface *ifp;
  struct rip_interface *ri;
 ...
 */
int
lib_interface_rip_bfd_profile_modify (struct nb_cb_modify_args *args)
{
  struct interface *ifp;
  struct rip_interface *ri;
...
int
lib_interface_rip_bfd_profile_destroy (struct nb_cb_destroy_args *args)
{
  struct interface *ifp;
  struct rip_interface *ri;
