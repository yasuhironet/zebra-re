...
static int
static_path_list_create (struct nb_cb_create_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_VALIDATE:
      vrf_dnode =
          yang_dnode_get_parent (args->dnode, "control-plane-protocol");
...
static int
static_path_list_destroy (struct nb_cb_destroy_args *args)
{
  struct static_path *pn;
...
static int
static_path_list_tag_modify (struct nb_cb_modify_args *args)
{
  struct static_path *pn;
...
static int
nexthop_iter_cb (const struct lyd_node *dnode, void *arg)
{
...
static bool
static_nexthop_create (struct nb_cb_create_args *args)
{
...
static bool
static_nexthop_destroy (struct nb_cb_destroy_args *args)
{
  struct static_nexthop *nh;
...
static int
nexthop_mpls_label_stack_entry_create (struct nb_cb_create_args *args)
{
  struct static_nexthop *nh;
  uint32_t pos;
  uint8_t index;
...
static int
static_nexthop_mpls_label_modify (struct nb_cb_modify_args *args)
{
  struct static_nexthop *nh;
  uint32_t pos;
  uint8_t index;
...
static int
static_nexthop_onlink_modify (struct nb_cb_modify_args *args)
{
  struct static_nexthop *nh;
  enum static_nh_type nh_type;
  bool old_onlink;
...
static int
static_nexthop_color_modify (struct nb_cb_modify_args *args)
{
  struct static_nexthop *nh;
  uint32_t old_color;
...
static int
static_nexthop_color_destroy (struct nb_cb_destroy_args *args)
{
  struct static_nexthop *nh;
  uint32_t old_color;
...
static int
static_nexthop_bh_type_modify (struct nb_cb_modify_args *args)
{
  struct static_nexthop *nh;
  enum static_nh_type nh_type;
 ...
 */
int
route_next_hop_bfd_create (struct nb_cb_create_args *args)
{
...
int
route_next_hop_bfd_destroy (struct nb_cb_destroy_args *args)
{
  struct static_nexthop *sn;
 ...
 */
int
route_next_hop_bfd_source_modify (struct nb_cb_modify_args *args)
{
  struct static_nexthop *sn;
...
int
route_next_hop_bfd_source_destroy (struct nb_cb_destroy_args *args)
{
  struct static_nexthop *sn;
 ...
 */
int
route_next_hop_bfd_multi_hop_modify (struct nb_cb_modify_args *args)
{
  struct static_nexthop *sn;
  ...
  sn = nb_running_get_entry (args->dnode, NULL, true);
  static_next_hop_bfd_multi_hop (sn, yang_dnode_get_bool (args->dnode, NULL));
 ...
 */
int
route_next_hop_bfd_profile_modify (struct nb_cb_modify_args *args)
{
  struct static_nexthop *sn;
  ...
  sn = nb_running_get_entry (args->dnode, NULL, true);
  static_next_hop_bfd_profile (sn, yang_dnode_get_string (args->dnode, NULL));

  return NB_OK;
}

int
route_next_hop_bfd_profile_destroy (struct nb_cb_destroy_args *args)
{
  struct static_nexthop *sn;
    ...
    struct nb_cb_create_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      src_rn = static_add_route (afi, safi, &rn->p, &src_prefix, s_vrf);
