...
extern int ripng_passive_interface_set (struct ripng *ripng,
                                        const char *ifname);
...
extern void ripng_event (struct ripng *ripng, enum ripng_event event,
                         int sock);
extern int ripng_request (struct interface *ifp);
extern void ripng_redistribute_add (struct ripng *ripng, int type,
...
extern void ripng_zebra_ipv6_delete (struct ripng *ripng,
