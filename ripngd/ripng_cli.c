...
void
cli_show_router_ripng (struct vty *vty, const struct lyd_node *dnode,
                       bool show_defaults)
{
  const char *vrf_name;
...
void
cli_show_ripng_allow_ecmp (struct vty *vty, const struct lyd_node *dnode,
                           bool show_defaults)
{
  uint8_t paths;
...
void
cli_show_ripng_default_information_originate (struct vty *vty,
...
void
cli_show_ripng_default_metric (struct vty *vty, const struct lyd_node *dnode,
                               bool show_defaults)
{
...
void
cli_show_ripng_network_prefix (struct vty *vty, const struct lyd_node *dnode,
                               bool show_defaults)
{
...
void
cli_show_ripng_network_interface (struct vty *vty,
                                  const struct lyd_node *dnode,
                                  bool show_defaults)
{
  vty_out (vty, " network %s\n", yang_dnode_get_string (dnode, NULL));
...
void
cli_show_ripng_offset_list (struct vty *vty, const struct lyd_node *dnode,
                            bool show_defaults)
{
...
void
cli_show_ripng_passive_interface (struct vty *vty,
                                  const struct lyd_node *dnode,
                                  bool show_defaults)
{
...
void
cli_show_ripng_redistribute (struct vty *vty, const struct lyd_node *dnode,
                             bool show_defaults)
{
...
void
cli_show_ripng_route (struct vty *vty, const struct lyd_node *dnode,
                      bool show_defaults)
{
  vty_out (vty, " route %s\n", yang_dnode_get_string (dnode, NULL));
}
...
void
cli_show_ripng_aggregate_address (struct vty *vty,
                                  const struct lyd_node *dnode,
                                  bool show_defaults)
{
...
void
cli_show_ripng_timers (struct vty *vty, const struct lyd_node *dnode,
                       bool show_defaults)
{
...
void
cli_show_ipv6_ripng_split_horizon (struct vty *vty,
                                   const struct lyd_node *dnode,
                                   bool show_defaults)
{
  int value;
  ...
  if (vrf)
    {
      ...
      yang_vrf =
          yang_data_new ("/frr-ripngd:clear-ripng-route/input/vrf", vrf);
       ...
       "Interface name\n")
{
  ...
  return distribute_list_no_parser (vty, prefix, false, argv[4 + prefix]->text,
