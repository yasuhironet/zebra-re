...
int
ripngd_instance_state_routes_route_get_keys (struct nb_cb_get_keys_args *args);
...
void cli_show_ripng_allow_ecmp (struct vty *vty, const struct lyd_node *dnode,
                                bool show_defaults);
void cli_show_ripng_default_information_originate (
...
void cli_show_ripng_passive_interface (struct vty *vty,
                                       const struct lyd_node *dnode,
                                       bool show_defaults);
void cli_show_ripng_redistribute (struct vty *vty,
                                  const struct lyd_node *dnode,
                                  bool show_defaults);
