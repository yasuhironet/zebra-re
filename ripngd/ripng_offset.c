...
ripng_offset_list_new (struct ripng *ripng, const char *ifname)
{
...
void
ripng_offset_list_del (struct ripng_offset_list *offset)
{
...
struct ripng_offset_list *
ripng_offset_list_lookup (struct ripng *ripng, const char *ifname)
{
...
int
ripng_offset_list_apply_in (struct ripng *ripng, struct prefix_ipv6 *p,
...
/* If metric is modified return 1. */
int
ripng_offset_list_apply_out (struct ripng *ripng, struct prefix_ipv6 *p,
                             struct interface *ifp, uint8_t *metric)
{
  struct ripng_offset_list *offset;
  struct access_list *alist;
