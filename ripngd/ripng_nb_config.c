 ...
 */
int
ripngd_instance_create (struct nb_cb_create_args *args)
{
  struct ripng *ripng;
  struct vrf *vrf;
  const char *vrf_name;
...
int
ripngd_instance_destroy (struct nb_cb_destroy_args *args)
{
  struct ripng *ripng;
...
const void *
ripngd_instance_get_next (struct nb_cb_get_next_args *args)
{
...
int
ripngd_instance_get_keys (struct nb_cb_get_keys_args *args)
{
  const struct ripng *ripng = args->list_entry;

  args->keys->num = 1;
  strlcpy (args->keys->key[0], ripng->vrf_name, sizeof (args->keys->key[0]));

  return NB_OK;
}

const void *
ripngd_instance_lookup_entry (struct nb_cb_lookup_entry_args *args)
{
 ...
 */
int
ripngd_instance_allow_ecmp_modify (struct nb_cb_modify_args *args)
{
  struct ripng *ripng;
    ...
    struct nb_cb_modify_args *args)
{
  ...
  if (default_information)
    {
      ripng_redistribute_add (ripng, ZEBRA_ROUTE_RIPNG, RIPNG_ROUTE_DEFAULT,
                              &p, 0, NULL, 0);
    }
  else
    {
      ripng_redistribute_delete (ripng, ZEBRA_ROUTE_RIPNG, RIPNG_ROUTE_DEFAULT,
                                 &p, 0);
    }
 ...
 */
int
ripngd_instance_default_metric_modify (struct nb_cb_modify_args *args)
{
  struct ripng *ripng;
 ...
 */
int
ripngd_instance_network_create (struct nb_cb_create_args *args)
{
  struct ripng *ripng;
  struct prefix p;
...
int
ripngd_instance_network_destroy (struct nb_cb_destroy_args *args)
{
  struct ripng *ripng;
  struct prefix p;
 ...
 */
int
ripngd_instance_interface_create (struct nb_cb_create_args *args)
{
  struct ripng *ripng;
  const char *ifname;
...
int
ripngd_instance_interface_destroy (struct nb_cb_destroy_args *args)
{
  struct ripng *ripng;
  const char *ifname;
 ...
 */
int
ripngd_instance_offset_list_create (struct nb_cb_create_args *args)
{
  struct ripng *ripng;
  const char *ifname;
...
int
ripngd_instance_offset_list_destroy (struct nb_cb_destroy_args *args)
{
  int direct;
  struct ripng_offset_list *offset;
 ...
 */
int
ripngd_instance_offset_list_access_list_modify (struct nb_cb_modify_args *args)
{
  int direct;
  struct ripng_offset_list *offset;
 ...
 */
int
ripngd_instance_offset_list_metric_modify (struct nb_cb_modify_args *args)
{
  int direct;
  uint8_t metric;
  struct ripng_offset_list *offset;
 ...
 */
int
ripngd_instance_passive_interface_create (struct nb_cb_create_args *args)
{
  struct ripng *ripng;
  const char *ifname;
...
int
ripngd_instance_passive_interface_destroy (struct nb_cb_destroy_args *args)
{
  struct ripng *ripng;
  const char *ifname;
 ...
 */
int
ripngd_instance_redistribute_create (struct nb_cb_create_args *args)
{
  struct ripng *ripng;
  int type;
...
int
ripngd_instance_redistribute_destroy (struct nb_cb_destroy_args *args)
{
  struct ripng *ripng;
  int type;
 ...
 */
int
ripngd_instance_redistribute_route_map_modify (struct nb_cb_modify_args *args)
{
  struct ripng *ripng;
  int type;
 ...
 */
int
ripngd_instance_redistribute_metric_modify (struct nb_cb_modify_args *args)
{
  struct ripng *ripng;
  int type;
  uint8_t metric;
...
int
ripngd_instance_redistribute_metric_destroy (struct nb_cb_destroy_args *args)
{
  struct ripng *ripng;
  int type;
 ...
 */
int
ripngd_instance_static_route_create (struct nb_cb_create_args *args)
{
  struct ripng *ripng;
  struct prefix_ipv6 p;
  ...
  ripng_redistribute_add (ripng, ZEBRA_ROUTE_RIPNG, RIPNG_ROUTE_STATIC, &p, 0,
                          NULL, 0);
...
int
ripngd_instance_static_route_destroy (struct nb_cb_destroy_args *args)
{
  struct ripng *ripng;
  struct prefix_ipv6 p;
  ...
  ripng_redistribute_delete (ripng, ZEBRA_ROUTE_RIPNG, RIPNG_ROUTE_STATIC, &p,
                             0);
 ...
 */
int
ripngd_instance_aggregate_address_create (struct nb_cb_create_args *args)
{
  struct ripng *ripng;
  struct prefix_ipv6 p;
...
int
ripngd_instance_aggregate_address_destroy (struct nb_cb_destroy_args *args)
{
  struct ripng *ripng;
  struct prefix_ipv6 p;
 ...
 */
void
ripngd_instance_timers_apply_finish (struct nb_cb_apply_finish_args *args)
{
  struct ripng *ripng;
 ...
 */
int
ripngd_instance_timers_flush_interval_modify (struct nb_cb_modify_args *args)
{
  struct ripng *ripng;
 ...
 */
int
ripngd_instance_timers_update_interval_modify (struct nb_cb_modify_args *args)
{
  struct ripng *ripng;
 ...
 */
int
lib_interface_ripng_split_horizon_modify (struct nb_cb_modify_args *args)
{
