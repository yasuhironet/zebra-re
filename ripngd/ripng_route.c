...
void
ripng_aggregate_increment (struct agg_node *child, struct ripng_info *rinfo)
{
  struct agg_node *np;
...
void
ripng_aggregate_decrement (struct agg_node *child, struct ripng_info *rinfo)
{
  struct agg_node *np;
  struct ripng_aggregate *aggregate;
...
void
ripng_aggregate_decrement_list (struct agg_node *child, struct list *list)
{
  struct agg_node *np;
  struct ripng_aggregate *aggregate;
...
int
ripng_aggregate_add (struct ripng *ripng, struct prefix *p)
{
  struct agg_node *top;
  struct agg_node *rp;
...
int
ripng_aggregate_delete (struct ripng *ripng, struct prefix *p)
{
  struct agg_node *top;
  struct agg_node *rp;
  struct ripng_info *rinfo;
