...
#define VTYSH_ALL                                                             \
  VTYSH_ZEBRA | VTYSH_RIPD | VTYSH_RIPNGD | VTYSH_OSPFD | VTYSH_OSPF6D |      \
      VTYSH_LDPD | VTYSH_BGPD | VTYSH_ISISD | VTYSH_PIMD | VTYSH_PIM6D |      \
      VTYSH_NHRPD | VTYSH_EIGRPD | VTYSH_BABELD | VTYSH_SHARPD | VTYSH_PBRD | \
      VTYSH_STATICD | VTYSH_BFDD | VTYSH_FABRICD | VTYSH_VRRPD |              \
      VTYSH_PATHD | VTYSH_MGMTD
#define VTYSH_ACL                                                             \
  VTYSH_BFDD | VTYSH_BABELD | VTYSH_BGPD | VTYSH_EIGRPD | VTYSH_ISISD |       \
      VTYSH_FABRICD | VTYSH_LDPD | VTYSH_NHRPD | VTYSH_OSPF6D | VTYSH_OSPFD | \
      VTYSH_PBRD | VTYSH_PIMD | VTYSH_PIM6D | VTYSH_RIPD | VTYSH_RIPNGD |     \
      VTYSH_VRRPD | VTYSH_ZEBRA
#define VTYSH_AFFMAP VTYSH_ZEBRA | VTYSH_ISISD
#define VTYSH_RMAP                                                            \
  VTYSH_ZEBRA | VTYSH_RIPD | VTYSH_RIPNGD | VTYSH_OSPFD | VTYSH_OSPF6D |      \
      VTYSH_BGPD | VTYSH_ISISD | VTYSH_PIMD | VTYSH_EIGRPD | VTYSH_FABRICD
#define VTYSH_INTERFACE_SUBSET                                                \
  VTYSH_ZEBRA | VTYSH_RIPD | VTYSH_RIPNGD | VTYSH_OSPFD | VTYSH_OSPF6D |      \
      VTYSH_ISISD | VTYSH_PIMD | VTYSH_PIM6D | VTYSH_NHRPD | VTYSH_EIGRPD |   \
