 ...
 */
void
pathd_apply_finish (struct nb_cb_apply_finish_args *args)
{
  srte_apply_changes ();
}
 ...
 */
int
pathd_srte_segment_list_create (struct nb_cb_create_args *args)
{
...
int
pathd_srte_segment_list_destroy (struct nb_cb_destroy_args *args)
{
  struct srte_segment_list *segment_list;
 ...
 */
int
pathd_srte_segment_list_protocol_origin_modify (struct nb_cb_modify_args *args)
{
  struct srte_segment_list *segment_list;
 ...
 */
int
pathd_srte_segment_list_originator_modify (struct nb_cb_modify_args *args)
{
  struct srte_segment_list *segment_list;
 ...
 */
int
pathd_srte_segment_list_segment_create (struct nb_cb_create_args *args)
{
  struct srte_segment_list *segment_list;
...
int
pathd_srte_segment_list_segment_destroy (struct nb_cb_destroy_args *args)
{
  struct srte_segment_entry *segment;
...
int
pathd_srte_segment_list_segment_nai_destroy (struct nb_cb_destroy_args *args)
{
  struct srte_segment_entry *segment;
    ...
    struct nb_cb_apply_finish_args *args)
{
  ...
  if (srte_segment_entry_set_nai (segment, type, &local_addr, local_iface,
                                  ...
                                  local_prefix_len))
    SET_FLAG (segment->segment_list->flags, F_SEGMENT_LIST_SID_CONFLICT);
}
 ...
 */
int
pathd_srte_policy_create (struct nb_cb_create_args *args)
{
...
int
pathd_srte_policy_destroy (struct nb_cb_destroy_args *args)
{
  struct srte_policy *policy;
 ...
 */
int
pathd_srte_policy_name_modify (struct nb_cb_modify_args *args)
{
  struct srte_policy *policy;
  const char *name;
...
int
pathd_srte_policy_name_destroy (struct nb_cb_destroy_args *args)
{
  struct srte_policy *policy;
 ...
 */
int
pathd_srte_policy_binding_sid_modify (struct nb_cb_modify_args *args)
{
  struct srte_policy *policy;
...
int
pathd_srte_policy_binding_sid_destroy (struct nb_cb_destroy_args *args)
{
  struct srte_policy *policy;
 ...
 */
int
pathd_srte_policy_candidate_path_create (struct nb_cb_create_args *args)
{
  struct srte_policy *policy;
  ...
  candidate = srte_candidate_add (policy, preference, SRTE_ORIGIN_LOCAL, NULL);
...
int
pathd_srte_policy_candidate_path_destroy (struct nb_cb_destroy_args *args)
{
  struct srte_candidate *candidate;
 ...
 */
int
pathd_srte_policy_candidate_path_name_modify (struct nb_cb_modify_args *args)
{
  struct srte_candidate *candidate;
  const char *name;
...
static int
affinity_filter_modify (struct nb_cb_modify_args *args,
...
static int
affinity_filter_destroy (struct nb_cb_destroy_args *args,
                         enum affinity_filter_type type)
{
  struct srte_candidate *candidate;
    ...
    struct nb_cb_modify_args *args)
{
  ...
  candidate = nb_running_get_entry (args->dnode, NULL, true);
  originator = yang_dnode_get_string (args->dnode, NULL);
  strlcpy (candidate->originator, originator, sizeof (candidate->originator));
 ...
 */
int
pathd_srte_policy_candidate_path_type_modify (struct nb_cb_modify_args *args)
{
  struct srte_candidate *candidate;
  ...
  if (args->event == NB_EV_VALIDATE)
    {
      ...
      if (candidate && candidate->type != SRTE_CANDIDATE_TYPE_UNDEFINED)
        {
          flog_warn (EC_LIB_NB_CB_CONFIG_VALIDATE,
