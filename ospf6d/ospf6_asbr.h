...
extern int ospf6_distribute_config_write (struct vty *vty,
                                          struct ospf6 *ospf6);
...
int ospf6_asbr_external_rt_advertise (struct ospf6 *ospf6, struct prefix *p);
...
int ospf6_external_aggr_config_unset (struct ospf6 *ospf6, struct prefix *p);
