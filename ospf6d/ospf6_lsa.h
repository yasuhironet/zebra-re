...
#define IS_OSPF6_DEBUG_EXAMIN(name)                                           \
  (ospf6_lstype_debug (htons (OSPF6_LSTYPE_##name)) & OSPF6_LSA_DEBUG_EXAMIN)
...
#define OSPF6_LSA_IS_SEQWRAP(L)                                               \
  ((L)->header->seqnum == htonl (OSPF_MAX_SEQUENCE_NUMBER + 1))
...
#define CHECK_LSA_TOPO_CHG_ELIGIBLE(type)                                     \
  ((type == OSPF6_LSTYPE_ROUTER) || (type == OSPF6_LSTYPE_NETWORK) ||         \
   (type == OSPF6_LSTYPE_INTER_PREFIX) ||                                     \
   (type == OSPF6_LSTYPE_INTER_ROUTER) ||                                     \
   (type == OSPF6_LSTYPE_AS_EXTERNAL) || (type == OSPF6_LSTYPE_TYPE_7) ||     \
...
extern int ospf6_lsa_is_differ (struct ospf6_lsa *lsa1,
                                struct ospf6_lsa *lsa2);
extern int ospf6_lsa_is_changed (struct ospf6_lsa *lsa1,
                                 struct ospf6_lsa *lsa2);
