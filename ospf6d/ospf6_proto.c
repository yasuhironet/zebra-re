...
void
ospf6_prefix_in6_addr (struct in6_addr *in6, const void *prefix_buf,
...
void
ospf6_prefix_options_printbuf (uint8_t prefix_options, char *buf, int size)
{
...
void
ospf6_options_printbuf (uint8_t *options, char *buf, int size)
{
  ...
  snprintf (buf, size, "%s|%s|%s|-|-|%s|%s|%s|%s|%s|%s", at, l, af, dc, r, n,
            mc, e, v6);
}
