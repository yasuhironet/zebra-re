...
#define CHECK_LSA_TYPE_1_TO_5_OR_7(type)                                      \
  ((type == OSPF6_ROUTER_LSA_MIN_SIZE) ||                                     \
   ...
   (type == OSPF6_INTRA_PREFIX_LSA_MIN_SIZE) || (type == OSPF6_AS_NSSA_LSA))
...
int ospf6_area_nssa_no_summary_set (struct ospf6 *ospf6,
...
ospf6_translated_nssa_refresh (struct ospf6_area *oa, struct ospf6_lsa *type7,
