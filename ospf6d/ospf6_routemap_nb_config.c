 ...
 */
int
lib_route_map_entry_set_action_rmap_set_action_metric_type_modify (
...
int
lib_route_map_entry_set_action_rmap_set_action_metric_type_destroy (
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      ...
      rv = generic_set_add (rhc->rhc_rmi, "forwarding-address", ipv6_addr,
