...
#define DEFAULT_ORIGINATE_ALWAYS 2
  ...
  struct event *t_deferred_shutdown; /* deferred/stub-router shutdown timer*/
...
extern int ospf_area_no_summary_set (struct ospf *ospf,
                                     struct in_addr area_id);
...
extern int ospf_area_import_list_unset (struct ospf *ospf,
                                        struct ospf_area *area_id);
extern int ospf_area_shortcut_set (struct ospf *ospf,
                                   struct ospf_area *area_id, int mode);
...
extern void ospf_interface_area_unset (struct ospf *ospf,
