...
void
netlink_update_binding (struct interface *ifp, union sockunion *proto,
...
static void
netlink_log_register (int fd, int group)
{
  struct nlmsghdr *n;
  struct nfgenmsg *nf;
...
static void
netlink_log_indication (struct nlmsghdr *msg, struct zbuf *zb)
{
  struct nfgenmsg *nf;
  struct rtattr *rta;
...
static void
netlink_log_recv (struct event *t)
{
...
void
netlink_set_nflog_group (int nlgroup)
{
  if (netlink_log_fd >= 0)
    {
...
int
nhrp_neighbor_operation (ZAPI_CALLBACK_ARGS)
{
