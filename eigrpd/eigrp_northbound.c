...
/* Helper functions. */
static void
redistribute_get_metrics (const struct lyd_node *dnode,
...
static struct eigrp_interface *
eigrp_interface_lookup (const struct eigrp *eigrp, const char *ifname)
{
 ...
 */
static int
eigrpd_instance_create (struct nb_cb_create_args *args)
{
  struct eigrp *eigrp;
  const char *vrf;
  struct vrf *pVrf;
...
static int
eigrpd_instance_destroy (struct nb_cb_destroy_args *args)
{
  struct eigrp *eigrp;
 ...
 */
static int
eigrpd_instance_router_id_modify (struct nb_cb_modify_args *args)
{
  struct eigrp *eigrp;
...
static int
eigrpd_instance_router_id_destroy (struct nb_cb_destroy_args *args)
{
  struct eigrp *eigrp;
 ...
 */
static int
eigrpd_instance_active_time_modify (struct nb_cb_modify_args *args)
{
  switch (args->event)
    {
    case NB_EV_VALIDATE:
 ...
 */
static int
eigrpd_instance_variance_modify (struct nb_cb_modify_args *args)
{
  struct eigrp *eigrp;
...
static int
eigrpd_instance_variance_destroy (struct nb_cb_destroy_args *args)
{
  struct eigrp *eigrp;
 ...
 */
static int
eigrpd_instance_maximum_paths_modify (struct nb_cb_modify_args *args)
{
  struct eigrp *eigrp;
 ...
 */
static int
eigrpd_instance_network_create (struct nb_cb_create_args *args)
{
...
static int
eigrpd_instance_network_destroy (struct nb_cb_destroy_args *args)
{
  struct route_node *rnode;
  struct prefix prefix;
  struct eigrp *eigrp;
 ...
 */
static int
eigrpd_instance_neighbor_create (struct nb_cb_create_args *args)
{
  switch (args->event)
    {
    case NB_EV_VALIDATE:
...
static int
eigrpd_instance_neighbor_destroy (struct nb_cb_destroy_args *args)
{
  switch (args->event)
    {
    case NB_EV_VALIDATE:
 ...
 */
static int
eigrpd_instance_redistribute_create (struct nb_cb_create_args *args)
{
...
static int
eigrpd_instance_redistribute_destroy (struct nb_cb_destroy_args *args)
{
  struct eigrp *eigrp;
  uint32_t proto;
 ...
 */
static int
lib_interface_eigrp_delay_modify (struct nb_cb_modify_args *args)
{
 ...
 */
static int
lib_interface_eigrp_bandwidth_modify (struct nb_cb_modify_args *args)
{
  struct interface *ifp;
  struct eigrp_interface *ei;
 ...
 */
static int
lib_interface_eigrp_hold_time_modify (struct nb_cb_modify_args *args)
{
  struct interface *ifp;
  struct eigrp_interface *ei;
 ...
 */
static int
lib_interface_eigrp_instance_create (struct nb_cb_create_args *args)
{
  struct eigrp_interface *eif;
  struct interface *ifp;
  struct eigrp *eigrp;
...
static int
lib_interface_eigrp_instance_destroy (struct nb_cb_destroy_args *args)
{
  switch (args->event)
    {
    case NB_EV_VALIDATE:
