...
/* Hook functions. */
static uint8_t *eigrpVpnEntry (struct variable *, oid *, size_t *, int,
                               size_t *, WriteMethod **);
...
struct variable eigrp_variables[] = {
  ...
  { EIGRPHELLOSSENT, COUNTER, RONLY, eigrpTraffStatsEntry, 4, { 2, 1, 1, 3 } },
  { EIGRPHELLOSRCVD, COUNTER, RONLY, eigrpTraffStatsEntry, 4, { 2, 1, 1, 4 } },
  { EIGRPUPDATESSENT,
    COUNTER,
    RONLY,
    eigrpTraffStatsEntry,
  ...
  { EIGRPXMITRELIABLEQ, GAUGE, RONLY, eigrpInterfaceEntry, 4, { 5, 1, 1, 4 } },
  ...
  { EIGRPAUTHKEYCHAIN, STRING, RONLY, eigrpInterfaceEntry, 4, { 5, 1, 1, 23 } }
};
...
static uint8_t *
eigrpVpnEntry (struct variable *v, oid *name, size_t *length, int exact,
...
static uint8_t *
eigrpTraffStatsEntry (struct variable *v, oid *name, size_t *length, int exact,
                      size_t *var_len, WriteMethod **write_method)
{
  struct eigrp *eigrp;
  struct eigrp_interface *ei;
...
static uint8_t *
eigrpTopologyEntry (struct variable *v, oid *name, size_t *length, int exact,
                    size_t *var_len, WriteMethod **write_method)
{
  struct eigrp *eigrp;
...
static uint8_t *
eigrpPeerEntry (struct variable *v, oid *name, size_t *length, int exact,
                size_t *var_len, WriteMethod **write_method)
{
  struct eigrp *eigrp;
  struct eigrp_interface *ei;
...
static uint8_t *
eigrpInterfaceEntry (struct variable *v, oid *name, size_t *length, int exact,
                     size_t *var_len, WriteMethod **write_method)
{
  struct eigrp *eigrp;
  struct listnode *node, *nnode;
