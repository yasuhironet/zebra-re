 ...
 */
void
eigrp_distribute_update (struct distribute_ctx *ctx, struct distribute *dist)
{
 ...
 */
void
eigrp_distribute_timer_process (struct event *thread)
{
  struct eigrp *eigrp;
 ...
 */
void
eigrp_distribute_timer_interface (struct event *thread)
{
