 ...
 */
static int
eigrp_route_descriptor_cmp (struct eigrp_route_descriptor *entry1,
 ...
 */
void
eigrp_topology_free (struct eigrp *eigrp, struct route_table *table)
{
 ...
 */
void
eigrp_prefix_descriptor_add (struct route_table *topology,
 ...
 */
void
eigrp_route_descriptor_add (struct eigrp *eigrp,
 ...
 */
void
eigrp_prefix_descriptor_delete (struct eigrp *eigrp, struct route_table *table,
                                struct eigrp_prefix_descriptor *pe)
{
 ...
 */
void
eigrp_route_descriptor_delete (struct eigrp *eigrp,
                               struct eigrp_prefix_descriptor *node,
                               struct eigrp_route_descriptor *entry)
{
  if (listnode_lookup (node->entries, entry) != NULL)
 ...
 */
void
eigrp_topology_delete_all (struct eigrp *eigrp, struct route_table *topology)
{
  struct route_node *rn;
  struct eigrp_prefix_descriptor *pe;
...
struct list *
eigrp_neighbor_prefixes_lookup (struct eigrp *eigrp,
                                struct eigrp_neighbor *nbr)
{
...
eigrp_topology_update_distance (struct eigrp_fsm_action_message *msg)
{
  ...
  switch (msg->data_type)
    ...
    case EIGRP_INT:
      ...
      if (eigrp_metrics_is_same (msg->metrics, entry->reported_metric))
        {
...
void
eigrp_update_routing_table (struct eigrp *eigrp,
