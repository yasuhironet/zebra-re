 ...
 */
static void
bfd_session_get_key (bool mhop, const struct lyd_node *dnode,
                     struct bfd_key *bk)
{
...
static int
session_iter_cb (const struct lyd_node *dnode, void *arg)
{
...
static int
bfd_session_create (struct nb_cb_create_args *args, bool mhop)
{
  ...
  switch (args->event)
    ...
    case NB_EV_VALIDATE:
      ...
      yang_dnode_iterate (session_iter_cb, &iter, sess_dnode,
                          "./single-hop[dest-addr='%s'][vrf='%s']", dest,
                          vrfname);
...
static int
bfd_session_destroy (enum nb_event event, const struct lyd_node *dnode,
                     bool mhop)
{
  struct bfd_session *bs;
  struct bfd_key bk;
 ...
 */
int
bfdd_bfd_create (struct nb_cb_create_args *args)
{
...
int
bfdd_bfd_destroy (struct nb_cb_destroy_args *args)
{
  switch (args->event)
    {
    case NB_EV_VALIDATE:
 ...
 */
int
bfdd_bfd_profile_create (struct nb_cb_create_args *args)
{
...
int
bfdd_bfd_profile_destroy (struct nb_cb_destroy_args *args)
{
  struct bfd_profile *bp;
 ...
 */
int
bfdd_bfd_profile_detection_multiplier_modify (struct nb_cb_modify_args *args)
{
  struct bfd_profile *bp;
 ...
 */
int
bfdd_bfd_profile_administrative_down_modify (struct nb_cb_modify_args *args)
{
  struct bfd_profile *bp;
 ...
 */
int
bfdd_bfd_profile_passive_mode_modify (struct nb_cb_modify_args *args)
{
  struct bfd_profile *bp;
 ...
 */
int
bfdd_bfd_profile_minimum_ttl_modify (struct nb_cb_modify_args *args)
{
  struct bfd_profile *bp;
 ...
 */
int
bfdd_bfd_profile_echo_mode_modify (struct nb_cb_modify_args *args)
{
  struct bfd_profile *bp;
  bool echo;
 ...
 */
int
bfdd_bfd_sessions_single_hop_create (struct nb_cb_create_args *args)
{
  return bfd_session_create (args, false);
}

int
bfdd_bfd_sessions_single_hop_destroy (struct nb_cb_destroy_args *args)
{
 ...
 */
int
bfdd_bfd_sessions_single_hop_profile_modify (struct nb_cb_modify_args *args)
{
  struct bfd_session *bs;
...
int
bfdd_bfd_sessions_single_hop_profile_destroy (struct nb_cb_destroy_args *args)
{
  struct bfd_session *bs;
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      bs = nb_running_get_entry (args->dnode, NULL, true);
      bs->peer_profile.min_tx = yang_dnode_get_uint32 (args->dnode, NULL);
      bfd_session_apply (bs);
      break;
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      bs = nb_running_get_entry (args->dnode, NULL, true);
      bs->peer_profile.min_rx = yang_dnode_get_uint32 (args->dnode, NULL);
      bfd_session_apply (bs);
      break;
 ...
 */
int
bfdd_bfd_sessions_single_hop_echo_mode_modify (struct nb_cb_modify_args *args)
{
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      bs = nb_running_get_entry (args->dnode, NULL, true);
      bs->peer_profile.min_echo_tx = yang_dnode_get_uint32 (args->dnode, NULL);
      bfd_session_apply (bs);
      break;
    ...
    struct nb_cb_modify_args *args)
{
  ...
  switch (args->event)
    ...
    case NB_EV_APPLY:
      bs = nb_running_get_entry (args->dnode, NULL, true);
      bs->peer_profile.min_echo_rx = yang_dnode_get_uint32 (args->dnode, NULL);
      bfd_session_apply (bs);
      break;
 ...
 */
int
bfdd_bfd_sessions_multi_hop_create (struct nb_cb_create_args *args)
{
  return bfd_session_create (args, true);
}

int
bfdd_bfd_sessions_multi_hop_destroy (struct nb_cb_destroy_args *args)
{
 ...
 */
int
bfdd_bfd_sessions_multi_hop_minimum_ttl_modify (struct nb_cb_modify_args *args)
{
  struct bfd_session *bs;
