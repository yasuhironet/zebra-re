...
int
bfdd_bfd_sessions_single_hop_get_keys (struct nb_cb_get_keys_args *args)
{
    ...
    struct nb_cb_get_elem_args *args)
{
  ...
  return yang_data_new_uint32 (args->xpath, bs->remote_timers.desired_min_tx);
}
    ...
    struct nb_cb_get_elem_args *args)
{
  ...
  return yang_data_new_uint32 (args->xpath, bs->remote_timers.required_min_rx);
}
...
int
bfdd_bfd_sessions_multi_hop_get_keys (struct nb_cb_get_keys_args *args)
{
  const struct bfd_session *bs = args->list_entry;
