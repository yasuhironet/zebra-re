...
const void *bfdd_bfd_sessions_single_hop_lookup_entry (
...
const void *bfdd_bfd_sessions_multi_hop_lookup_entry (
    struct nb_cb_lookup_entry_args *args);
...
struct yang_data *bfdd_bfd_sessions_multi_hop_stats_remote_state_get_elem (
    struct nb_cb_get_elem_args *args);
struct yang_data *
bfdd_bfd_sessions_multi_hop_stats_remote_diagnostic_get_elem (
    struct nb_cb_get_elem_args *args);
struct yang_data *
bfdd_bfd_sessions_multi_hop_stats_remote_multiplier_get_elem (
    struct nb_cb_get_elem_args *args);
struct yang_data *
...
struct yang_data *bfdd_bfd_sessions_multi_hop_stats_last_up_time_get_elem (
    struct nb_cb_get_elem_args *args);
struct yang_data *
bfdd_bfd_sessions_multi_hop_stats_session_down_count_get_elem (
    struct nb_cb_get_elem_args *args);
