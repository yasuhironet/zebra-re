...
#define MGMT_DEBUG_TXN_CHECK()                                                \
  DEBUG_MODE_CHECK (&mgmt_debug_tx, DEBUG_MODE_ALL)
 ...
 */
static inline void
mgmt_remove_trailing_separator (char *str, char sep)
{
  size_t len;
...
extern void mgmt_master_init (struct event_loop *master,
