...
mgmt_ds_id2name (Mgmtd__DatastoreId id)
{
 ...
 *    Datastore ID.
 */
static inline Mgmtd__DatastoreId
 ...
 */
static inline void
mgmt_xpath_append_trail_wildcard (char *xpath, size_t *xpath_len)
{
  if (! xpath || ! xpath_len)
    return;
 ...
 */
static inline void
mgmt_xpath_remove_trail_wildcard (char *xpath, size_t *xpath_len)
{
  if (! xpath || ! xpath_len)
    return;
