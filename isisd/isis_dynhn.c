...
void
dyn_cache_init (struct isis *isis)
{
...
void
dyn_cache_finish (struct isis *isis)
{
...
static void
dyn_cache_cleanup (struct event *thread)
{
  struct listnode *node, *nnode;
  struct isis_dynhn *dyn;
  ...
  event_add_timer (master, dyn_cache_cleanup, isis, 120, &isis->t_dync_clean);
}

struct isis_dynhn *
dynhn_find_by_id (struct isis *isis, const uint8_t *id)
{
...
struct isis_dynhn *
dynhn_find_by_name (struct isis *isis, const char *hostname)
{
  struct listnode *node = NULL;
  struct isis_dynhn *dyn = NULL;
...
void
isis_dynhn_insert (struct isis *isis, const uint8_t *id, const char *hostname,
                   int level)
{
  struct isis_dynhn *dyn;
...
void
isis_dynhn_remove (struct isis *isis, const uint8_t *id)
{
  struct isis_dynhn *dyn;
 ...
 */
void
dynhn_print_all (struct vty *vty, struct isis *isis)
{
...
struct isis_dynhn *
dynhn_snmp_next (struct isis *isis, const uint8_t *id, int level)
{
  struct listnode *node = NULL;
  struct isis_dynhn *dyn = NULL;
