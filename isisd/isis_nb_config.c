 ...
 */
int
isis_instance_create (struct nb_cb_create_args *args)
{
...
int
isis_instance_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_area *area;
  struct isis *isis;
 ...
 */
int
isis_instance_is_type_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
  int type;
...
static int
sysid_iter_cb (const struct lyd_node *dnode, void *arg)
{
 ...
 */
int
isis_instance_area_address_create (struct nb_cb_create_args *args)
{
  struct isis_area *area;
...
int
isis_instance_area_address_destroy (struct nb_cb_destroy_args *args)
{
 ...
 */
int
isis_instance_dynamic_hostname_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_attached_send_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
  bool attached;
 ...
 */
int
isis_instance_attached_receive_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
  bool attached;
 ...
 */
int
isis_instance_attached_modify (struct nb_cb_modify_args *args)
{
  return NB_OK;
}
 ...
 */
int
isis_instance_overload_enabled_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
  bool overload;
 ...
 */
int
isis_instance_overload_on_startup_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_advertise_high_metrics_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_metric_style_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_purge_originator_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_admin_group_send_zero_modify (struct nb_cb_modify_args *args)
{
  struct isis_circuit *circuit;
  struct isis_area *area;
  struct listnode *node;
 ...
 */
int
isis_instance_asla_legacy_flag_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_lsp_mtu_modify (struct nb_cb_modify_args *args)
{
 ...
 */
int
isis_instance_advertise_passive_only_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
 ...
 */
void
ietf_backoff_delay_apply_finish (struct nb_cb_apply_finish_args *args)
{
  ...
  area->spf_delay_ietf[0] = spf_backoff_new (
      master, buf, init_delay, short_delay, long_delay, holddown, timetolearn);

  snprintf (buf, bufsiz, "IS-IS %s L2", area->area_tag);
  spf_backoff_free (area->spf_delay_ietf[1]);
  area->spf_delay_ietf[1] = spf_backoff_new (
      master, buf, init_delay, short_delay, long_delay, holddown, timetolearn);
...
int
isis_instance_spf_ietf_backoff_delay_create (struct nb_cb_create_args *args)
{
...
int
isis_instance_spf_ietf_backoff_delay_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_area *area;
 ...
 */
void
area_password_apply_finish (struct nb_cb_apply_finish_args *args)
{
...
int
isis_instance_area_password_create (struct nb_cb_create_args *args)
{
...
int
isis_instance_area_password_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_area_password_password_modify (struct nb_cb_modify_args *args)
{
  /* actual setting is done in apply_finish */
  return NB_OK;
}
 ...
 */
void
domain_password_apply_finish (struct nb_cb_apply_finish_args *args)
{
  const char *password = yang_dnode_get_string (args->dnode, "./password");
  struct isis_area *area = nb_running_get_entry (args->dnode, NULL, true);
  int pass_type = yang_dnode_get_enum (args->dnode, "./password-type");
...
int
isis_instance_domain_password_create (struct nb_cb_create_args *args)
{
  /* actual setting is done in apply_finish */
  return NB_OK;
}
...
int
isis_instance_domain_password_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_domain_password_password_modify (struct nb_cb_modify_args *args)
{
  /* actual setting is done in apply_finish */
  return NB_OK;
}
 ...
 */
void
default_info_origin_apply_finish (const struct lyd_node *dnode, int family)
{
...
void
default_info_origin_ipv4_apply_finish (struct nb_cb_apply_finish_args *args)
{
  default_info_origin_apply_finish (args->dnode, AF_INET);
}

void
default_info_origin_ipv6_apply_finish (struct nb_cb_apply_finish_args *args)
{
 ...
 */
void
redistribute_apply_finish (const struct lyd_node *dnode, int family)
{
...
void
redistribute_ipv4_apply_finish (struct nb_cb_apply_finish_args *args)
{
  redistribute_apply_finish (args->dnode, AF_INET);
}

void
redistribute_ipv6_apply_finish (struct nb_cb_apply_finish_args *args)
{
  redistribute_apply_finish (args->dnode, AF_INET6);
}

int
isis_instance_redistribute_ipv4_create (struct nb_cb_create_args *args)
{
...
int
isis_instance_redistribute_ipv4_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_area *area;
  int level, type;
 ...
 */
int
isis_instance_redistribute_ipv4_metric_modify (struct nb_cb_modify_args *args)
{
  /* It's all done by redistribute_apply_finish */
  return NB_OK;
}
 ...
 */
int
isis_instance_redistribute_ipv6_create (struct nb_cb_create_args *args)
{
  /* It's all done by redistribute_apply_finish */
  return NB_OK;
}
...
int
isis_instance_redistribute_ipv6_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_area *area;
  int level, type;
 ...
 */
int
isis_instance_redistribute_ipv6_metric_modify (struct nb_cb_modify_args *args)
{
  /* It's all done by redistribute_apply_finish */
  return NB_OK;
}
 ...
 */
static int
isis_multi_topology_common (enum nb_event event, const struct lyd_node *dnode,
...
static int
isis_multi_topology_overload_common (enum nb_event event,
...
isis_instance_multi_topology_ipv4_multicast_create (
    struct nb_cb_create_args *args)
{
  return isis_multi_topology_common (args->event, args->dnode, args->errmsg,
                                     args->errmsg_len, "ipv4-multicast", true);
}
...
{
  return isis_multi_topology_common (args->event, args->dnode, args->errmsg,
                                     args->errmsg_len, "ipv4-multicast",
                                     false);
}
...
{
  return isis_multi_topology_common (args->event, args->dnode, args->errmsg,
                                     args->errmsg_len, "ipv4-mgmt", true);
}
...
{
  return isis_multi_topology_common (args->event, args->dnode, args->errmsg,
                                     args->errmsg_len, "ipv4-mgmt", false);
}
...
{
  return isis_multi_topology_common (args->event, args->dnode, args->errmsg,
                                     args->errmsg_len, "ipv6-unicast", true);
}
...
{
  return isis_multi_topology_common (args->event, args->dnode, args->errmsg,
                                     args->errmsg_len, "ipv6-unicast", false);
}
...
{
  return isis_multi_topology_common (args->event, args->dnode, args->errmsg,
                                     args->errmsg_len, "ipv6-multicast", true);
}
...
{
  return isis_multi_topology_common (args->event, args->dnode, args->errmsg,
                                     args->errmsg_len, "ipv6-multicast",
                                     false);
}
...
{
  return isis_multi_topology_common (args->event, args->dnode, args->errmsg,
                                     args->errmsg_len, "ipv6-mgmt", true);
}
...
{
  return isis_multi_topology_common (args->event, args->dnode, args->errmsg,
                                     args->errmsg_len, "ipv6-mgmt", false);
}
...
{
  return isis_multi_topology_common (args->event, args->dnode, args->errmsg,
                                     args->errmsg_len, "ipv6-dstsrc", true);
}
...
{
  return isis_multi_topology_common (args->event, args->dnode, args->errmsg,
                                     args->errmsg_len, "ipv6-dstsrc", false);
}
 ...
 */
int
isis_instance_log_adjacency_changes_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_log_pdu_drops_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
  bool log = yang_dnode_get_bool (args->dnode, NULL);
 ...
 */
int
isis_instance_mpls_te_create (struct nb_cb_create_args *args)
{
  struct isis_area *area;
...
int
isis_instance_mpls_te_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_mpls_te_router_address_modify (struct nb_cb_modify_args *args)
{
...
int
isis_instance_mpls_te_router_address_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_mpls_te_export_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_segment_routing_enabled_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
  ...
  switch (sid_type)
    ...
    case SR_SID_VALUE_TYPE_ABSOLUTE:
      if (! IS_MPLS_UNRESERVED_LABEL (sid))
        {
          snprintf (args->errmsg, args->errmsg_len, "Invalid absolute SID %u",
                    sid);
          return NB_ERR_VALIDATION;
        }
 ...
 */
int
isis_instance_flex_algo_create (struct nb_cb_create_args *args)
{
  struct isis_area *area;
  struct flex_algo *fa;
  bool advertise;
...
int
isis_instance_flex_algo_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_area *area;
  uint32_t algorithm;
...
static int
isis_instance_flex_algo_affinity_set (struct nb_cb_create_args *args, int type)
{
...
int
isis_instance_flex_algo_prefix_metric_create (struct nb_cb_create_args *args)
{
  struct isis_area *area;
  const char *area_tag;
  struct flex_algo *fa;
...
int
isis_instance_flex_algo_prefix_metric_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_area *area;
  const char *area_tag;
  struct flex_algo *fa;
...
static int
isis_instance_flex_algo_dplane_set (struct nb_cb_create_args *args, int type)
{
  struct isis_area *area;
  const char *area_tag;
  struct flex_algo *fa;
...
static int
isis_instance_flex_algo_dplane_unset (struct nb_cb_destroy_args *args,
                                      int type)
{
  struct isis_area *area;
  const char *area_tag;
...
int
isis_instance_flex_algo_dplane_sr_mpls_create (struct nb_cb_create_args *args)
{
...
int
isis_instance_flex_algo_dplane_srv6_create (struct nb_cb_create_args *args)
{
  return isis_instance_flex_algo_dplane_set (args, FLEX_ALGO_SRV6);
}

int
isis_instance_flex_algo_dplane_srv6_destroy (struct nb_cb_destroy_args *args)
{
...
int
isis_instance_flex_algo_dplane_ip_create (struct nb_cb_create_args *args)
{
  return isis_instance_flex_algo_dplane_set (args, FLEX_ALGO_IP);
}

int
isis_instance_flex_algo_dplane_ip_destroy (struct nb_cb_destroy_args *args)
{
...
int
isis_instance_flex_algo_metric_type_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
  const char *area_tag;
  struct flex_algo *fa;
...
int
isis_instance_flex_algo_priority_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
  const char *area_tag;
  struct flex_algo *fa;
...
int
isis_instance_flex_algo_priority_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_area *area;
  const char *area_tag;
  struct flex_algo *fa;
 ...
 */
int
isis_instance_mpls_ldp_sync_create (struct nb_cb_create_args *args)
{
  struct isis_area *area;
  const char *vrfname;
  ...
  switch (args->event)
    {
    case NB_EV_VALIDATE:
      vrfname = yang_dnode_get_string (lyd_parent (lyd_parent (args->dnode)),
                                       "./vrf");
...
int
isis_instance_mpls_ldp_sync_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_area *area;
 ...
 */
int
isis_instance_mpls_ldp_sync_holddown_modify (struct nb_cb_modify_args *args)
{
  struct isis_area *area;
  uint16_t holddown;
  const char *vrfname;
  ...
  switch (args->event)
    ...
    case NB_EV_VALIDATE:
      vrfname = yang_dnode_get_string (
          lyd_parent (lyd_parent (lyd_parent (args->dnode))), "./vrf");
 ...
 */
int
lib_interface_isis_create (struct nb_cb_create_args *args)
{
...
int
lib_interface_isis_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_circuit *circuit;
 ...
 */
int
lib_interface_isis_area_tag_modify (struct nb_cb_modify_args *args)
{
  struct isis_circuit *circuit;
  ...
  if (args->event == NB_EV_VALIDATE)
    {
      circuit =
          nb_running_get_entry_non_rec (lyd_parent (args->dnode), NULL, false);
      if (circuit)
        {
          snprintf (args->errmsg, args->errmsg_len,
 ...
 */
int
lib_interface_isis_circuit_type_modify (struct nb_cb_modify_args *args)
{
 ...
 */
int
lib_interface_isis_ipv4_routing_modify (struct nb_cb_modify_args *args)
{
  bool ipv4, ipv6;
  struct isis_circuit *circuit;
 ...
 */
int
lib_interface_isis_ipv6_routing_modify (struct nb_cb_modify_args *args)
{
  bool ipv4, ipv6;
  struct isis_circuit *circuit;
 ...
 */
int
lib_interface_isis_hello_padding_modify (struct nb_cb_modify_args *args)
{
  struct isis_circuit *circuit;
 ...
 */
int
lib_interface_isis_metric_level_1_modify (struct nb_cb_modify_args *args)
{
  struct isis_circuit *circuit;
  unsigned int met;
 ...
 */
int
lib_interface_isis_metric_level_2_modify (struct nb_cb_modify_args *args)
{
  struct isis_circuit *circuit;
  unsigned int met;
 ...
 */
int
lib_interface_isis_priority_level_1_modify (struct nb_cb_modify_args *args)
{
  struct isis_circuit *circuit;
 ...
 */
int
lib_interface_isis_priority_level_2_modify (struct nb_cb_modify_args *args)
{
  struct isis_circuit *circuit;
 ...
 */
int
lib_interface_isis_network_type_modify (struct nb_cb_modify_args *args)
{
  struct isis_circuit *circuit;
 ...
 */
int
lib_interface_isis_passive_modify (struct nb_cb_modify_args *args)
{
  struct isis_circuit *circuit;
 ...
 */
int
lib_interface_isis_password_create (struct nb_cb_create_args *args)
{
  return NB_OK;
}

int
lib_interface_isis_password_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_circuit *circuit;
 ...
 */
int
lib_interface_isis_password_password_modify (struct nb_cb_modify_args *args)
{
  struct isis_circuit *circuit;
  const char *password;
...
static int
lib_interface_isis_multi_topology_common (enum nb_event event,
                                          const struct lyd_node *dnode,
                                          char *errmsg, size_t errmsg_len,
                                          uint16_t mtid)
{
 ...
 */
int
lib_interface_isis_mpls_ldp_sync_modify (struct nb_cb_modify_args *args)
{
  struct isis_circuit *circuit;
 ...
 */
int
lib_interface_isis_mpls_holddown_modify (struct nb_cb_modify_args *args)
{
  struct isis_circuit *circuit;
  struct ldp_sync_info *ldp_sync_info;
  uint16_t holddown;
...
int
lib_interface_isis_mpls_holddown_destroy (struct nb_cb_destroy_args *args)
{
  struct isis_circuit *circuit;
  struct ldp_sync_info *ldp_sync_info;
