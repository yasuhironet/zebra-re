...
int
isis_instance_flex_algo_frr_disable_modify (struct nb_cb_modify_args *args);
int
isis_instance_flex_algo_frr_disable_destroy (struct nb_cb_destroy_args *args);
...
void default_info_origin_apply_finish (const struct lyd_node *dnode,
                                       int family);
void
...
void cli_show_isis_dynamic_hostname (struct vty *vty,
                                     const struct lyd_node *dnode,
                                     bool show_defaults);
void cli_show_isis_attached_send (struct vty *vty,
                                  const struct lyd_node *dnode,
                                  bool show_defaults);
...
void cli_show_isis_mpls_te_router_addr_ipv6 (struct vty *vty,
                                             const struct lyd_node *dnode,
                                             bool show_defaults);
void cli_show_isis_mpls_te_export (struct vty *vty,
                                   const struct lyd_node *dnode,
                                   bool show_defaults);
...
void cli_show_isis_mt_ipv6_mgmt (struct vty *vty, const struct lyd_node *dnode,
                                 bool show_defaults);
void cli_show_isis_mt_ipv6_dstsrc (struct vty *vty,
                                   const struct lyd_node *dnode,
                                   bool show_defaults);
...
void cli_show_ip_isis_hello_interval (struct vty *vty,
                                      const struct lyd_node *dnode,
                                      bool show_defaults);
void cli_show_ip_isis_hello_multi (struct vty *vty,
                                   const struct lyd_node *dnode,
                                   bool show_defaults);
...
void cli_show_ip_isis_psnp_interval (struct vty *vty,
                                     const struct lyd_node *dnode,
                                     bool show_defaults);
void cli_show_ip_isis_mt_standard (struct vty *vty,
                                   const struct lyd_node *dnode,
                                   bool show_defaults);
...
void cli_show_ip_isis_priority (struct vty *vty, const struct lyd_node *dnode,
                                bool show_defaults);
void cli_show_isis_log_adjacency (struct vty *vty,
                                  const struct lyd_node *dnode,
                                  bool show_defaults);
void cli_show_isis_log_pdu_drops (struct vty *vty,
                                  const struct lyd_node *dnode,
                                  bool show_defaults);
void cli_show_isis_mpls_ldp_sync (struct vty *vty,
                                  const struct lyd_node *dnode,
                                  bool show_defaults);
...
void cli_show_isis_flex_algo (struct vty *vty, const struct lyd_node *dnode,
                              bool show_defaults);
void cli_show_isis_flex_algo_end (struct vty *vty,
                                  const struct lyd_node *dnode);
...
void isis_notif_if_state_change (const struct isis_circuit *circuit,
                                 bool down);
