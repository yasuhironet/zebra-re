 ...
 */
static void
notif_prep_instance_hdr (const char *xpath, const struct isis_area *area,
                         const char *routing_instance, struct list *args)
{
...
static void
notif_prepr_iface_hdr (const char *xpath, const struct isis_circuit *circuit,
                       struct list *args)
{
  char xpath_arg[XPATH_MAXLEN];
  struct yang_data *data;
 ...
 */
void
isis_notif_db_overload (const struct isis_area *area, bool overload)
{
 ...
 */
void
isis_notif_lsp_too_large (const struct isis_circuit *circuit,
 ...
 */
void
isis_notif_if_state_change (const struct isis_circuit *circuit, bool down)
{
 ...
 */
void
isis_notif_corrupted_lsp (const struct isis_area *area, const uint8_t *lsp_id)
{
 ...
 */
void
isis_notif_lsp_exceed_max (const struct isis_area *area, const uint8_t *lsp_id)
{
                                   ...
                                   const char *raw_pdu, size_t raw_pdu_len)
{
  ...
  hook_call (isis_hook_authentication_failure, circuit, raw_pdu, raw_pdu_len);
 ...
 */
void
isis_notif_adj_state_change (const struct isis_adjacency *adj, int new_state,
                             const char *reason)
{
 ...
 */
void
isis_notif_reject_adjacency (const struct isis_circuit *circuit,
 ...
 */
void
isis_notif_area_mismatch (const struct isis_circuit *circuit,
                          const char *raw_pdu, size_t raw_pdu_len)
{
 ...
 */
void
isis_notif_lsp_received (const struct isis_circuit *circuit,
 ...
 */
void
isis_notif_lsp_gen (const struct isis_area *area, const uint8_t *lsp_id,
 ...
 */
void
isis_notif_id_len_mismatch (const struct isis_circuit *circuit,
 ...
 */
void
isis_notif_version_skew (const struct isis_circuit *circuit, uint8_t version,
                         const char *raw_pdu, size_t raw_pdu_len)
{
  ...
  hook_call (isis_hook_version_skew, circuit, version, raw_pdu, raw_pdu_len);
 ...
 */
void
isis_notif_lsp_error (const struct isis_circuit *circuit,
 ...
 */
void
isis_notif_seqno_skipped (const struct isis_circuit *circuit,
                          const uint8_t *lsp_id)
{
 ...
 */
void
isis_notif_own_lsp_purge (const struct isis_circuit *circuit,
                          const uint8_t *lsp_id)
{
