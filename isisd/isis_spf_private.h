...
#define VTYPE_IP(t)                                                           \
  ((t) >= VTYPE_IPREACH_INTERNAL && (t) <= VTYPE_IP6REACH_EXTERNAL)
...
__attribute__ ((__unused__)) static unsigned
isis_vertex_queue_hash_key (const void *vp)
{
...
__attribute__ ((__unused__)) static bool
isis_vertex_queue_hash_cmp (const void *a, const void *b)
{
...
isis_vertex_queue_tent_cmp (const void *a, const void *b)
{
...
__attribute__ ((__unused__)) static struct skiplist *
...
isis_vertex_queue_init (struct isis_vertex_queue *queue, const char *name,
                        bool ordered)
{
  if (ordered)
    {
...
__attribute__ ((__unused__)) static void
isis_vertex_queue_clear (struct isis_vertex_queue *queue)
{
...
__attribute__ ((__unused__)) static void
isis_vertex_queue_free (struct isis_vertex_queue *queue)
{
...
__attribute__ ((__unused__)) static void
isis_vertex_queue_append (struct isis_vertex_queue *queue,
                          struct isis_vertex *vertex)
{
...
__attribute__ ((__unused__)) static void
isis_vertex_queue_insert (struct isis_vertex_queue *queue,
                          struct isis_vertex *vertex)
{
  assert (queue->insert_counter);
...
__attribute__ ((__unused__)) static void
isis_vertex_queue_delete (struct isis_vertex_queue *queue,
                          struct isis_vertex *vertex)
{
  assert (queue->insert_counter);
...
__attribute__ ((__unused__)) static void
isis_vertex_id_init (struct isis_vertex *vertex, const void *id,
...
__attribute__ ((__unused__)) static struct isis_vertex *
isis_find_vertex (struct isis_vertex_queue *queue, const void *id,
                  enum vertextype vtype)
{
...
__attribute__ ((__unused__)) static struct isis_lsp *
lsp_for_vertex (struct isis_spftree *spftree, struct isis_vertex *vertex)
{
...
const char *vid2string (const struct isis_vertex *vertex, char *buff,
                        int size);
